;;; Automatically created by pop-gen at 2016-01-07 17:59:34.
;;; Source file is NIL

(in-package "ODM")


(defpackage "ODM-CL" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-DL" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-ODM" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-OWL" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-OWLBase" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-OWLDL" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-OWLFull" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-RDF" (:use :pod-utils :ptypes :mofi :ocl :cl))
(defpackage "ODM-RDFConcepts" (:use :pod-utils :ptypes :mofi :ocl :cl))
...
(def-meta-class |AllValuesFromRestriction| 
   (:model "ODM" :superclasses (|OWLRestriction|) 
    :packages (ODM::ODM ODM::OWL ODM::|OWLBase|) 
...
;;; ====================== BlankNode
;;; =========================================================
(in-package "ODM-RDFConcepts")
(def-meta-class |BlankNode| 
   (:model "ODM" :superclasses (|Node|) 
    :packages (ODM::ODM ODM::RDF ODM::|RDFConcepts|) 
...
(def-meta-class |ClassExpression| 
   (:model "ODM" :superclasses (ODM-RDFS::|RDFSClass|) 
    :packages (ODM::ODM ODM::OWL ODM::|OWLBase|) 
...
(def-meta-class |Collection| 
   (:model "ODM" :superclasses (ODM-DL::|Concept|) 
    :packages (ODM::ODM ODM::DL) 
    :xmi-id "_15_5_2c17055e_1218847223579_447975_3376")
 ""
  ((ODM-DL::|member| :xmi-id "_15_5_2c17055e_1218847223559_198107_2851"
    :range ODM-DL::|Extent| :multiplicity (0 -1)
    :opposite (ODM-DL::|Extent| ODM-DL:|type|))))
...
(def-meta-class |DatatypeRestriction| 
 ...
 "This represents a DataRange which is a restriction of another datatype
  ...
  ((|datatypeRestricted| :xmi-id "_17_0_4_1_e4a0319_1376903326453_943424_4645"
    :range ODM-RDFS::|RDFSDatatype| :multiplicity (1 1)
    :documentation
 ...
 "A HasValueRestriction describes a class of all individuals for which the
  ...
  ((|OWLhasIndividualValue| :xmi-id "_15_5_2c17055e_1218847223579_722197_3347"
   ...
   (|OWLhasLiteralValue| :xmi-id "_15_5_2c17055e_1218847223579_473292_3342"
    :range |ODM-RDFConcepts|::|Literal| :multiplicity (0 1) :is-composite-p T
    :documentation
...
(def-meta-class |OWLAnnotationProperty| 
   (:model "ODM" :superclasses (|OWLUniverse| |ODM-RDFConcepts|::|RDFProperty|) 
    :packages (ODM::ODM ODM::OWL ODM::|OWLBase|) 
...
(def-meta-class |OWLDataEnumeration| 
 ...
 "This represents a DataRange which is defined through listing its complete
  ...
  ((|dataOneOf| :xmi-id "_15_5_2c17055e_1218847223559_288499_2862"
    :range |ODM-RDFConcepts|::|Literal| :multiplicity (1 -1)
    :documentation
...
(def-meta-class |OWLOntology| 
   (:model "ODM" :superclasses (|ODM-RDFConcepts|::|RDFSResource|) 
    :packages (ODM::ODM ODM::OWL ODM::|OWLBase|) 
 ...
 "An OWL ontology contains a sequence of annotations, axioms, and facts.
  ...
  ((|OWLbackwardCompatibleWith| :xmi-id "_15_5_2c17055e_1218847223579_432309_3402"
   ...
   (|triple| :xmi-id "_15_5_2c17055e_1219362791601_494644_2036"
    :range |ODM-RDFConcepts|::|Triple| :multiplicity (1 -1)
    :documentation
...
(def-meta-class |OWLRestriction| 
 ...
 "The class owl:Restriction is defined as a subclass of owl:Class. A restriction
  ...
  ((|OWLonProperty| :xmi-id "_15_5_2c17055e_1218847223579_886744_3535"
    :range |ODM-RDFConcepts|::|RDFProperty| :multiplicity (1 1)
    :documentation
...
(def-meta-class |RDFAlt| 
   (:model "ODM" :superclasses (|RDFSContainer|) 
    :packages (ODM::ODM ODM::RDF ODM::RDFS) 
...
(def-meta-class |RDFProperty| 
   (:model "ODM" :superclasses (|ODM-RDFConcepts|::|RDFProperty|) 
    :packages (ODM::ODM ODM::RDF ODM::RDFS) 
...
(def-meta-class |RDFSDatatype| 
   (:model "ODM" :superclasses (|ODM-OWLBase|::|DataRange|) 
    :packages (ODM::ODM ODM::RDF ODM::RDFS) 
 ...
 "An RDF source is a persistent yet mutable source or container of RDF graphs.
  ...
  ((|defaultNamespace| :xmi-id "_17_0_3_e980341_1344460099799_887908_2259"
   ...
   (|namespaceSuffixDelimiter| :xmi-id "_17_0_4_1_e4a0319_1384200365206_13415_6206"
    :range |String| :multiplicity (0 1) :default "/" ; POD was :"\"
    :documentation
...
(def-meta-class |TypedLiteral| 
   (:model "ODM" :superclasses (|ODM-RDFConcepts|::|TypedLiteral|) 
    :packages (ODM::ODM ODM::RDF ODM::RDFS) 
...
(def-meta-package CL ODM "ODM" 
   (ODM-CL::|CommentedTerm|
    ...
    ODM-CL::|Term|
    ODM-CL::|Name|) :xmi-id "_15_5_2c17055e_1218847223559_934831_3084")
...
(def-meta-package DL ODM "ODM" 
   (ODM-DL::|Element|
    ...
    ODM-DL::|ForAll|
    ODM-DL::|Literal|
    ODM-DL::|TBox|) :xmi-id "_15_5_2c17055e_1218847223559_533876_3134")
...
(def-meta-package |OWLBase| OWL "ODM" 
   (|ODM-OWLBase|::|OWLClass|
    ...
    |ODM-OWLBase|::|ExactCardinalityRestriction|
    |ODM-OWLBase|::|UnionClass|
    |ODM-OWLBase|::|OWLUniverse|
    |ODM-OWLBase|::|OWLDatatypeProperty|
    |ODM-OWLBase|::|OWLDataEnumeration|
    |ODM-OWLBase|::|MinCardinalityRestriction|
    |ODM-OWLBase|::|SomeValuesFromRestriction|
    |ODM-OWLBase|:|AllValuesFromRestriction|
    |ODM-OWLBase|:|ClassExpression|
    |ODM-OWLBase|::|DataRange|
    |ODM-OWLBase|::|ComplementDatatype|
    |ODM-OWLBase|::|UnionDatatype|
    |ODM-OWLBase|::|IntersectionDatatype|
    |ODM-OWLBase|::|DatatypeRestriction|
    |ODM-OWLBase|::|OWLDatatype|
    |ODM-OWLBase|::|HasSelfRestriction|
    |ODM-OWLBase|::|CardinalityRestriction|) :xmi-id "_15_5_2c17055e_1218847223559_146511_3103")
...
(def-meta-package |RDFConcepts| RDF "ODM" 
   (|ODM-RDFConcepts|:|BlankNode|
    |ODM-RDFConcepts|::|RDFXMLLiteral|
    |ODM-RDFConcepts|::|Triple|
    |ODM-RDFConcepts|::|TypedLiteral|
    |ODM-RDFConcepts|::|Statement|
    |ODM-RDFConcepts|::|Graph|
    |ODM-RDFConcepts|::|RDFProperty|
    |ODM-RDFConcepts|::|Node|
    |ODM-RDFConcepts|::|Literal|
    |ODM-RDFConcepts|::|Source|
    |ODM-RDFConcepts|::|RDFSResource|
    |ODM-RDFConcepts|::|ReferenceNode|
    |ODM-RDFConcepts|::|Dataset|
    |ODM-RDFConcepts|::|NamedGraph|
    |ODM-RDFConcepts|::|Document|
    |ODM-RDFConcepts|::IRI
    |ODM-RDFConcepts|::|Namespace|
    |ODM-RDFConcepts|::|NamespaceDefinition|) :xmi-id "_15_5_2c17055e_1218847223559_720925_2973")
...
(def-meta-package RDFS RDF "ODM" 
   (ODM-RDFS::|RDFAlt|
    ...
    ODM-RDFS::|RDFSResource|
    ODM-RDFS::|TypedLiteral|
    ODM-RDFS::|RDFProperty|) :xmi-id "_15_5_2c17055e_1218847223559_917028_3121")
...
(def-meta-package TM ODM "ODM" 
   (ODM-TM:|AssociationRole|
    ...
    ODM-TM::|TopicMap|
    ODM-TM::|TypeAble|) :xmi-id "_15_5_2c17055e_1218847223559_785519_2929")

(in-package "MOFI") ; POD was :OCL !
...
(with-slots (abstract-classes ns-uri ns-prefix) *model*
     (setf abstract-classes 
        '(ODM-CL:|Atom|
          ...
          ODM-TM::|TopicMapConstruct|
          ODM-TM::|TypeAble|))
     (setf ns-uri "http://www.omg.org/spec/ODM/20131101/ODM-metamodels.xmi")
     (setf ns-prefix "ODM"))
