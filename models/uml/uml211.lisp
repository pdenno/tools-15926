...
;;; Automatically generated from /local/lisp/pod-utils/uml-utils/models/uml-nnew.lisp by UML Testbed tools 
;;; on 2008-08-11 17:48:44
...
(def-mm-enum |InteractionOperatorKind|
 :uml211 () (|alt| |assert| |break| |consider| 
...
(def-mm-enum |MessageKind|
 :uml211 () (|complete| |found| |lost| |unknown| )
    "  This is an enumerated type that identifies the type of message.")

(def-mm-enum |MessageSort|
 :uml211 () (|asynchCall| |asynchSignal| |createMessage| |deleteMessage| 
   |reply| |synchCall| )
...
(def-mm-enum |ParameterEffectKind|
 :uml211 () (|create| |delete| |read| |update| )
...
(def-mm-class |AcceptCallAction| :uml211 (|AcceptEventAction|)
...
(def-mm-class |AcceptEventAction| :uml211 (|Action|)
...
(def-mm-class |Action| :uml211 (|ExecutableNode|)
...
(def-mm-class |ActionExecutionSpecification| :uml211 (|ExecutionSpecification|)
...
(def-mm-class |ActionInputPin| :uml211 (|InputPin|)
...
(def-mm-class |Activity| :uml211 (|Behavior|)
...
(def-mm-class |ActivityEdge| :uml211 (|RedefinableElement|)
...
(def-mm-class |ActivityFinalNode| :uml211 (|FinalNode|)
"  An activity final node is a final node that stops all flows in an activity."
  ())


(def-mm-class |ActivityGroup| :uml211 (|Element|)
"  ActivityGroup is an abstract class for defining sets of nodes and edges
  ...
  :is-derived-p t :subsetted-properties ((|Element| |ownedElement|)) :opposite (|ActivityGroup| |superGroup|) 
  :documentation
   "  Groups immediately contained in the group.")
  (|superGroup| :range |ActivityGroup| :multiplicity (0  1) :is-derived-union-p t :is-readonly-p t 
  :is-derived-p t :subsetted-properties ((|Element| |owner|)) :opposite (|ActivityGroup| |subgroup|) 
  :documentation
...
(def-mm-class |ActivityNode| :uml211 (|RedefinableElement|)
...
(def-mm-class |ActivityParameterNode| :uml211 (|ObjectNode|)
...
(def-mm-class |ActivityPartition| :uml211 (|ActivityGroup| |NamedElement|)
"  An activity partition is a kind of activity group for identifying actions
  ...
  :subsetted-properties ((|ActivityGroup| |subgroup|)) :opposite (|ActivityPartition| |superPartition|) 
  :documentation
   "  Partitions immediately contained in the partition.")
  (|superPartition| :range |ActivityPartition| :multiplicity (0  1) 
  :subsetted-properties ((|ActivityGroup| |superGroup|)) :opposite (|ActivityPartition| |subpartition|) 
  :documentation
...
(def-mm-class |Actor| :uml211 (|BehavioredClassifier|)
...
(def-mm-class |AddStructuralFeatureValueAction| :uml211 (|WriteStructuralFeatureAction|)
...
(def-mm-class |AddVariableValueAction| :uml211 (|WriteVariableAction|)
...
(def-mm-constraint "single_input_pin" |AddVariableValueAction| 
  ...
  otherwise the action has no input pin for the insertion point."
    :operation-body "variable.ordering = #ordered implies
(insertAt.is(1,1) and insertAt.type.oclIsKindOf(UnlimitedNatural)) or insertAt->size() = 0 ")

(def-mm-class |AnyReceiveEvent| :uml211 (|MessageEvent|)
...
(def-mm-class |Artifact| :uml211 (|DeployedArtifact| |Classifier|)
"  An artifact is the source of a deployment to a node."
  ...
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |attribute|)) 
    :documentation
  ...
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |feature|)) 
    :documentation
   "  The Operations defined for the Artifact. The association is a specialization
  of the ownedMember association.")))


(def-mm-class |Association| :uml211 (|Classifier| |Relationship|)
"  An association describes a set of tuples whose values refer to typed instances.
  ...
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |feature|) (|Association| |memberEnd|)) :opposite (|Property| |owningAssociation|) 
    :documentation
...
(def-mm-constraint "specialized_end_types" |Association| 
  ...
  association corresponds to an end of the general association, and the specific
    ...
    :operation-status :ignored
    :operation-body "true"
    :original-body "Sequence{1 ..self.memberEnd->size()}->
...
(def-mm-class |AssociationClass| :uml211 (|Class| |Association|)
...
(def-mm-class |Behavior| :uml211 (|Class|)
"  A behavior owns zero or more parameter sets."
  ...
  associated with a classifier (i.e., it is the behavior of the classifier
  as a whole).")))
...
(def-mm-class |BehaviorExecutionSpecification| :uml211 (|ExecutionSpecification|)
...
(def-mm-class |BehavioralFeature| :uml211 (|Namespace| |Feature|)
...
(def-mm-class |BehavioredClassifier| :uml211 (|Classifier|)
"  A classifier can have behavior specifications defined in its namespace.
  ...
  :subsetted-properties ((|NamedElement| |clientDependency|) (|Element| |ownedElement|)) :opposite (|InterfaceRealization| |implementingClassifier|) 
    :documentation
...
(def-mm-class |BroadcastSignalAction| :uml211 (|InvocationAction|)
...
(def-mm-class |CallAction| :uml211 (|InvocationAction|)
...
(def-mm-class |CallBehaviorAction| :uml211 (|CallAction|)
...
(def-mm-class |CallEvent| :uml211 (|MessageEvent|)
...
(def-mm-class |CallOperationAction| :uml211 (|CallAction|)
...
(def-mm-class |CentralBufferNode| :uml211 (|ObjectNode|)
"  A central buffer node is an object node for managing flows from multiple
  sources and destinations."
  ())


(def-mm-class |ChangeEvent| :uml211 (|Event|)
...
(def-mm-class |Class| :uml211 (|EncapsulatedClassifier| |BehavioredClassifier|)
"  Class has derived association that indicates how it may be extended through
  ...
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|)) 
   ...
   (|ownedAttribute| :range |Property| :multiplicity (0 -1 ) :is-composite-p t 
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |attribute|)) :redefined-property (|StructuredClassifier| |ownedAttribute|) :opposite (|Property| |class|) 
    :documentation
   "  The attributes (i.e. the properties) owned by the class.")
   (|ownedOperation| :range |Operation| :multiplicity (0 -1 ) :is-composite-p t 
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |feature|)) :opposite (|Operation| |class|) 
    :documentation
...
(def-mm-operation "inherit" |Class| 
    ...
    :editor-note "Not sure what intended here. argument isn't a Collection. excluding isn't a Collection operator."
    :operation-status :ignored
    :operation-body "Set{}"
    :original-body "result = inhs->excluding(inh | 
...
(def-mm-class |Classifier| :uml211 (|TemplateableElement| |Type| |Namespace| |RedefinableElement|)
"  Classifier is defined to be a kind of templateable element so that a classifier
  ...
  :subsetted-properties ((|NamedElement| |clientDependency|) (|Element| |ownedElement|)) :opposite (|Substitution| |substitutingClassifier|) 
    :documentation
...
(def-mm-operation "allParents" |Classifier| 
    ...
    :operation-body "result = self.parents()->union(self.parents()->collect(p | p.allParents()))" ; pod
...
(def-mm-operation "maySpecializeType" |Classifier| 
    ...
    :editor-note "oclType() not oclType."
    :operation-status :rewritten
...
(def-mm-class |ClassifierTemplateParameter| :uml211 (|TemplateParameter|)
"  A classifier template parameter exposes a classifier as a formal template
  ...
  parameteredElement for this formal parameter.")
   (|constrainingClassifier| :range |Classifier| :multiplicity (0 1 )
    :documentation
   "  The classifier that constrains the argument that can be used for the parameter.
  ...
  an argument.")
   (|defaultClassifier| :range |Classifier| :multiplicity (0 1 )
    :documentation
   "  The classifier that is used by default if no argument is provided during
  template binding. If this property is empty, then there is no default.")
...
(def-mm-class |Clause| :uml211 (|Element|)
...
(def-mm-class |ClearAssociationAction| :uml211 (|Action|)
...
(def-mm-constraint "multiplicity" |ClearAssociationAction| 
    ...
    :editor-note "Use of 'is' should be investigated."
...
(def-mm-class |ClearStructuralFeatureAction| :uml211 (|StructuralFeatureAction|)
"  A clear structural feature action is a structural feature action that removes
  all values of a structural feature."
  ())


(def-mm-class |ClearVariableAction| :uml211 (|VariableAction|)
"  A clear variable action is a variable action that removes all values of
  a variable."
  ())


(def-mm-class |Collaboration| :uml211 (|BehavioredClassifier| |StructuredClassifier|)
...
(def-mm-class |CollaborationUse| :uml211 (|NamedElement|)
...
(def-mm-class |CombinedFragment| :uml211 (|InteractionFragment|)
...
(def-mm-class |Comment| :uml211 (|Element|)
...
(def-mm-class |CommunicationPath| :uml211 (|Association|)
...
(def-mm-class |Component| :uml211 ( #||Namespace||# |Class|)
...
(def-mm-class |ComponentRealization| :uml211 (|Realization|)
"  The realization concept is specialized to (optionally) define the classifiers
 ...
 (  (|abstraction| :range |Component| :multiplicity (0  1) 
  ...
  :subsetted-properties ((|Dependency| |supplier|)) 
    :documentation
   "  A classifier that is involved in the implementation of the Component that
  owns this ComponentRealization.")))


(def-mm-class |ConditionalNode| :uml211 (|StructuredActivityNode|)
...
(def-mm-class |ConnectableElement| :uml211 (|ParameterableElement| |TypedElement|)
"  A connectable element may be exposed as a connectable element template
  parameter."
  ((|end| :range |ConnectorEnd| :multiplicity (0 -1 )
  :is-ordered-p t :opposite (|ConnectorEnd| |role|) 
    :documentation
...
(def-mm-class |ConnectableElementTemplateParameter| :uml211 (|TemplateParameter|)
...
(def-mm-class |ConnectionPointReference| :uml211 (|Vertex|)
...
(def-mm-class |Connector| :uml211 (|Feature|)
...
(def-mm-class |ConnectorEnd| :uml211 (|MultiplicityElement|)
...
(def-mm-class |ConsiderIgnoreFragment| :uml211 (|CombinedFragment|)
...
(def-mm-class |Constraint| :uml211 (|PackageableElement|)
...
(def-mm-constraint "value_specification_boolean" |Constraint| 
    ...
    :editor-note "No () on specification. oclIsKindOf not isOclKindOf. More generally,
        ...
        describe this in OCL."
    :operation-status :rewritten
    :operation-body "true"
    :original-body "self.specification().booleanValue().isOclKindOf(Boolean)")


(def-mm-class |Continuation| :uml211 (|InteractionFragment|)
...
(def-mm-class |ControlFlow| :uml211 (|ActivityEdge|)
...
(def-mm-class |ControlNode| :uml211 (|ActivityNode|)
"  A control node is an abstract activity node that coordinates flows in an
  activity."
  ())


(def-mm-class |CreateLinkAction| :uml211 (|WriteLinkAction|)
...
(def-mm-class |CreateLinkObjectAction| :uml211 (|CreateLinkAction|)
...
(def-mm-class |CreateObjectAction| :uml211 (|Action|)
...
(def-mm-class |CreationEvent| :uml211 (|Event|)
...
(def-mm-class |DataStoreNode| :uml211 (|CentralBufferNode|)
"  A data store node is a central buffer node for non-transient information."
  ())


(def-mm-class |DataType| :uml211 (|Classifier|)
"  A data type is a type whose instances are identified only by their value.
  ...
  data types."
  ((|ownedAttribute| :range |Property| :multiplicity (0 -1 ) :is-composite-p t 
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |attribute|)) :opposite (|Property| |datatype|) 
    :documentation
   "  The Attributes owned by the DataType.")
   (|ownedOperation| :range |Operation| :multiplicity (0 -1 ) :is-composite-p t 
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |feature|)) :opposite (|Operation| |datatype|) 
    :documentation
...
(def-mm-operation "inherit" |DataType| 
    ...
    :operation-status :ignored
    :operation-body "Set{}"
    :original-body "result = inhs->excluding(inh | ownedMember->select(oclIsKindOf(RedefinableElement))->select
                              (redefinedElement->includes(inh)))"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|NamedElement| :parameter-return-p T)
                      (make-instance 'ocl-parameter :parameter-name '|inhs| :parameter-type '|NamedElement| 
				     :parameter-return-p NIL)))

(def-mm-class |DecisionNode| :uml211 (|ControlNode|)
...
(def-mm-constraint "edges" |DecisionNode| 
    "  The edges coming into and out of a decision node must be either all object
  flows or all control flows."
    :operation-body "true")

(def-mm-constraint "input_parameter" |DecisionNode| 
    "  A decision input behavior has zero or one input parameter and one output
  parameter. Any input parameter must be the same as or a supertype of the
  type of object tokens coming along the incoming edge. The behavior cannot
  have side effects."
    :operation-body "true")

(def-mm-constraint "one_incoming_edge" |DecisionNode| 
    "  A decision node has one incoming edge."
    :operation-body "true")


(def-mm-class |Dependency| :uml211 (|PackageableElement| |DirectedRelationship|)
...
(def-mm-class |DeploymentSpecification| :uml211 (|Artifact|)
...
(def-mm-class |DeploymentTarget| :uml211 (|NamedElement|)
"  A deployment target is the location for a deployed artifact."
  ...
  :subsetted-properties ((|NamedElement| |clientDependency|) (|Element| |ownedElement|)) :opposite (|Deployment| |location|) 
    :documentation
...
(def-mm-class |DestroyLinkAction| :uml211 (|WriteLinkAction|)
...
(def-mm-class |DestroyObjectAction| :uml211 (|Action|)
...
(def-mm-class |DestructionEvent| :uml211 (|Event|)
...
(def-mm-class |Device| :uml211 (|Node|)
...
(def-mm-class |DirectedRelationship| :uml211 (|Relationship|)
...
(def-mm-class |DurationConstraint| :uml211 (|IntervalConstraint|)
...
(def-mm-class |DurationInterval| :uml211 (|Interval|)
...
(def-mm-class |DurationObservation| :uml211 (|Observation|)
...
(def-mm-class |Element| :uml211 NIL
"  An element is a constituent of a model. As such, it has the capability
  ...
  :is-derived-p t :opposite (|Element| |owner|) 
  :documentation
   "  The Elements owned by this element.")
  (|owner| :range |Element| :multiplicity (0  1) :is-derived-union-p t :is-readonly-p t 
  :is-derived-p t :opposite (|Element| |ownedElement|) 
  :documentation
...
(def-mm-class |ElementImport| :uml211 (|DirectedRelationship|)
"  An element import identifies an element in another package, and allows
  ...
  :subsetted-properties ((|Element| |owner|) (|DirectedRelationship| |source|)) :opposite (|Namespace| |elementImport|) 
    :documentation
...
(def-mm-class |EncapsulatedClassifier| :uml211 (|StructuredClassifier|)
...
(def-mm-class |Enumeration| :uml211 (|DataType|)
...
(def-mm-class |EnumerationLiteral| :uml211 (|InstanceSpecification|)
...
(def-mm-class |ExecutableNode| :uml211 (|ActivityNode|)
...
(def-mm-class |ExecutionEnvironment| :uml211 (|Node|)
...
(def-mm-class |ExecutionEvent| :uml211 (|Event|)
"  An execution event models the start or finish of an execution occurrence."
  ())


(def-mm-class |ExecutionOccurrenceSpecification| :uml211 (|OccurrenceSpecification|)
...
(def-mm-class |ExecutionSpecification| :uml211 (|InteractionFragment|)
...
(def-mm-constraint "same_lifeline" |ExecutionSpecification| 
    ...
    :editor-note "No such property as 'lifeline'."
    :operation-body "true"
    :operation-status :ignored
    :original-body "start.lifeline = finish.lifeline")

(def-mm-class |ExpansionNode| :uml211 (|ObjectNode|)
...
(def-mm-class |ExpansionRegion| :uml211 (|StructuredActivityNode|)
...
(def-mm-class |Expression| :uml211 (|ValueSpecification|)
...
(def-mm-class |Extend| :uml211 (|NamedElement| |DirectedRelationship|)
...
(def-mm-class |Extension| :uml211 (|Association|)
...
(def-mm-class |ExtensionEnd| :uml211 (|Property|)
"  The default multiplicity of an extension end is 0..1."
  ...
  the possible types of an ExtensionEnd to only be Stereotypes.")
   (|owningAssociation| :range |Extension| :multiplicity (0 1 )  ;; POD See notes from 2009-03-21
    :redefined-property (|Property| |owningAssociation|)
    :opposite (|Extension| |ownedEnd|) ;; POD See notes from 2009-03-21
    :documentation
   "  Editor's note: It is currently unresolved whether this could have been 
      inferred from the model, but this redefinition was manually defined, and
      I'm only guessing that it is what was intended!")))
...
(def-mm-class |ExtensionPoint| :uml211 (|RedefinableElement|)
...
(def-mm-class |Feature| :uml211 (|RedefinableElement|)
...
(def-mm-class |FinalNode| :uml211 (|ControlNode|)
...
(def-mm-class |FinalState| :uml211 (|State|)
...
(def-mm-class |FlowFinalNode| :uml211 (|FinalNode|)
"  A flow final node is a final node that terminates a flow."
  ())


(def-mm-class |ForkNode| :uml211 (|ControlNode|)
...
(def-mm-class |FunctionBehavior| :uml211 (|OpaqueBehavior|)
...
(def-mm-class |Gate| :uml211 (|MessageEnd|)
...
(def-mm-class |GeneralOrdering| :uml211 (|NamedElement|)
...
(def-mm-class |Generalization| :uml211 (|DirectedRelationship|)
"  A generalization relates a specific classifier to a more general classifier,
  ...
  :subsetted-properties ((|Element| |owner|) (|DirectedRelationship| |source|)) :opposite (|Classifier| |generalization|) 
    :documentation
...
(def-mm-class |GeneralizationSet| :uml211 (|PackageableElement|)
...
(def-mm-class |Image| :uml211 (|Element|)
...
(def-mm-operation "mustBeOwned" |Image| 
    "The query mustBeOwned() indicates whether elements of this type must have an owner."
    :editor-note "This is NOT part of the UML spec, but was added for the MIWG activity."
    :operation-body "result = false"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T))
  )


(def-mm-class |Include| :uml211 (|NamedElement| |DirectedRelationship|)
...
(def-mm-class |InformationFlow| :uml211 (|PackageableElement| |DirectedRelationship|)
...
(def-mm-class |InformationItem| :uml211 (|Classifier|)
...
(def-mm-class |InitialNode| :uml211 (|ControlNode|)
...
(def-mm-class |InputPin| :uml211 (|Pin|)
...
(def-mm-class |InstanceSpecification| :uml211 (|DeployedArtifact| |DeploymentTarget| |PackageableElement|)
...
(def-mm-class |InstanceValue| :uml211 (|ValueSpecification|)
...
(def-mm-class |Interaction| :uml211 (|Behavior| |InteractionFragment|)
...
(def-mm-class |InteractionConstraint| :uml211 (|Constraint|)
...
(def-mm-class |InteractionFragment| :uml211 (|NamedElement|)
...
(def-mm-class |InteractionOperand| :uml211 (|Namespace| |InteractionFragment|)
...
(def-mm-class |InteractionUse| :uml211 (|InteractionFragment|)
...
(def-mm-class |Interface| :uml211 (|Classifier|)
"  Since an interface specifies conformance characteristics, it does not own
  ...
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |attribute|)) 
   ...
   "  The attributes (i.e. the properties) owned by the class.")
   (|ownedOperation| :range |Operation| :multiplicity (0 -1 ) :is-composite-p t 
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |feature|)) :opposite (|Operation| |interface|) 
    :documentation
   "  The operations owned by the class.")
   (|ownedReception| :range |Reception| :multiplicity (0 -1 ) :is-composite-p t 
  :subsetted-properties ((|Namespace| |ownedMember|) (|Classifier| |feature|)) 
    :documentation
...
(def-mm-class |InterfaceRealization| :uml211 (|Realization|)
...
(def-mm-class |InterruptibleActivityRegion| :uml211 (|ActivityGroup|)
...
(def-mm-class |Interval| :uml211 (|ValueSpecification|)
...
(def-mm-class |IntervalConstraint| :uml211 (|Constraint|)
...
(def-mm-class |InvocationAction| :uml211 (|Action|)
...
(def-mm-class |JoinNode| :uml211 (|ControlNode|)
...
(def-mm-class |Lifeline| :uml211 (|NamedElement|)
...
(def-mm-class |LinkAction| :uml211 (|Action|)
...
(def-mm-class |LinkEndCreationData| :uml211 (|LinkEndData|)
...
(def-mm-constraint "single_input_pin" |LinkEndCreationData| 
  ...
  input pin for the insertion point with type UnlimitedNatural and multiplicity
  of 1..1, otherwise the action has no input pin for the insertion point."
    :editor-note "insertAt not insertAts. Uses .is."
    :operation-status :rewritten
    :operation-body "  end.ordering = #ordered implies
 (insertAt->size() = 1 and insertAt.type.oclIsKindOf(UnlimitedNatural) and insertAt.is(1,1))
  or insertAt->size() = 0"
    :original-body "  end.ordering = #ordered implies
   (insertAt->size() = 1 and insertAt.type.oclIsKindOf(UnlimitedNatural) and insertAts.is(1,1))
   or insertAt->size() = 0")


(def-mm-class |LinkEndData| :uml211 (|Element|)
...
(def-mm-class |LinkEndDestructionData| :uml211 (|LinkEndData|)
...
(def-mm-class |LiteralBoolean| :uml211 (|LiteralSpecification|)
...
(def-mm-class |LiteralInteger| :uml211 (|LiteralSpecification|)
...
(def-mm-class |LiteralNull| :uml211 (|LiteralSpecification|)
...
(def-mm-class |LiteralSpecification| :uml211 (|ValueSpecification|)
"  A literal specification identifies a literal constant being modeled."
  ())


(def-mm-class |LiteralString| :uml211 (|LiteralSpecification|)
...
(def-mm-class |LiteralUnlimitedNatural| :uml211 (|LiteralSpecification|)
...
(def-mm-class |LoopNode| :uml211 (|StructuredActivityNode|)
...
(def-mm-class |Manifestation| :uml211 (|Abstraction|)
...
(def-mm-class |MergeNode| :uml211 (|ControlNode|)
...
(def-mm-class |Message| :uml211 (|NamedElement|)
...
(def-mm-class |MessageEnd| :uml211 (|NamedElement|)
...
(def-mm-class |MessageEvent| :uml211 (|Event|)
"  A message event specifies the receipt by an object of either a call or
  a signal."
  ())


(def-mm-class |MessageOccurrenceSpecification| :uml211 (|OccurrenceSpecification| |MessageEnd|)
...
(def-mm-class |Model| :uml211 (|Package|)
...
(def-mm-class |MultiplicityElement| :uml211 (|Element|)
...
(def-mm-constraint "upper_ge_lower" |MultiplicityElement| 
    ...
    :editor-note "Rewrite was probably pointless. Needs examination."
    :operation-status :rewritten
    :operation-body "not upperBound().oclIsUndefined() and not lowerBound().oclIsUndefined() 
                     implies upperBound() >= lowerBound()"
    :original-body "(upperBound()->notEmpty() and lowerBound()->notEmpty()) implies upperBound() >= lowerBound()")

(def-mm-constraint "upper_gt_0" |MultiplicityElement| 
    "  A multiplicity must define at least one valid cardinality that is greater
  than zero."
    :editor-note "Rewrite was probably pointless. Needs examination."
    :operation-status :rewritten
    :operation-body "not upperBound().oclIsUndefined() implies upperBound() > 0"
    :original-body "upperBound()->notEmpty() implies upperBound() > 0")
...
(def-mm-operation "compatibleWith" |MultiplicityElement| 
    "The operation compatibleWith takes another multiplicity as input. It checks if one multiplicity is 
    compatible with another."
    :editor-note "Problem here needs examination."
    :operation-status :ignored
    :operation-body "Set{}"
    :original-body "result = Integer.allInstances()->forAll(i : Integer | self.includesCardinality(i) 
                    implies other.includesCardinality(i))"
    :parameters 
...
(def-mm-class |NamedElement| :uml211 (|Element|)
...
(def-mm-operation "qualifiedName.1" |NamedElement| 
    "When there is a name, and all of the containing namespaces have a name, 
     the qualified name is constructed from the names of the containing namespaces."
    :editor-note "Use OCL concat not union."
    :operation-status :rewritten
...
(def-mm-class |Namespace| :uml211 (|NamedElement|)
...
>union(self.packageImport.importedPackage->collect(p | p.visibleMembers())))"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|PackageableElement| 
				     :parameter-return-p T)))
...
(def-mm-class |Node| :uml211 (|DeploymentTarget| |Class|)
...
(def-mm-class |ObjectFlow| :uml211 (|ActivityEdge|)
...
(def-mm-class |ObjectNode| :uml211 (|TypedElement| |ActivityNode|)
...
(def-mm-class |Observation| :uml211 (|PackageableElement|)
...
(def-mm-class |OccurrenceSpecification| :uml211 (|InteractionFragment|)
...
(def-mm-class |OpaqueAction| :uml211 (|Action|)
...
(def-mm-class |OpaqueBehavior| :uml211 (|Behavior|)
...
(def-mm-class |OpaqueExpression| :uml211 (|ValueSpecification|)
...
(def-mm-class |Operation| :uml211 (|TemplateableElement| |ParameterableElement| |BehavioralFeature|)
...
(def-mm-class |OperationTemplateParameter| :uml211 (|TemplateParameter|)
...
(def-mm-class |OutputPin| :uml211 (|Pin|)
...
(def-mm-class |Package| :uml211 (|TemplateableElement| |Namespace| |PackageableElement|)
"  Package specializes TemplateableElement and PackageableElement specializes
  ...
  :subsetted-properties ((|NamedElement| |namespace|)) :opposite (|Package| |nestedPackage|) 
  :documentation
...
(def-mm-class |PackageImport| :uml211 (|DirectedRelationship|)
"  A package import is a relationship that allows the use of unqualified names
  ...
  :subsetted-properties ((|DirectedRelationship| |target|)) 
   ...
   (|importingNamespace| :range |Namespace| :multiplicity (1 1 )
  :subsetted-properties ((|Element| |owner|) (|DirectedRelationship| |source|)) :opposite (|Namespace| |packageImport|) 
    :documentation
...
(def-mm-class |PackageMerge| :uml211 (|DirectedRelationship|)
"  A package merge defines how the contents of one package are extended by
  ...
  :subsetted-properties ((|Element| |owner|) (|DirectedRelationship| |source|)) :opposite (|Package| |packageMerge|) 
    :documentation
   "  References the Package that is being extended with the contents of the
  merged package of the PackageMerge.")))


(def-mm-class |PackageableElement| :uml211 (|ParameterableElement| |NamedElement|)
...
(def-mm-class |Parameter| :uml211 (|ConnectableElement| |MultiplicityElement|)
...
(def-mm-class |ParameterSet| :uml211 (|NamedElement|)
...
(def-mm-class |ParameterableElement| :uml211 (|Element|)
"  A parameterable element is an element that can be exposed as a formal template
  ...
  :subsetted-properties ((|ParameterableElement| |templateParameter|) (|Element| |owner|)) :opposite (|TemplateParameter| |ownedParameteredElement|) 
    :documentation
...
(def-mm-operation "isCompatibleWith" |ParameterableElement| 
    ...
    :operation-body "result = p->oclIsKindOf(self.oclType())" ; pod
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
...
(def-mm-class |PartDecomposition| :uml211 (|InteractionUse|)
...
(def-mm-class |Pin| :uml211 (|ObjectNode| |MultiplicityElement|)
...
(def-mm-class |Port| :uml211 (|Property|)
...
(def-mm-class |PrimitiveType| :uml211 (|DataType|)
...
(def-mm-class |Profile| :uml211 (|Package|)
...
(def-mm-class |ProfileApplication| :uml211 (|DirectedRelationship|)
"  A profile application is used to show which profiles have been applied
  ...
  :subsetted-properties ((|Element| |owner|) (|DirectedRelationship| |source|)) :opposite (|Package| |profileApplication|) 
    :documentation
...
(def-mm-class |Property| :uml211 (|TemplateableElement| |StructuralFeature| |DeploymentTarget| |ConnectableElement|)
"  Property specializes ParameterableElement to specify that a property can
  ...
  :subsetted-properties ((|Element| |owner|)) :opposite (|Property| |qualifier|) 
  :documentation
  ...
  :is-ordered-p t :subsetted-properties ((|Element| |ownedElement|)) :opposite (|Property| |associationEnd|) 
  :documentation
...
(def-mm-constraint "redefined_property_inherited" |Property| 
  ...
  the redefining property."
    :editor-note "Use implies, not if...MIWG: Replaced the body with TRUE, since it appears that redefinitionContext is a derived union with no subsetting properties."
    :operation-status :rewritten
    :operation-body "true"
    :original-body "    if (redefinedProperty->notEmpty()) then
     ...
     <br/><strong>Corrected but not used (see Editor's note above):</strong><br/>
      redefinedProperty->notEmpty() implies
           redefinitionContext->notEmpty() and
           redefinedProperty->forAll(rp|redefinitionContext->collect(fc | fc.allParents())->asSet()
...
(def-mm-operation "isAttribute" |Property| 
    ...
    :editor-note "What was really intended here was allInstances(), the OCL method (which I 
                  haven't yet implemented!). See discssion from these dates in the MIWG mail folder."
    :operation-body "Set{}"
...
"
    :operation-body "result = p->oclIsKindOf(self.oclType()) and self.type.conformsTo(p.oclAsType(TypedElement).type)"; pod
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
                      (make-instance 'ocl-parameter :parameter-name '|p| :parameter-type '|ParameterableElement| :parameter-return-p NIL))
  )
...
;;; pod class not classifier ??? I'm guessing. ....Wrong. Forget it.
(def-mm-operation "isNavigable" |Property| 
    "The query isNavigable() indicates whether it is possible to navigate across the property."
    :editor-note "Was classifier intended?"
    :operation-status :ignored
    :operation-body "Set{}"
    :original-body "result = not class->isEmpty() or association.owningAssociation.navigableOwnedEnd->includes(self)"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T))
  )
...
(def-mm-class |ProtocolConformance| :uml211 (|DirectedRelationship|)
"  Protocol state machines can be redefined into more specific protocol state
  ...
  :subsetted-properties ((|Element| |owner|) (|DirectedRelationship| |source|)) :opposite (|ProtocolStateMachine| |conformance|) 
    :documentation
   "  Specifies the state machine which conforms to the general state machine.")))


(def-mm-class |ProtocolStateMachine| :uml211 (|StateMachine|)
...
(def-mm-class |ProtocolTransition| :uml211 (|Transition|)
...
(def-mm-class |Pseudostate| :uml211 (|Vertex|)
...
(def-mm-constraint "initial_vertex" |Pseudostate| 
    ...
    :editor-note "size() not size."
    :operation-status :rewritten
    :operation-body "(self.kind = #initial) implies (self.outgoing->size() <= 1)"
    :original-body "(self.kind = #initial) implies (self.outgoing->size <= 1)")
...
(def-mm-constraint "outgoing_from_initial" |Pseudostate| 
  ...
  not a trigger or a guard."
    :editor-note "outgoing is a Collection."
    :operation-status :rewritten
    :operation-body "(self.kind = #initial) implies self.outgoing->forAll( out | out.guard->isEmpty())
  and self.outgoing->forAll( out | out.trigger->isEmpty())"
    :original-body "(self.kind = #initial) implies (self.outgoing.guard->isEmpty()
  and self.outgoing.trigger->isEmpty())")

;;; pod OCL will have to settle on one of , or ; (compare to iterate)
...
(def-mm-class |QualifierValue| :uml211 (|Element|)
...
(def-mm-class |RaiseExceptionAction| :uml211 (|Action|)
...
(def-mm-class |ReadExtentAction| :uml211 (|Action|)
...
(def-mm-constraint "multiplicity_of_result" |ReadExtentAction| 
    ...
    :editor-note "Use of 'is' should be investigated."
    :operation-body "self.result.is(0,LiteralUnlimitedNatural)")
...
(def-mm-class |ReadIsClassifiedObjectAction| :uml211 (|Action|)
...
(def-mm-class |ReadLinkAction| :uml211 (|LinkAction|)
...
(def-mm-constraint "compatible_multiplicity" |ReadLinkAction| 
  ...
  multiplicity of the result output pin."
    :editor-note "multiplicity, AssociationEnd, not defined."
    :operation-status :ignored
    :operation-body "true"
    :original-body "let openend : AssociationEnd = self.endData->select(ed | 
...
(def-mm-constraint "navigable_open_end" |ReadLinkAction| 
    ...
    :operation-body "true"
    :original-body "let openend : AssociationEnd = self.endData->select(ed | 
                      ed.value->size() = 0)->asSequence()->first().end in openend.isNavigable()")
...
(def-mm-class |ReadLinkObjectEndAction| :uml211 (|Action|)
...
(def-mm-class |ReadLinkObjectEndQualifierAction| :uml211 (|Action|)
...
(def-mm-class |ReadSelfAction| :uml211 (|Action|)
...
(def-mm-class |ReadStructuralFeatureAction| :uml211 (|StructuralFeatureAction|)
...
(def-mm-class |ReadVariableAction| :uml211 (|VariableAction|)
...
(def-mm-constraint "compatible_multiplicity" |ReadVariableAction| 
  ...
  of the output pin."
    :editor-note "multiplicity not defined."
    :operation-status :ignored
    :operation-body "true"
...
(def-mm-class |Realization| :uml211 (|Abstraction|)
...
(def-mm-class |ReceiveOperationEvent| :uml211 (|MessageEvent|)
...
(def-mm-class |ReceiveSignalEvent| :uml211 (|MessageEvent|)
...
(def-mm-class |Reception| :uml211 (|BehavioralFeature|)
...
(def-mm-class |ReclassifyObjectAction| :uml211 (|Action|)
...
(def-mm-class |RedefinableElement| :uml211 (|NamedElement|)
...
(def-mm-operation "isRedefinitionContextValid" |RedefinableElement| 
    ...
    :editor-note "Use intersection/notEmpty, not includes. Removed extra close paren...MIWG: Replaced the body with TRUE, since it appears that redefinitionContext is a derived union with no subsetting properties."
    :operation-status :ignored
    :operation-body "result = true"
    :original-body "result = redefinitionContext->exists(c | c.allParents()->includes(redefined.redefinitionContext)))      <br/><strong>Corrected but not used (see Editor's note above):</strong><br/>
      result = redefinitionContext->
                                 exists(c | c.allParents()-> 
                                             intersection(redefined.redefinitionContext)->notEmpty())"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
                      (make-instance 'ocl-parameter :parameter-name '|redefined| :parameter-type '|RedefinableElement| :parameter-return-p NIL))
  )


(def-mm-class |RedefinableTemplateSignature| :uml211 (|TemplateSignature| |RedefinableElement|)
...
(def-mm-class |ReduceAction| :uml211 (|Action|)
...
(def-mm-class |Region| :uml211 (|Namespace| |RedefinableElement|)
...
(def-mm-class |Relationship| :uml211 (|Element|)
...
(def-mm-class |RemoveStructuralFeatureValueAction| :uml211 (|WriteStructuralFeatureAction|)
...
(def-mm-class |RemoveVariableValueAction| :uml211 (|WriteVariableAction|)
...
(def-mm-class |ReplyAction| :uml211 (|Action|)
...
(def-mm-class |SendObjectAction| :uml211 (|InvocationAction|)
...
(def-mm-class |SendOperationEvent| :uml211 (|MessageEvent|)
...
(def-mm-class |SendSignalAction| :uml211 (|InvocationAction|)
...
(def-mm-class |SendSignalEvent| :uml211 (|MessageEvent|)
...
(def-mm-class |SequenceNode| :uml211 (|StructuredActivityNode|)
...
(def-mm-class |Signal| :uml211 (|Classifier|)
...
(def-mm-class |SignalEvent| :uml211 (|MessageEvent|)
...
(def-mm-class |Slot| :uml211 (|Element|)
...
(def-mm-class |StartClassifierBehaviorAction| :uml211 (|Action|)
...
(def-mm-class |State| :uml211 (|Namespace| |RedefinableElement| |Vertex|)
...
;;; pod stateMachine no statemachine 
...
(def-mm-class |StateInvariant| :uml211 (|InteractionFragment|)
...
(def-mm-class |StateMachine| :uml211 (|Behavior|)
...
(def-mm-class |Stereotype| :uml211 (|Class|)
...
(def-mm-constraint "generalize" |Stereotype| 
    ...
    :editor-note "Stereotype.generalization is a collection."
    :operation-status :rewritten
    :original-body "generalization.general->forAll(e |e.oclIsKindOf(Stereotype)) and generalization.specific->forAll(e | e.oclIsKindOf(Stereotype)) "
    :operation-body "generalization->forAll( g | g.general->notEmpty () implies g.general->forAll(e |e.oclIsKindOf(Stereotype)) and g.specific->forAll(e | e.oclIsKindOf(Stereotype))) "
)
...
(def-mm-class |StringExpression| :uml211 (|Expression| |TemplateableElement|)
"  An expression that specifies a string value that is derived by concatenating
 ...
 (  (|owningExpression| :range |StringExpression| :multiplicity (0  1) 
  :subsetted-properties ((|Element| |owner|)) :opposite (|StringExpression| |subExpression|) 
  :documentation
  ...
  :subsetted-properties ((|Element| |ownedElement|)) :opposite (|StringExpression| |owningExpression|) 
  :documentation
...
(def-mm-class |StructuralFeature| :uml211 (|MultiplicityElement| |TypedElement| |Feature|)
...
(def-mm-class |StructuralFeatureAction| :uml211 (|Action|)
...
(def-mm-constraint "visibility" |StructuralFeatureAction| 
  ...
  the action."
    ...
    :operation-status :ignored
    :operation-body "true"
    :operation-body "let host : Classifier = self.context in
...
(def-mm-class |StructuredActivityNode| :uml211 (|ActivityGroup| |Action| |Namespace|)
...
(def-mm-class |StructuredClassifier| :uml211 (|Classifier|)
...
(def-mm-class |Substitution| :uml211 (|Realization|)
...
(def-mm-class |TemplateBinding| :uml211 (|DirectedRelationship|)
...
(def-mm-class |TemplateParameter| :uml211 (|Element|)
"  A template parameter exposes a parameterable element as a formal template
  ...
  :subsetted-properties ((|TemplateParameter| |parameteredElement|) (|Element| |ownedElement|)) :opposite (|ParameterableElement| |owningTemplateParameter|) 
    :documentation
...
(def-mm-class |TemplateParameterSubstitution| :uml211 (|Element|)
"  A template parameter substitution relates the actual parameter(s) to a
  formal template parameter as part of a template binding."
...
(def-mm-class |TemplateSignature| :uml211 (|Element|)
"  A template signature bundles the set of formal template parameters for
  ...
  :is-ordered-p t :subsetted-properties ((|TemplateSignature| |parameter|) (|Element| |ownedElement|)) :opposite (|TemplateParameter| |signature|) 
    :documentation
...
(def-mm-class |TemplateableElement| :uml211 (|Element|)
...
(def-mm-class |TestIdentityAction| :uml211 (|Action|)
...
(def-mm-class |TimeConstraint| :uml211 (|IntervalConstraint|)
...
(def-mm-class |TimeEvent| :uml211 (|Event|)
"  A time event can be defined relative to entering the current state of the
  ...
  :default :FALSE 
   ...
   (|when| :range |ValueSpecification| :multiplicity (1 1 ) :is-composite-p t 
  :subsetted-properties ((|Element| |ownedElement|)) 
    :documentation
...
(def-mm-class |TimeExpression| :uml211 (|ValueSpecification|)
...
(def-mm-class |TimeInterval| :uml211 (|Interval|)
...
(def-mm-class |TimeObservation| :uml211 (|Observation|)
...
(def-mm-class |Transition| :uml211 (|Namespace| |RedefinableElement|)
"  A transition is a directed relationship between a source vertex and a target
  ...
  :opposite (|Vertex| |incoming|) 
   ...
   (|trigger| :range |Trigger| :multiplicity (0 -1 ) :is-composite-p t 
    :documentation
   "  Specifies the triggers that may fire the transition. <br/><strong>Editor's note:</strong> Made this owned by the Transition."
   :subsetted-properties ((|Element| |ownedElement|)))))
...
(def-mm-constraint "outgoing_pseudostates" |Transition| 
    ...
    :operation-body "source.oclIsKindOf(Pseudostate) and
...
(def-mm-class |Trigger| :uml211 (|NamedElement|)
...
(def-mm-class |Type| :uml211 (|PackageableElement|)
...
(def-mm-class |TypedElement| :uml211 (|NamedElement|)
...
(def-mm-class |UnmarshallAction| :uml211 (|Action|)
...
(def-mm-class |Usage| :uml211 (|Dependency|)
...
(def-mm-class |UseCase| :uml211 (|BehavioredClassifier|)
...
(def-mm-class |ValuePin| :uml211 (|InputPin|)
...
(def-mm-class |ValueSpecification| :uml211 (|PackageableElement| |TypedElement|)
...
(def-mm-operation "unlimitedValue" |ValueSpecification| 
    "The query unlimitedValue() gives a single UnlimitedNatural value when one can be computed."
     :operation-body "result = value.oclAsType(UnlimitedNatural)"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|UnlimitedNatural| :parameter-return-p T))
  )


(def-mm-class |ValueSpecificationAction| :uml211 (|Action|)
...
(def-mm-class |Variable| :uml211 (|ConnectableElement| |MultiplicityElement|)
...
(def-mm-class |VariableAction| :uml211 (|Action|)
...
(def-mm-class |Vertex| :uml211 (|NamedElement|)
...
if not container->isEmpty()
   then container.containingStateMachine()
    ...
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|StateMachine| 
				     :parameter-return-p T)))


(def-mm-class |WriteLinkAction| :uml211 (|LinkAction|)
...
(def-mm-class |WriteStructuralFeatureAction| :uml211 (|StructuralFeatureAction|)
...
(def-mm-class |WriteVariableAction| :uml211 (|VariableAction|)
...
(with-slots (mofi::abstract-classes) *model*
    (setf mofi::abstract-classes '(|Vertex| |FinalNode| |WriteStructuralFeatureAction| |StructuralFeature| |BehavioralFeature| |DeployedArtifact| |ConnectableElement| |InvocationAction| |CallAction| |Namespace| |Relationship| |NamedElement| |DirectedRelationship| |Classifier| |WriteLinkAction| |ParameterableElement| |MessageEnd| |ObjectNode| |Observation| |WriteVariableAction| |RedefinableElement| |Element| |TemplateableElement| |Feature| |StructuredClassifier| |Type| |Behavior| |Action| |TypedElement| |MessageEvent| |ExecutableNode| |EncapsulatedClassifier| |BehavioredClassifier| |PackageableElement| |InteractionFragment| |ActivityEdge| |ValueSpecification| |ExecutionSpecification| |LinkAction| |DeploymentTarget| |ActivityGroup| |LiteralSpecification| |ActivityNode| |MultiplicityElement| |ControlNode| |Event| |VariableAction| |StructuralFeatureAction| |Pin|))) 
