...
;;; Automatically generated from file /local/lisp/pod-utils/uml-utils/data/uml23/09-09-23.cmof 
;;; by UML Testbed tools on 2010-06-22 14:36:53
...
(def-mm-primitive |Boolean|
 (:UML23) NIL 
   "  A Boolean type is used for logical expression, consisting of the predefined
  values true and false.")

(def-mm-primitive |Integer|
 (:UML23) NIL 
   "  An integer is a primitive type representing integer values.")

(def-mm-primitive |String|
 (:UML23) NIL 
   "  A string is a sequence of characters in some suitable character set used
  to display information about the model. Character sets may include non-Roman
  alphabets and characters.")

(def-mm-primitive |UnlimitedNatural|
 (:UML23) NIL 
   "  An unlimited natural is a primitive type representing unlimited natural
  values.")

(def-mm-enum |AggregationKind|
 (:UML23) () (|composite| |none| |shared| )
...
(def-mm-enum |InteractionOperatorKind|
 (:UML23) () (|alt| |assert| |break| |consider| 
...
(def-mm-enum |MessageKind|
 (:UML23) () (|complete| |found| |lost| |unknown| )
    "  This is an enumerated type that identifies the type of message.")

(def-mm-enum |MessageSort|
 (:UML23) () (|asynchCall| |asynchSignal| |createMessage| |deleteMessage| 
   |reply| |synchCall| )
...
(def-mm-enum |ParameterEffectKind|
 (:UML23) () (|create| |delete| |read| |update| )
...
(def-mm-class |AcceptCallAction| (:UML23) (|AcceptEventAction|)
...
(def-mm-class |AcceptEventAction| (:UML23) (|Action|)
...
(def-mm-class |Action| (:UML23) (|ExecutableNode|)
"  An action has pre- and post-conditions."
  ...
  the total set of inputs.")
   (|isLocallyReentrant| :range |Boolean| :multiplicity (1 1 )
  :default :FALSE 
    :documentation
...
(def-mm-class |ActionExecutionSpecification| (:UML23) (|ExecutionSpecification|)
...
(def-mm-class |ActionInputPin| (:UML23) (|InputPin|)
...
(def-mm-class |Activity| (:UML23) (|Behavior|)
...
(def-mm-class |ActivityEdge| (:UML23) (|RedefinableElement|)
...
(def-mm-class |ActivityFinalNode| (:UML23) (|FinalNode|)
"  An activity final node is a final node that stops all flows in an activity."
  ())


(def-mm-class |ActivityGroup| (:UML23) (|NamedElement|)
...
(def-mm-class |ActivityNode| (:UML23) (|RedefinableElement|)
...
(def-mm-class |ActivityParameterNode| (:UML23) (|ObjectNode|)
...
(def-mm-class |ActivityPartition| (:UML23) (|ActivityGroup|)
...
(def-mm-class |Actor| (:UML23) (|BehavioredClassifier|)
...
(def-mm-constraint "associations" |Actor| 
  ...
  Furthermore these associations must be binary."
    :operation-body "self.ownedAttribute->forAll ( a |
...
(def-mm-class |AddStructuralFeatureValueAction| (:UML23) (|WriteStructuralFeatureAction|)
...
(def-mm-constraint "required_value" |AddStructuralFeatureValueAction| 
    ...
    :operation-body "self.value -> notEmpty()")
...
(def-mm-class |AddVariableValueAction| (:UML23) (|WriteVariableAction|)
...
(def-mm-class |AnyReceiveEvent| (:UML23) (|MessageEvent|)
...
(def-mm-class |Artifact| (:UML23) (|DeployedArtifact| |Classifier|)
...
(def-mm-class |Association| (:UML23) (|Classifier| |Relationship|)
...
(def-mm-constraint "association_ends" |Association| 
  ...
  by the association."
    :operation-body "if memberEnd->size() > 2 then ownedEnd->includesAll(memberEnd)")

(def-mm-constraint "binary_associations" |Association| 
    "  Only binary associations can be aggregations."
    :operation-body "self.memberEnd->exists(aggregation <> Aggregation::none) implies self.memberEnd->size() = 2")
...
(def-mm-constraint "specialized_end_number" |Association| 
  ...
  ends as the other association."
    :operation-body "parents()->select(oclIsKindOf(Association)).oclAsType(Association)->forAll(p | p.memberEnd->size() = self.memberEnd->size())")
...
(def-mm-constraint "specialized_end_types" |Association| 
  ...
  association corresponds to an end of the general association, and the specific
    ...
    :operation-body "Sequence{1..self.memberEnd->size()}->
...
(def-mm-class |AssociationClass| (:UML23) (|Class| |Association|)
...
(def-mm-constraint "cannot_be_defined" |AssociationClass| 
    ...
    :operation-body "self.endType->excludes(self) and self.endType>collect(et|et.allparents()->excludes(self))")
...
(def-mm-constraint "disjoint_attributes_ends" |AssociationClass| 
    ...
    :operation-body "ownedAttribute->intersection(ownedEnd)->isEmpty()")


(def-mm-class |Behavior| (:UML23) (|Class|)
...
(def-mm-class |BehaviorExecutionSpecification| (:UML23) (|ExecutionSpecification|)
...
(def-mm-class |BehavioralFeature| (:UML23) (|Namespace| |Feature|)
...
(def-mm-class |BehavioredClassifier| (:UML23) (|Classifier|)
...
(def-mm-constraint "class_behavior" |BehavioredClassifier| 
    ...
    :operation-body "self.classifierBehavior->notEmpty() implies self.classifierBehavior.specification->isEmpty()")


(def-mm-class |BroadcastSignalAction| (:UML23) (|InvocationAction|)
...
(def-mm-class |CallAction| (:UML23) (|InvocationAction|)
...
(def-mm-class |CallBehaviorAction| (:UML23) (|CallAction|)
...
(def-mm-class |CallEvent| (:UML23) (|MessageEvent|)
...
(def-mm-class |CallOperationAction| (:UML23) (|CallAction|)
...
(def-mm-class |CentralBufferNode| (:UML23) (|ObjectNode|)
"  A central buffer node is an object node for managing flows from multiple
  sources and destinations."
  ())


(def-mm-class |ChangeEvent| (:UML23) (|Event|)
...
(def-mm-class |Class| (:UML23) (|EncapsulatedClassifier| |BehavioredClassifier|)
...
(def-mm-operation "inherit" |Class| 
    ...
    :operation-body "result = inhs->excluding(inh | ownedMember->select(oclIsKindOf(RedefinableElement))->select(redefinedElement->includes(inh)))"
...
(def-mm-class |Classifier| (:UML23) (|Namespace| |TemplateableElement| |Type| |RedefinableElement|)
"  Classifier is defined to be a kind of templateable element so that a classifier
  ...
  used by other classifiers e.g. as the target of general metarelationships
  or generalization relationships.")
   (|isFinalSpecialization| :range |Boolean| :multiplicity (1 1 )
  :default :FALSE 
    :documentation
...
(def-mm-constraint "non_final_parents" |Classifier| 
    ...
    :operation-body "self.parents()->forAll(not isFinalSpecialization)")
...
(def-mm-operation "hasVisibilityOf" |Classifier| 
    ...
    :operation-body "result = if (self.inheritedMember->includes(n)) then (n.visibility <> #private) else true"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
                      (make-instance 'ocl-parameter :parameter-name '|n| :parameter-type '|NamedElement| :parameter-return-p NIL))
  )
...
(def-mm-operation "inheritableMembers" |Classifier| 
    ...
    :operation-body "result = member->select(m | c.hasVisibilityOf(m))"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|NamedElement| :parameter-return-p T)
...
(def-mm-operation "inheritedMember.1" |Classifier| 
    ...
    :operation-body "result = self.inherit(self.parents()->collect(p | p.inheritableMembers(self))"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|NamedElement| :parameter-return-p T))
  )

(def-mm-operation "isTemplate" |Classifier| 
    "The query isTemplate() returns whether this templateable element is actually a template."
    :operation-body "result = oclAsType(TemplatableElement).isTemplate() or general->exists(g | g.isTemplate())"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T))
  )
...
(def-mm-operation "parents" |Classifier| 
    ...
    :operation-body "result = generalization.general"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Classifier| :parameter-return-p T))
  )


(def-mm-class |ClassifierTemplateParameter| (:UML23) (|TemplateParameter|)
...
(def-mm-class |Clause| (:UML23) (|Element|)
...
(def-mm-class |ClearAssociationAction| (:UML23) (|Action|)
...
(def-mm-constraint "multiplicity" |ClearAssociationAction| 
    ...
    :operation-body "self.object.multiplicity.is(1,1)")
...
(def-mm-class |ClearStructuralFeatureAction| (:UML23) (|StructuralFeatureAction|)
...
(def-mm-constraint "multiplicity_of_result" |ClearStructuralFeatureAction| 
    ...
    :operation-body "result->notEmpty() implies self.result.multiplicity.is(1,1)")
...
(def-mm-class |ClearVariableAction| (:UML23) (|VariableAction|)
"  A clear variable action is a variable action that removes all values of
  a variable."
  ())


(def-mm-class |Collaboration| (:UML23) (|BehavioredClassifier| |StructuredClassifier|)
...
(def-mm-class |CollaborationUse| (:UML23) (|NamedElement|)
...
(def-mm-class |CombinedFragment| (:UML23) (|InteractionFragment|)
...
(def-mm-constraint "consider_and_ignore" |CombinedFragment| 
  ...
  the CombineIgnoreFragment subtype of CombinedFragment"
    :operation-body "((interactionOperator = #consider) or (interactionOperator = #ignore)) implies oclsisTypeOf(CombineIgnoreFragment)")
...
(def-mm-class |Comment| (:UML23) (|Element|)
...
(def-mm-class |CommunicationPath| (:UML23) (|Association|)
...
(def-mm-class |Component| (:UML23) (|Class|)
...
(def-mm-constraint "no_nested_classifiers" |Component| 
    ...
    :operation-body "self.nestedClassifier->isEmpty()")

(def-mm-constraint "no_packaged_elements" |Component| 
    "  component nested in a Class cannot have any packaged elements."
    :operation-body "(not self.class->isEmpty()) implies self.packagedElement->isEmpty()")
...
(def-mm-operation "usedInterfaces" |Component| 
    ...
    :operation-body "result = (classifier.supplierDependency->
...
(def-mm-class |ComponentRealization| (:UML23) (|Realization|)
"  The realization concept is specialized to (optionally) define the classifiers
  ...
  :subsetted-properties ((|Dependency| |supplier|) (|Element| |owner|)) :opposite (|Component| |realization|) 
    :documentation
...
(def-mm-class |ConditionalNode| (:UML23) (|StructuredActivityNode|)
"  A conditional node is a structured activity node that represents an exclusive
  ...
  :default :FALSE 
   ...
   (|result| :range |OutputPin| :multiplicity (0 -1 ) :is-composite-p t 
  :is-ordered-p t :redefined-property (|StructuredActivityNode| |structuredNodeOutput|) 
    :documentation
...
(def-mm-class |ConnectableElementTemplateParameter| (:UML23) (|TemplateParameter|)
...
(def-mm-class |ConnectionPointReference| (:UML23) (|Vertex|)
...
(def-mm-class |Connector| (:UML23) (|Feature|)
"  A delegation connector is a connector that links the external contract
  ...
  elements attached to this end. The set of connector ends is ordered.")
   (|kind| :range |ConnectorKind| :multiplicity (1 1 )
  :is-derived-p t 
    :documentation
...
then ConnectorKind::delegation 
    ...
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|ConnectorKind| :parameter-return-p T))
  )


(def-mm-class |ConnectorEnd| (:UML23) (|MultiplicityElement|)
...
(def-mm-class |ConsiderIgnoreFragment| (:UML23) (|CombinedFragment|)
...
(def-mm-class |Constraint| (:UML23) (|PackageableElement|)
...
(def-mm-constraint "value_specification_boolean" |Constraint| 
    "  The value specification for a constraint must evaluate to a Boolean value."
    :operation-body "self.specification().booleanValue().isOclKindOf(Boolean)")


(def-mm-class |Continuation| (:UML23) (|InteractionFragment|)
...
(def-mm-class |ControlFlow| (:UML23) (|ActivityEdge|)
...
(def-mm-class |ControlNode| (:UML23) (|ActivityNode|)
"  A control node is an abstract activity node that coordinates flows in an
  activity."
  ())


(def-mm-class |CreateLinkAction| (:UML23) (|WriteLinkAction|)
...
(def-mm-class |CreateLinkObjectAction| (:UML23) (|CreateLinkAction|)
...
(def-mm-constraint "multiplicity" |CreateLinkObjectAction| 
    ...
    :operation-body "self.result.multiplicity.is(1,1)")
...
(def-mm-class |CreateObjectAction| (:UML23) (|Action|)
...
(def-mm-class |CreationEvent| (:UML23) (|Event|)
...
(def-mm-class |DataStoreNode| (:UML23) (|CentralBufferNode|)
"  A data store node is a central buffer node for non-transient information."
  ())


(def-mm-class |DataType| (:UML23) (|Classifier|)
...
(def-mm-class |DecisionNode| (:UML23) (|ControlNode|)
...
(def-mm-class |Dependency| (:UML23) (|PackageableElement| |DirectedRelationship|)
...
(def-mm-class |DeploymentSpecification| (:UML23) (|Artifact|)
...
(def-mm-constraint "deployed_elements" |DeploymentSpecification| 
  ...
  (i.e. the configured components)."
    :operation-body "self.deployment->forAll (d | d.location.deployedElements->forAll (de |
...
(def-mm-class |DeploymentTarget| (:UML23) (|NamedElement|)
...
(def-mm-class |DestroyLinkAction| (:UML23) (|WriteLinkAction|)
...
(def-mm-class |DestroyObjectAction| (:UML23) (|Action|)
...
(def-mm-constraint "multiplicity" |DestroyObjectAction| 
    "  The multiplicity of the input pin is 1..1."
    :operation-body "self.target.multiplicity.is(1,1)")
...
(def-mm-class |DestructionEvent| (:UML23) (|Event|)
...
(def-mm-class |Device| (:UML23) (|Node|)
...
(def-mm-class |DirectedRelationship| (:UML23) (|Relationship|)
...
(def-mm-class |Duration| (:UML23) (|ValueSpecification|)
...
(def-mm-class |DurationConstraint| (:UML23) (|IntervalConstraint|)
"  A duration constraint is a constraint that refers to a duration interval."
  ...
  :redefined-property (|IntervalConstraint| |specification Constraint|) 
    :documentation
...
(def-mm-class |DurationInterval| (:UML23) (|Interval|)
...
(def-mm-class |DurationObservation| (:UML23) (|Observation|)
...
(def-mm-class |Element| (:UML23) NIL
...
(def-mm-class |ElementImport| (:UML23) (|DirectedRelationship|)
...
(def-mm-class |EncapsulatedClassifier| (:UML23) (|StructuredClassifier|)
"  A classifier has the ability to own ports as specific and type checked
  ...
  :is-derived-p t :subsetted-properties ((|StructuredClassifier| |ownedAttribute|)) 
    :documentation
   "  References a set of ports that an encapsulated classifier owns.")))


(def-mm-class |Enumeration| (:UML23) (|DataType|)
...
(def-mm-class |EnumerationLiteral| (:UML23) (|InstanceSpecification|)
...
(def-mm-class |ExecutableNode| (:UML23) (|ActivityNode|)
...
(def-mm-constraint "region_as_input_or_putput" |ExecutableNode| 
    "  One of regionAsInput or regionAsOutput must be non-empty, but not both."
    :operation-body "true")


(def-mm-class |ExecutionEnvironment| (:UML23) (|Node|)
...
(def-mm-class |ExecutionEvent| (:UML23) (|Event|)
"  An ExecutionEvent models the start or finish of an execution specification."
  ())


(def-mm-class |ExecutionOccurrenceSpecification| (:UML23) (|OccurrenceSpecification|)
...
(def-mm-class |ExecutionSpecification| (:UML23) (|InteractionFragment|)
...
(def-mm-class |ExpansionNode| (:UML23) (|ObjectNode|)
...
(def-mm-class |ExpansionRegion| (:UML23) (|StructuredActivityNode|)
...
(def-mm-class |Expression| (:UML23) (|ValueSpecification|)
...
(def-mm-class |Extend| (:UML23) (|NamedElement| |DirectedRelationship|)
...
(def-mm-class |Extension| (:UML23) (|Association|)
...
(def-mm-constraint "non_owned_end" |Extension| 
    ...
    :operation-body "metaclassEnd()->notEmpty() and metaclass()->oclIsKindOf(Class)")
...
lower bound, which normally, for MultiplicityElements, evaluates to 1 if empty."
    :operation-body "result = lowerBound = if lowerValue->isEmpty() then 0 else lowerValue->IntegerValue() endif"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Integer| :parameter-return-p T))
  )


(def-mm-class |ExtensionPoint| (:UML23) (|RedefinableElement|)
...
(def-mm-class |Feature| (:UML23) (|RedefinableElement|)
...
(def-mm-class |FinalNode| (:UML23) (|ControlNode|)
...
(def-mm-class |FinalState| (:UML23) (|State|)
...
(def-mm-class |FlowFinalNode| (:UML23) (|FinalNode|)
"  A flow final node is a final node that terminates a flow."
  ())


(def-mm-class |ForkNode| (:UML23) (|ControlNode|)
...
(def-mm-class |FunctionBehavior| (:UML23) (|OpaqueBehavior|)
...
(def-mm-constraint "one_output_parameter" |FunctionBehavior| 
    ...
    :operation-body "self.ownedParameters->
...
(def-mm-constraint "types_of_parameters" |FunctionBehavior| 
  ...
  but other datatypes."
    :operation-body "def: hasAllDataTypeAttributes(d : DataType) : Boolean =
...
(def-mm-class |Gate| (:UML23) (|MessageEnd|)
...
(def-mm-class |GeneralOrdering| (:UML23) (|NamedElement|)
...
(def-mm-class |Generalization| (:UML23) (|DirectedRelationship|)
...
(def-mm-class |GeneralizationSet| (:UML23) (|PackageableElement|)
...
(def-mm-class |Image| (:UML23) (|Element|)
...
(def-mm-class |Include| (:UML23) (|NamedElement| |DirectedRelationship|)
...
(def-mm-class |InformationFlow| (:UML23) (|PackageableElement| |DirectedRelationship|)
...
(def-mm-constraint "sources_and_targets_kind" |InformationFlow| 
  ...
  Property, Interface, Package, ActivityNode, ActivityPartition and InstanceSpecification
    ...
    :operation-body "(self.informationSource->forAll(p | p->oclIsKindOf(Actor) or oclIsKindOf(Node) or
...
(def-mm-class |InformationItem| (:UML23) (|Classifier|)
...
(def-mm-constraint "sources_and_targets" |InformationItem| 
  ...
  Signal, Component."
    :operation-body "(self.represented->select(p | p->oclIsKindOf(InformationItem))->forAll(p |
...
(def-mm-class |InitialNode| (:UML23) (|ControlNode|)
...
(def-mm-class |InputPin| (:UML23) (|Pin|)
...
(def-mm-class |InstanceSpecification| (:UML23) (|DeployedArtifact| |DeploymentTarget| |PackageableElement|)
...
(def-mm-class |InstanceValue| (:UML23) (|ValueSpecification|)
...
(def-mm-class |Interaction| (:UML23) (|Behavior| |InteractionFragment|)
...
(def-mm-class |InteractionConstraint| (:UML23) (|Constraint|)
...
(def-mm-class |InteractionFragment| (:UML23) (|NamedElement|)
...
(def-mm-class |InteractionOperand| (:UML23) (|Namespace| |InteractionFragment|)
...
(def-mm-class |InteractionUse| (:UML23) (|InteractionFragment|)
...
(def-mm-class |Interface| (:UML23) (|Classifier|)
"  Since an interface specifies conformance characteristics, it does not own
  ...
  :is-ordered-p t :subsetted-properties ((|Namespace| |ownedMember|)) 
   ...
   "  References all the Classifiers that are defined (nested) within the Class.")
   (|ownedAttribute| :range |Property| :multiplicity (0 -1 ) :is-composite-p t 
  :is-ordered-p t :subsetted-properties ((|Classifier| |attribute|) (|Namespace| |ownedMember|)) :opposite (|Property| |interface|) 
    :documentation
   "  The attributes (i.e. the properties) owned by the class.")
   (|ownedOperation| :range |Operation| :multiplicity (0 -1 ) :is-composite-p t 
...
(def-mm-class |InterfaceRealization| (:UML23) (|Realization|)
...
(def-mm-class |InterruptibleActivityRegion| (:UML23) (|ActivityGroup|)
...
(def-mm-class |Interval| (:UML23) (|ValueSpecification|)
...
(def-mm-class |IntervalConstraint| (:UML23) (|Constraint|)
...
(def-mm-class |InvocationAction| (:UML23) (|Action|)
...
(def-mm-class |JoinNode| (:UML23) (|ControlNode|)
...
(def-mm-constraint "incoming_object_flow" |JoinNode| 
  ...
  flow, otherwise, it must have an outgoing control flow."
    :operation-body "(self.incoming.select(e | e.isTypeOf(ObjectFlow)->notEmpty() implies
...
(def-mm-class |Lifeline| (:UML23) (|NamedElement|)
...
(def-mm-class |LinkAction| (:UML23) (|Action|)
...
(def-mm-constraint "not_static" |LinkAction| 
    ...
    :operation-body "self.endData->forall(end.oclisKindOf(NavigableEnd) implies end.isStatic = #false")
...
(def-mm-class |LinkEndCreationData| (:UML23) (|LinkEndData|)
...
(def-mm-constraint "create_link_action" |LinkEndCreationData| 
  ...
  its specializations."
    :operation-body "self.LinkAction.oclIsKindOf(CreateLinkAction)")
...
(def-mm-class |LinkEndData| (:UML23) (|Element|)
...
(def-mm-constraint "multiplicity" |LinkEndData| 
    ...
    :operation-body "self.value.multiplicity.is(1,1)")
...
(def-mm-class |LinkEndDestructionData| (:UML23) (|LinkEndData|)
...
(def-mm-class |LiteralBoolean| (:UML23) (|LiteralSpecification|)
...
(def-mm-class |LiteralInteger| (:UML23) (|LiteralSpecification|)
...
(def-mm-class |LiteralNull| (:UML23) (|LiteralSpecification|)
...
(def-mm-class |LiteralSpecification| (:UML23) (|ValueSpecification|)
"  A literal specification identifies a literal constant being modeled."
  ())


(def-mm-class |LiteralString| (:UML23) (|LiteralSpecification|)
...
(def-mm-class |LiteralUnlimitedNatural| (:UML23) (|LiteralSpecification|)
...
(def-mm-class |LoopNode| (:UML23) (|StructuredActivityNode|)
"  A loop node is a structured activity node that represents a loop with setup,
  ...
  :is-ordered-p t :redefined-property (|StructuredActivityNode| |structuredNodeInput|) 
    :documentation
...
(def-mm-class |Manifestation| (:UML23) (|Abstraction|)
...
(def-mm-class |MergeNode| (:UML23) (|ControlNode|)
...
(def-mm-class |Message| (:UML23) (|NamedElement|)
...
(def-mm-class |MessageEnd| (:UML23) (|NamedElement|)
...
(def-mm-class |MessageEvent| (:UML23) (|Event|)
"  A message event specifies the receipt by an object of either a call or
  a signal."
  ())


(def-mm-class |MessageOccurrenceSpecification| (:UML23) (|OccurrenceSpecification| |MessageEnd|)
...
(def-mm-class |Model| (:UML23) (|Package|)
...
(def-mm-class |MultiplicityElement| (:UML23) (|Element|)
...
(def-mm-constraint "lower_ge_0" |MultiplicityElement| 
    ...
    :operation-body "lowerBound()->notEmpty() implies lowerBound() >= 0")
...
(def-mm-operation "compatibleWith" |MultiplicityElement| 
    ...
    :operation-body "result = Integer.allInstances()->forAll(i : Integer | self.includesCardinality(i) implies other.includesCardinality(i))"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
...
(def-mm-operation "is" |MultiplicityElement| 
    ...
    :operation-body "result = (lowerbound = self.lowerbound and upperbound = self.upperbound)"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
...
(def-mm-operation "upperBound" |MultiplicityElement| 
    ...
    :operation-body "result = if upperValue->isEmpty() then 1 else upperValue.unlimitedValue() endif"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|UnlimitedNatural| :parameter-return-p T))
  )


(def-mm-class |NamedElement| (:UML23) (|Element|)
...
(def-mm-constraint "has_qualified_name" |NamedElement| 
  ...
  the qualified name is constructed from the names of the containing namespaces."
    :operation-body "(self.name->notEmpty() and self.allNamespaces()->select(ns | ns.name->isEmpty())->isEmpty()) implies
...
(def-mm-constraint "visibility_needs_ownership" |NamedElement| 
    ...
    :operation-body "namespace->isEmpty() implies visibility->isEmpty()")
...
(def-mm-operation "allOwningPackages" |NamedElement| 
    ...
    :operation-body "result = self.namespace->select(p | p.oclIsKindOf(Package))->union(p.allOwningPackages())"
...
(def-mm-operation "qualifiedName.1" |NamedElement| 
    ...
    :operation-body "result = if self.name->notEmpty() and self.allNamespaces()->select(ns | ns.name->isEmpty())->isEmpty()
then 
...
(def-mm-class |Namespace| (:UML23) (|NamedElement|)
...
then Set{}->include(element.name)
  ...
  then elementImports->collect(el | el.getName())
    ...
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|String| :parameter-return-p T)
                      (make-instance 'ocl-parameter :parameter-name '|element| :parameter-type '|NamedElement| :parameter-return-p NIL))
  )

(def-mm-operation "importMembers" |Namespace| 
    "The query importMembers() defines which of a set of PackageableElements are actually imported into the namespace. This excludes hidden ones, i.e., those which have names that conflict with names of owned members, and also excludes elements which would have the same name when imported."
    :operation-body "result = self.excludeCollisions(imps)->select(imp | self.ownedMember->forAll(mem |
...
(def-mm-operation "importedMember.1" |Namespace| 
    ...
    :operation-body "result = self.importMembers(self.elementImport.importedElement.asSet()-
...
(def-mm-class |Node| (:UML23) (|DeploymentTarget| |Class|)
...
(def-mm-class |ObjectFlow| (:UML23) (|ActivityEdge|)
...
(def-mm-class |ObjectNode| (:UML23) (|TypedElement| |ActivityNode|)
...
(def-mm-class |Observation| (:UML23) (|PackageableElement|)
...
(def-mm-class |OccurrenceSpecification| (:UML23) (|InteractionFragment|)
...
(def-mm-class |OpaqueAction| (:UML23) (|Action|)
...
(def-mm-class |OpaqueBehavior| (:UML23) (|Behavior|)
...
(def-mm-class |OpaqueExpression| (:UML23) (|ValueSpecification|)
...
(def-mm-class |Operation| (:UML23) (|TemplateableElement| |ParameterableElement| |BehavioralFeature|)
"  Operation specializes TemplateableElement in order to support specification
  ...
  :subsetted-properties ((|Feature| |featuringClassifier|) (|NamedElement| |namespace|) (|RedefinableElement| |redefinitionContext|)) :opposite (|Interface| |ownedOperation|) 
    :documentation
...
(def-mm-operation "isConsistentWith" |Operation| 
    ...
    :operation-body "result = redefinee.oclIsKindOf(Operation) and
...
(def-mm-class |OperationTemplateParameter| (:UML23) (|TemplateParameter|)
...
(def-mm-class |OutputPin| (:UML23) (|Pin|)
...
(def-mm-class |Package| (:UML23) (|TemplateableElement| |Namespace| |PackageableElement|)
...
(def-mm-constraint "elements_public_or_private" |Package| 
  ...
  private."
    :operation-body "self.ownedElements->forAll(e | e.visibility->notEmpty() implies e.visbility = #public or e.visibility = #private)")
...
self.ownedStereotype->union(self.ownedMember->
    ...
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Stereotype| :parameter-return-p T))
  )
...
if self.oclIsKindOf(Profile) then 
    ...
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Profile| :parameter-return-p T))
  )
...
(def-mm-class |PackageImport| (:UML23) (|DirectedRelationship|)
...
(def-mm-class |PackageMerge| (:UML23) (|DirectedRelationship|)
...
(def-mm-class |PackageableElement| (:UML23) (|ParameterableElement| |NamedElement|)
...
(def-mm-class |Parameter| (:UML23) (|ConnectableElement| |MultiplicityElement|)
...
(def-mm-constraint "connector_end" |Parameter| 
  ...
  of a collaboration."
    :operation-body "self.end.notEmpty() implies self.collaboration.notEmpty()")
...
(def-mm-class |ParameterSet| (:UML23) (|NamedElement|)
...
(def-mm-class |ParameterableElement| (:UML23) (|Element|)
...
(def-mm-class |PartDecomposition| (:UML23) (|InteractionUse|)
...
(def-mm-class |Pin| (:UML23) (|ObjectNode| |MultiplicityElement|)
...
(def-mm-class |Port| (:UML23) (|Property|)
"  A port has an associated protocol state machine."
  ...
  by any instances that this classifier may contain.")
   (|isConjugated| :range |Boolean| :multiplicity (1 1 )
  :default :FALSE 
    :documentation
...
(def-mm-class |PrimitiveType| (:UML23) (|DataType|)
...
(def-mm-class |Profile| (:UML23) (|Package|)
...
(def-mm-constraint "metaclass_reference_not_specialized" |Profile| 
  ...
  in a Profile."
    :operation-body "self.metaclassReference.importedElement->
...
(def-mm-constraint "references_same_metamodel" |Profile| 
  ...
  are members of the same base reference metamodel."
    :operation-body "self.metamodelReference.importedPackage.elementImport.importedElement.allOwningPackages()->
  union(self.metaclassReference.importedElement.allOwningPackages() )->notEmpty()")


(def-mm-class |ProfileApplication| (:UML23) (|DirectedRelationship|)
...
(def-mm-class |Property| (:UML23) (|StructuralFeature| |DeploymentTarget| |ConnectableElement|)
"  Property specializes ParameterableElement to specify that a property can
  ...
  :subsetted-properties ((|Element| |owner|)) 
   ...
   (|class| :range |Class| :multiplicity (0 1 )
  :subsetted-properties ((|A_attribute_classifier| |classifier|) (|Feature| |featuringClassifier|) (|NamedElement| |namespace|)) :opposite (|Class| |ownedAttribute|) 
    :documentation
   "  References the Class that owns the Property.")
   (|datatype| :range |DataType| :multiplicity (0 1 )
  :subsetted-properties ((|A_attribute_classifier| |classifier|) (|Feature| |featuringClassifier|) (|NamedElement| |namespace|)) :opposite (|DataType| |ownedAttribute|) 
    :documentation
  ...
  Property when an object of the owning Classifier is instantiated.")
   (|interface| :range |Interface| :multiplicity (0 1 )
  :subsetted-properties ((|A_attribute_classifier| |classifier|) (|Feature| |featuringClassifier|) (|NamedElement| |namespace|)) :opposite (|Interface| |ownedAttribute|) )
...
(def-mm-constraint "navigable_readonly" |Property| 
    ...
    :operation-body "isReadOnly implies isNavigable()")
...
(def-mm-constraint "redefined_property_inherited" |Property| 
  ...
  the redefining property."
    :operation-body "if (redefinedProperty->notEmpty()) then
...
(def-mm-constraint "subsetting_context_conforms" |Property| 
  ...
  to the context of the subsetted property."
    :operation-body "self.subsettedProperty->notEmpty() implies
...
(def-mm-operation "opposite.1" |Property| 
    ...
    :operation-body "result = if owningAssociation->isEmpty() and association.memberEnd->size() = 2
  then
...
(def-mm-operation "subsettingContext" |Property| 
    ...
    :operation-body "result = if association->notEmpty()
...
(def-mm-class |ProtocolConformance| (:UML23) (|DirectedRelationship|)
...
(def-mm-class |ProtocolStateMachine| (:UML23) (|StateMachine|)
...
(def-mm-constraint "deep_or_shallow_history" |ProtocolStateMachine| 
    ...
    :operation-body "region->forAll (r | r.subvertex->forAll (v | v.oclIsKindOf(Psuedostate) implies
...
(def-mm-class |ProtocolTransition| (:UML23) (|Transition|)
...
(def-mm-class |Pseudostate| (:UML23) (|Vertex|)
...
(def-mm-class |QualifierValue| (:UML23) (|Element|)
...
(def-mm-constraint "qualifier_attribute" |QualifierValue| 
  ...
  link-end data."
    :operation-body "self.LinkEndData.end->collect(qualifier)->includes(self.qualifier)")
...
(def-mm-class |RaiseExceptionAction| (:UML23) (|Action|)
...
(def-mm-class |ReadExtentAction| (:UML23) (|Action|)
...
(def-mm-constraint "multiplicity_of_result" |ReadExtentAction| 
    ...
    :operation-body "self.result.multiplicity.is(0,#null)")
...
(def-mm-class |ReadIsClassifiedObjectAction| (:UML23) (|Action|)
...
(def-mm-class |ReadLinkAction| (:UML23) (|LinkAction|)
...
(def-mm-constraint "compatible_multiplicity" |ReadLinkAction| 
  ...
  multiplicity of the result output pin."
    :operation-body "let openend : Property = self.endData->select(ed | ed.value->size() = 0)->asSequence()->first().end in
...
(def-mm-class |ReadLinkObjectEndAction| (:UML23) (|Action|)
...
(def-mm-class |ReadLinkObjectEndQualifierAction| (:UML23) (|Action|)
...
(def-mm-constraint "multiplicity_of_qualifier" |ReadLinkObjectEndQualifierAction| 
    ...
    :operation-body "self.qualifier.multiplicity.is(1,1)")
...
(def-mm-class |ReadSelfAction| (:UML23) (|Action|)
...
(def-mm-class |ReadStructuralFeatureAction| (:UML23) (|StructuralFeatureAction|)
...
(def-mm-constraint "multiplicity" |ReadStructuralFeatureAction| 
  ...
  multiplicity of the output pin."
    :operation-body "self.structuralFeature.multiplicity.compatibleWith(self.result.multiplicity)")
...
(def-mm-class |ReadVariableAction| (:UML23) (|VariableAction|)
...
(def-mm-constraint "compatible_multiplicity" |ReadVariableAction| 
  ...
  of the output pin."
    :operation-body "self.variable.multiplicity.compatibleWith(self.result.multiplicity)")
...
(def-mm-class |Realization| (:UML23) (|Abstraction|)
...
(def-mm-class |ReceiveOperationEvent| (:UML23) (|MessageEvent|)
...
(def-mm-class |ReceiveSignalEvent| (:UML23) (|MessageEvent|)
...
(def-mm-class |Reception| (:UML23) (|BehavioralFeature|)
...
(def-mm-class |ReclassifyObjectAction| (:UML23) (|Action|)
...
(def-mm-constraint "multiplicity" |ReclassifyObjectAction| 
    "  The multiplicity of the input pin is 1..1."
    :operation-body "self.argument.multiplicity.is(1,1)")


(def-mm-class |RedefinableElement| (:UML23) (|NamedElement|)
...
(def-mm-constraint "non_leaf_redefinition" |RedefinableElement| 
    ...
    :operation-body "self.redefinedElement->forAll(not isLeaf)")
...
(def-mm-operation "isRedefinitionContextValid" |RedefinableElement| 
    ...
    :operation-body "result = redefinitionContext->exists(c | c.allParents()->includes(redefined.redefinitionContext)))"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
                      (make-instance 'ocl-parameter :parameter-name '|redefined| :parameter-type '|RedefinableElement| :parameter-return-p NIL))
  )


(def-mm-class |RedefinableTemplateSignature| (:UML23) (|TemplateSignature| |RedefinableElement|)
"  A redefinable template signature supports the addition of formal template
  ...
  ((|classifier| :range |Classifier| :multiplicity (1 1 )
  :subsetted-properties ((|Element| |owner|) (|RedefinableElement| |redefinitionContext|)) :redefined-property (|TemplateSignature| |template|) :opposite (|Classifier| |ownedTemplateSignature|) 
    :documentation
...
(def-mm-operation "isConsistentWith" |RedefinableTemplateSignature| 
    ...
    :operation-body "result = redefinee.oclIsKindOf(RedefineableTemplateSignature)"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Boolean| :parameter-return-p T)
                      (make-instance 'ocl-parameter :parameter-name '|redefinee| :parameter-type '|RedefinableElement| :parameter-return-p NIL))
  )


(def-mm-class |ReduceAction| (:UML23) (|Action|)
...
(def-mm-class |Region| (:UML23) (|Namespace| |RedefinableElement|)
...
(def-mm-class |Relationship| (:UML23) (|Element|)
...
(def-mm-class |RemoveStructuralFeatureValueAction| (:UML23) (|WriteStructuralFeatureAction|)
...
(def-mm-constraint "non_unique_removal" |RemoveStructuralFeatureValueAction| 
  ...
  pin."
    :operation-body "if not self.structuralFeature.isOrdered or self.structuralFeature.isUnique or  isRemoveDuplicates then
...
(def-mm-class |RemoveVariableValueAction| (:UML23) (|WriteVariableAction|)
...
(def-mm-constraint "unlimited_natural" |RemoveVariableValueAction| 
  ...
  1..1. Otherwise, the action has a value input pin and no removeAt input
  pin."
    :operation-body "if not self.variable.isOrdered or self.variable.isUnique or isRemoveDuplicates then 
  self.removeAt -> isEmpty() and self.value -> notEmpty()
else
  self.value -> isEmpty() and
  self.removeAt -> notEmpty() and
...
(def-mm-class |ReplyAction| (:UML23) (|Action|)
...
(def-mm-constraint "event_on_reply_to_call_trigger" |ReplyAction| 
    ...
    :operation-body "replyToCallEvent.oclIsKindOf(CallEvent)")
...
(def-mm-class |SendObjectAction| (:UML23) (|InvocationAction|)
...
(def-mm-class |SendOperationEvent| (:UML23) (|MessageEvent|)
...
(def-mm-class |SendSignalAction| (:UML23) (|InvocationAction|)
...
(def-mm-class |SendSignalEvent| (:UML23) (|MessageEvent|)
...
(def-mm-class |SequenceNode| (:UML23) (|StructuredActivityNode|)
...
(def-mm-class |Signal| (:UML23) (|Classifier|)
...
(def-mm-class |SignalEvent| (:UML23) (|MessageEvent|)
...
(def-mm-class |Slot| (:UML23) (|Element|)
...
(def-mm-class |StartClassifierBehaviorAction| (:UML23) (|Action|)
...
(def-mm-class |StartObjectBehaviorAction| (:UML23) (|CallAction|)
...
(def-mm-class |State| (:UML23) (|Namespace| |RedefinableElement| |Vertex|)
...
(def-mm-constraint "composite_states" |State| 
    ...
    :operation-body "connectionPoint->notEmpty() implies isComoposite")
...
(def-mm-class |StateInvariant| (:UML23) (|InteractionFragment|)
...
(def-mm-class |StateMachine| (:UML23) (|Behavior|)
...
(def-mm-constraint "connection_points" |StateMachine| 
  ...
  point or exit point."
    :operation-body "conectionPoint->forAll (c | c.kind = #entryPoint or c.kind = #exitPoint)")
...
(def-mm-class |Stereotype| (:UML23) (|Class|)
"  A stereotype defines how an existing metaclass may be extended, and enables
  ...
  the extended model elements.")
   (|profile| :range |Profile| :multiplicity (1 1 )
  :is-derived-p t 
    :documentation
...
(def-mm-operation "containingProfile" |Stereotype| 
    ...
    :operation-body "result = self.namespace.oclAsType(Package).containingProfile()"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Profile| :parameter-return-p T))
  )

(def-mm-operation "profile.1" |Stereotype| 
    "A stereotype must be contained, directly or indirectly, in a profile."
    :operation-body "result = self.containingProfile()"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|Profile| :parameter-return-p T))
  )


(def-mm-class |StringExpression| (:UML23) (|Expression| |TemplateableElement|)
...
(def-mm-constraint "subexpressions" |StringExpression| 
  ...
  between operands and subexpressions)."
    :operation-body "if subExpression->notEmpty() then operand->isEmpty() else operand->notEmpty()")
...
(def-mm-class |StructuralFeature| (:UML23) (|MultiplicityElement| |TypedElement| |Feature|)
...
(def-mm-class |StructuralFeatureAction| (:UML23) (|Action|)
...
(def-mm-constraint "multiplicity" |StructuralFeatureAction| 
    "  The multiplicity of the object input pin must be 1..1."
    :operation-body "self.object.lowerBound()=1 and self.object.upperBound()=1")
...
(def-mm-constraint "same_type" |StructuralFeatureAction| 
  ...
  the opposite end being the type of the object input pin."
    :operation-body "self.structuralFeature.featuringClassifier.oclAsType(Type)->includes(self.object.type) or
...
(def-mm-class |StructuredActivityNode| (:UML23) (|ActivityGroup| |Action| |Namespace|)
...
(def-mm-class |StructuredClassifier| (:UML23) (|Classifier|)
...
(def-mm-class |Substitution| (:UML23) (|Realization|)
...
(def-mm-class |TemplateBinding| (:UML23) (|DirectedRelationship|)
...
(def-mm-class |TemplateParameter| (:UML23) (|Element|)
...
(def-mm-class |TemplateParameterSubstitution| (:UML23) (|Element|)
...
(def-mm-class |TemplateSignature| (:UML23) (|Element|)
...
(def-mm-constraint "own_elements" |TemplateSignature| 
  ...
  be owned by the element being templated."
    :operation-body "templatedElement.ownedElement->includesAll(parameter.parameteredElement - parameter.ownedParameteredElement)")


(def-mm-class |TemplateableElement| (:UML23) (|Element|)
...
(def-mm-operation "parameterableElements" |TemplateableElement| 
    ...
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|ParameterableElement| :parameter-return-p T))
  )


(def-mm-class |TestIdentityAction| (:UML23) (|Action|)
...
(def-mm-constraint "multiplicity" |TestIdentityAction| 
    ...
    :operation-body "self.first.multiplicity.is(1,1)
...
(def-mm-class |TimeConstraint| (:UML23) (|IntervalConstraint|)
...
(def-mm-class |TimeEvent| (:UML23) (|Event|)
...
(def-mm-class |TimeExpression| (:UML23) (|ValueSpecification|)
...
(def-mm-class |TimeInterval| (:UML23) (|Interval|)
...
(def-mm-class |TimeObservation| (:UML23) (|Observation|)
...
(def-mm-class |Transition| (:UML23) (|Namespace| |RedefinableElement|)
...
(def-mm-constraint "initial_transition" |Transition| 
  ...
  has no trigger or it has a trigger with the stereotype <<create>>."
    :operation-body "self.source.oclIsKindOf(Pseudostate) implies
...
(def-mm-constraint "state_is_external" |Transition| 
    ...
    :operation-body "(kind = TransitionKind::external) implies
...
(def-mm-constraint "state_is_internal" |Transition| 
  ...
  source and target must be equal."
    :operation-body "(kind = TransitionKind::internal) implies
...
(def-mm-constraint "state_is_local" |Transition| 
  ...
  as its source."
    :operation-body "(kind = TransitionKind::local) implies
...
(def-mm-operation "isConsistentWith" |Transition| 
    ...
    :operation-body "result = (redefinee.oclIsKindOf(Transition) and
...
(def-mm-class |Trigger| (:UML23) (|NamedElement|)
...
(def-mm-class |Type| (:UML23) (|PackageableElement|)
...
(def-mm-class |TypedElement| (:UML23) (|NamedElement|)
...
(def-mm-class |UnmarshallAction| (:UML23) (|Action|)
...
(def-mm-class |Usage| (:UML23) (|Dependency|)
...
(def-mm-class |UseCase| (:UML23) (|BehavioredClassifier|)
...
(def-mm-operation "allIncludedUseCases" |UseCase| 
    ...
    :operation-body "result = self.include->union(self.include->collect(in | in.allIncludedUseCases()))"
    :parameters (list (make-instance 'ocl-parameter :parameter-name nil :parameter-type '|UseCase| :parameter-return-p T))
  )


(def-mm-class |ValuePin| (:UML23) (|InputPin|)
...
(def-mm-class |ValueSpecification| (:UML23) (|PackageableElement| |TypedElement|)
...
(def-mm-class |ValueSpecificationAction| (:UML23) (|Action|)
...
(def-mm-class |Variable| (:UML23) (|ConnectableElement| |MultiplicityElement|)
...
(def-mm-class |VariableAction| (:UML23) (|Action|)
...
(def-mm-class |Vertex| (:UML23) (|NamedElement|)
"  A vertex is an abstraction of a node in a state machine graph. In general,
  ...
  :is-derived-p t :opposite (|Transition| |target|) 
    :documentation
...
(def-mm-operation "containingStateMachine" |Vertex| 
    ...
    :operation-body "result = if not container->isEmpty()
then
...
(def-mm-operation "incoming.1" |Vertex| 
    ""
    :operation-body "result = Transition.allInstances()->select(t | t.target=self)"
...
(def-mm-class |WriteLinkAction| (:UML23) (|LinkAction|)
...
(def-mm-class |WriteStructuralFeatureAction| (:UML23) (|StructuralFeatureAction|)
...
(def-mm-constraint "input_pin" |WriteStructuralFeatureAction| 
    ...
    :operation-body "self.value -> notEmpty() implies
...
(def-mm-class |WriteVariableAction| (:UML23) (|VariableAction|)
...
(def-mm-constraint "same_type" |WriteVariableAction| 
    ...
    :operation-body "self.value -> notEmpty() implies self.value.type = self.variable.type")

(with-slots (mofi::abstract-classes) *model*
    (setf mofi::abstract-classes '(|StructuralFeature| |ExecutableNode| |Event| |PackageableElement| |DeploymentTarget| |ValueSpecification| |TypedElement| |LiteralSpecification| |ObjectNode| |TemplateableElement| |DeployedArtifact| |StructuredClassifier| |ParameterableElement| |InvocationAction| |BehavioralFeature| |VariableAction| |ActivityGroup| |CallAction| |EncapsulatedClassifier| |StructuralFeatureAction| |ActivityEdge| |Relationship| |WriteStructuralFeatureAction| |FinalNode| |BehavioredClassifier| |Observation| |Namespace| |DirectedRelationship| |ActivityNode| |Vertex| |NamedElement| |ControlNode| |MessageEnd| |Behavior| |Classifier| |Element| |LinkAction| |WriteLinkAction| |MessageEvent| |RedefinableElement| |WriteVariableAction| |MultiplicityElement| |InteractionFragment| |ConnectableElement| |Feature| |ExecutionSpecification| |Type| |Action|))) 
