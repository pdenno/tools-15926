...
"  An extension is used to indicate that the properties of a metaclass are
  ...
  :is-derived-p t #|:default :FALSE|# ; POD UML2.2 I don't think putting a default value on a derived is a good idea.
    :documentation
...
(def-mm-class |Integer| (:UML22) (|PrimitiveType|)
	      "An integer is a primitive type representing integer values." 
	      ())
(def-mm-class |Boolean| (:UML22) (|PrimitiveType|) 
	      "A Boolean type is used for logical expression, consisting of the predefined values true and false." 
	      ())
(def-mm-class |String|  (:UML22) (|PrimitiveType|) 
	      ...
	      ())
(def-mm-class |UnlimitedNatural| (:UML22) (|PrimitiveType|)
...
(def-mm-operation "isRedefinitionContextValid" |RedefinableElement| 
    ...
    :editor-note "Remove extra close paren."
    :operation-status :rewritten
