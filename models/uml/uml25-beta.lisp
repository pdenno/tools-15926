;;; Automatically created by pop-gen at 2012-11-04 11:18:29.
;;; Source file is /local/lisp/pod-utils/uml-utils/data/uml25/2012-08-03/UML.xmi
...
(def-meta-enum |MessageSort| (:model :UML25 :superclasses NIL 
   :xmi-id "MessageSort")
   (|asynchCall| |asynchSignal| |createMessage| |deleteMessage| |reply| |synchCall|)
...
(def-meta-enum |PseudostateKind| (:model :UML25 :superclasses NIL 
   ...
   (|choice| |deepHistory| |entryPoint| |exitPoint| |fork| |initial| |join| |junction| |shallowHistory| |terminate|)
...
(def-meta-class |AcceptEventAction| 
 ...
 "A AcceptEventAction is an Action that waits for the occurrence of one or
...
(def-meta-operation "containingBehavior" |Action| 
   ""
   :operation-body
   "if inStructuredNode<>null then inStructuredNode.containingBehavior()   else if activity<>null then activity  else interaction   endif  endif  "
   :parameters
...
(def-meta-operation "context.1" |Action| 
   ...
   :operation-body
   "let behavior: Behavior = self.containingBehavior() in  if behavior=null then null  else if behavior._'context' = null then behavior  else behavior._'context'  endif  endif"
   :parameters
 ...
 "An ActivityEdge is an abstract class for directed connections between two
  ...
  ((|activity| :range |Activity| :multiplicity (0 1)
   ...
   (|redefinedEdge| :range |ActivityEdge| :multiplicity (0 -1)
    ...
    :documentation
     "ActivityEdges from a generalization of the Activity containining this ActivityEdge
...
(def-meta-operation "isConsistentWith" |ActivityEdge| 
   ""
   :operation-body
   "redefinee.oclIsKindOf(ActivityEdge)"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|redefinee| :parameter-type '|RedefinableElement|
...
(def-meta-operation "containingActivity" |ActivityGroup| 
   ...
   :operation-body
   "if superGroup<>null then superGroup.containingActivity()  else inActivity  endif"
   :parameters
 ...
 "ActivityNode is an abstract class for points in the flow of an Activity
  ...
  ((|activity| :range |Activity| :multiplicity (0 1)
   ...
   (|inGroup| :range |ActivityGroup| :multiplicity (0 -1) :is-derived-union-p T :is-readonly-p T :is-derived-p T
    ...
    :documentation
     "ActivityGroups containing the ActivityNodeode.")
   ...
   (|inStructuredNode| :range |StructuredActivityNode| :multiplicity (0 1)
    ...
    :documentation
     "The StructuredActivityNode containing the ActvityNode, if its is directly
...
(def-meta-operation "containingActivity" |ActivityNode| 
   ...
   :operation-body
   "if inStructuredNode<>null then inStructuredNode.containingActivity()  else activity  endif"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Activity|
                        :parameter-return-p T))
)
...
(def-meta-operation "isConsistentWith" |ActivityNode| 
   ""
   :operation-body
   "redefinee.oclIsKindOf(ActivityNode)"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|redefinee| :parameter-type '|RedefinableElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
  ...
  ((|insertAt| :range |InputPin| :multiplicity (0 1) :is-composite-p T
    ...
    :documentation
     "The InputPin that gives the position at which to insert a new value or
      ...
      is UnlimitedINatural, but the value cannot be zero. It is omitted for unordered
      Variables.")
   (|isReplaceAll| :range |Boolean| :multiplicity (1 1) :default :false
    :documentation
...
(def-meta-operation "outputParameters" |Behavior| 
   "The out, inout and return ownedParamters."
   :operation-body
...
(def-meta-operation "isDistinguishableFrom" |BehavioralFeature| 
   "The query isDistinguishableFrom() determines whether two BehavioralFeatures
    ...
    signatures."
   :operation-body
   "(n.oclIsKindOf(BehavioralFeature) and ns.getNamesOfMember(self)->intersection(ns.getNamesOfMember(n))->notEmpty()) implies   Set{self}->including(n.oclAsType(BehavioralFeature))->isUnique(ownedParameter->collect(type))   "
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '\n :parameter-type '|NamedElement|
                        :parameter-return-p NIL)
...
(def-meta-operation "outputParameters" |BehavioralFeature| 
   "The ownedParameters with direciton out, inout or return."
   :operation-body
   "ownedParameter->select(direction=ParameterDirectionKind::out or direction=ParameterDirectionKind::inout or direction=ParameterDirectionKind::return)"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Parameter|
...
(def-meta-class |BroadcastSignalAction| 
 ...
 "A BroadcastSignalAction is an InvocationAction that transmits a Signal
  ...
  the Signal. The requestor continues execution immendiately after the Signal
...
(def-meta-operation "outputParameters" |CallOperationAction| 
   "Return the inout, out and return ownedParameters of theOperation being
    called."
   :operation-body
...
(def-meta-operation "inherit" |Class| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|inhs| :parameter-type '|NamedElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|NamedElement|
                        :parameter-return-p T))
)
...
(def-meta-operation "conformsTo" |Classifier| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|other| :parameter-type '|Classifier|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "inheritableMembers" |Classifier| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '\c :parameter-type '|Classifier|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|NamedElement|
                        :parameter-return-p T))
)
   ...
   (|exceptionType| :range |Classifier| :multiplicity (1 -1) :soft-opposite (|Classifier| |exceptionHandler|)
    :documentation
     "The Classifiers whose instances the ExceptionHandler catches as exceptions.
      ...
      catches the exception and excutes the handlerBody.")
...
(def-meta-class |ExpansionNode| 
 ...
 "An ExpansionNode is an ObjectNode used to indicate a collection input or
  ...
  of an ExpansionReagion combines individual elements produced by the execution
...
(def-meta-class |ExpansionRegion| 
 ...
 "An ExpansionRegion is a StructuredActivityR that executes its content multiple
  times corresponding to elements of input collection(s)."
...
(def-meta-operation "hasAllDataTypeAttributes" |FunctionBehavior| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '\d :parameter-type '|DataType|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "matches" |Gate| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|gateToMatch| :parameter-type '|Gate|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-class |LinkEndData| 
 ...
 "LinkEndData is an Element that identifies on end of a link to be read or
  written by a LinkAction. Since a link (that is not a link object) cannot
  be passed as a runtime value to or from an Action, it is instead identified
   ...
   (|loopVariable| :range |OutputPin| :multiplicity (0 -1) :is-composite-p T :is-ordered-p T
    ...
    :documentation
     "A list of OutputPins that hold the values of the loop variables during
      ...
      the result OutpuPins of the loop.")
...
(def-meta-operation "compatibleWith" |MultiplicityElement| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|other| :parameter-type '|MultiplicityElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "includesMultiplicity" |MultiplicityElement| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name 'M :parameter-type '|MultiplicityElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "is" |MultiplicityElement| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|lowerbound| :parameter-type '|Integer|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T)
...
(def-meta-operation "excludeCollisions" |Namespace| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|imps| :parameter-type '|PackageableElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|PackageableElement|
                        :parameter-return-p T))
)
...
(def-meta-operation "getNamesOfMember" |Namespace| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|element| :parameter-type '|NamedElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|String|
                        :parameter-return-p T))
)
 ...
 "An ObjectFlow is an ActivityEdge that is traversed by object tokens that
  ...
  ((|isMulticast| :range |Boolean| :multiplicity (1 1) :default :false
   ...
   (|selection| :range |Behavior| :multiplicity (0 1) :soft-opposite (|Behavior| |objectFlow|)
    :documentation
     "A Behavior used to selecs tokens from a source ObjectNode.")
   (|transformation| :range |Behavior| :multiplicity (0 1) :soft-opposite (|Behavior| |objectFlow|)
    :documentation
     "A Behavior used to changes or replace object tokens flowing along the ObjectFlow.")))
 ...
 "An ObjectNode is an abstract ActivityNode that may hold tokens within the
  ...
  ((|inState| :range |State| :multiplicity (0 -1) :soft-opposite (|State| |objectNode|)
   ...
   (|selection| :range |Behavior| :multiplicity (0 1) :soft-opposite (|Behavior| |objectNode|)
    :documentation
     "A Behavior used to selects tokens to be offered on outgoing ActivityEdges.")
...
(def-meta-operation "makesVisible" |Package| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|el| :parameter-type '|NamedElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "isCompatibleWith" |ParameterableElement| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '\p :parameter-type '|ParameterableElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "isAttribute" |Property| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '\p :parameter-type '|Property|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "isRedefinitionContextValid" |RedefinableElement| 
   ...
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|redefined| :parameter-type '|RedefinableElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "isConsistentWith" |Region| 
   "The query isConsistentWith() specifies that a redefining Region is consistent
    ...
    of the Redefined region, i.e. it its Vertices and Transitions conform to
   ...
   :operation-body
   "-- the following is merely a default body; it is expected that the specific form of this constraint will be specified by profiles  true"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|redefinee| :parameter-type '|RedefinableElement|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
...
(def-meta-operation "isRedefinitionContextValid" |Region| 
   ...
   :operation-body
   "if stateMachine->isEmpty() then    -- the Region is owned by a State   (state.redefinedState->notEmpty() and    state.redefinedState.region->includes(redefined))  else -- the region is owned by a StateMachine   (stateMachine.extendedStateMachine->notEmpty() and   stateMachine.extendedStateMachine->exists(sm : StateMachine | sm.region->includes(redefined)))  endif"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|redefined| :parameter-type '|Region|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-class |SendObjectAction| 
 ...
 "A SendObjectAction is an InvocationAction that transmits an input object
  ...
  object. The requestor continues execution immendiately after the object
...
(def-meta-class |SendSignalAction| 
 ...
 "A SendSignalAction is an InvocationAction that creates a Signal instance
  ...
  continues execution immendiately after the Signal instance is sent out
...
(def-meta-class |StartClassifierBehaviorAction| 
 ...
 "A StartVlassifierBehaviorAction is an Action that starts the classifierBehavior
  of the input object."
  ((|object| :range |InputPin| :multiplicity (1 1) :is-composite-p T
...
(def-meta-operation "behavior" |StartObjectBehaviorAction| 
   ...
   :operation-body
   "if object.type.oclIsKindOf(Behavior) then    object.type.oclAsType(Behavior)  else if object.type.oclIsKindOf(BehavioredClassifier) then    object.type.oclAsType(BehavioredClassifier).classifierBehavior  else    null  endif  endif"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Behavior|
                        :parameter-return-p T))
)
...
(def-meta-operation "isRedefinitionContextValid" |State| 
   ...
   :operation-body
   "container.redefinedElement.oclAsType(Region)->exists(r:Region | r.subvertex->includes(redefined))"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|redefined| :parameter-type '|State|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "LCA" |StateMachine| 
   ...
   :operation-body
   "if ancestor(s1, s2) then       s2.container  else   if ancestor(s2, s1) then       s1.container    else        LCA(s1.container.state, s2.container.state)   endif  endif"
   :parameters
...
(def-meta-operation "LCAState" |StateMachine| 
   ...
   :operation-body
   "if v2.oclIsTypeOf(State) and ancestor(v1, v2) then   v2.oclAsType(State)  else if v1.oclIsTypeOf(State) and ancestor(v2, v1) then   v1.oclAsType(State)  else if (v1.container.state->isEmpty() or v2.container.state->isEmpty()) then    null.oclAsType(State)  else LCAState(v1.container.state, v2.container.state)  endif endif endif"
   :parameters
...
(def-meta-operation "ancestor" |StateMachine| 
   "The query ancestor(s1, s2) checks whether Vertex s2 is an ancestor of Vertex
    s1."
   :operation-body
   "if (s2 = s1) then    true   else    if s1.container.stateMachine->notEmpty() then        true   else        if s2.container.stateMachine->notEmpty() then            false       else           ancestor(s1, s2.container.state)        endif    endif  endif  "
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T)
          (make-instance 'ocl-parameter :parameter-name '|s1| :parameter-type '|Vertex|
...
(def-meta-operation "isRedefinitionContextValid" |StateMachine| 
   ...
   :operation-body
   "self._'context'().oclAsType(BehavioredClassifier).redefinedClassifier->includes(redefined.oclAsType(Behavior)._'context'())"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|redefined| :parameter-type '|StateMachine|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "sourceNodes" |StructuredActivityNode| 
   ...
   :operation-body
   "node->union(input.oclAsType(ActivityNode)->asSet())->    union(node->select(oclIsKindOf(Action)).oclAsType(Action).output)->asSet()"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|ActivityNode|
                        :parameter-return-p T))
)
...
(def-meta-operation "targetNodes" |StructuredActivityNode| 
   ...
   :operation-body
   "node->union(output.oclAsType(ActivityNode)->asSet())->    union(node->select(oclIsKindOf(Action)).oclAsType(Action).input)->asSet()"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|ActivityNode|
                        :parameter-return-p T))
)
...
(def-meta-operation "conformsTo" |Type| 
   ...
   "false"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '|other| :parameter-type '|Type|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "isAccessibleBy" |Variable| 
   "A Variable is accessible by Actions within its scope (the Activity or StructuredActivityNode
    that owns it)."
   :operation-body
   "if scope<>null then scope.allOwnedNodes()->includes(a)  else a.containingActivity()=activityScope  endif"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '\a :parameter-type '|Action|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "isContainedInRegion" |Vertex| 
   "This utility query returns true if the Vertex is contained in the Region
    r (input argument)"
   :operation-body
   "if (container = r) then   true  else   if (r.state->isEmpty()) then    false   else    container.state.isContainedInRegion(r)   endif  endif"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name '\r :parameter-type '|Region|
                        :parameter-return-p NIL)
          (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T))
)
...
(def-meta-operation "isContainedInState" |Vertex| 
   "This utility operation returns true if the Vertex is contained in the State
    s (input argument)"
   :operation-body
   "if not s.isComposite() or container->isEmpty() then   false  else   if container.state = s then     true   else    container.state.isContainedInState(s)   endif  endif"
   :parameters
   (list (make-instance 'ocl-parameter :parameter-name NIL :parameter-type '|Boolean|
                        :parameter-return-p T)
...
(def-meta-package |Activities| UML :UML25 
   (|Activity|
    ...
    |ObjectNode|
    |Variable|
    |ObjectNodeOrderingKind|) :xmi-id "_8")
