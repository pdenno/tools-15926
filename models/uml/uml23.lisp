...
;;; by UML Testbed tools on 2010-06-22 13:30:33
...
(mofi:shadow-and-warn "Variable" :UML23)
...
"  Activity edges can be contained in interruptible regions."
  ...
  ;; 2011-10-13 back to a LiteralSpecification
   (mofi::mofi-make-instance (intern "LiteralBoolean" :uml23) :value :TRUE) ; POD 2010-11-01 MIWG telecon
    :documentation
  ...
  ;; 2011-10-13 back to a LiteralSpecification
   (mofi::mofi-make-instance (intern "LiteralInteger" :uml23) :value 1) ; POD added for 2010-11-01
    :documentation
...
(def-mm-constraint "specialized_end_number" |Association| 
  ...
  ends as the other association."
    :editor-note "->collect(...) before oclAsType. It's not a property. The infamous shorthand does not apply."
    :operation-status :rewritten
    :original-body "parents()->select(oclIsKindOf(Association)).oclAsType(Association)->forAll(p | p.memberEnd->size() = self.memberEnd->size())"
    :operation-body "parents()->select(oclIsKindOf(Association))->collect(oclAsType(Association))->forAll(p | p.memberEnd->size() = self.memberEnd->size())")
...
(def-mm-class |Classifier| (:UML23) (|TemplateableElement| uml23::|Type| |Namespace| |RedefinableElement|)
...
;;; This is what DataType is in the infrastructure document! It is far more reasonable than the above. 
;;; Which brings in TemplateableElement PackageableElement ParameterableElement RedefinableElement
;;;
;(def-mm-class |DataType| (:UML23) (|Type|)
;"  A data type is a type whose instances are identified only by their value.
;  A data type may contain attributes to support the modeling of structured
;  data types."
;  ())
...
;;; POD 2012-03-16, I had result = (memberEnd - OrderedSet{ownedEnd}).asOrderedSet()->first()"
(def-mm-operation "metaclassEnd" |Extension| 
    "The query metaclassEnd() returns the Property that is typed by a metaclass (as opposed to a stereotype)."
    :operation-status :rewritten
    :editor-note "Borrowed from UML2.5"
    :original-body "result = memberEnd->reject(ownedEnd)"
    :operation-body "memberEnd->reject(p | ownedEnd->includes(p.oclAsType(ExtensionEnd)))->any(true)"
...
(def-mm-constraint "sources_and_targets_kind" |InformationFlow| 
  ...
  Property, Interface, Package, ActivityNode, ActivityPartition and InstanceSpecification
    ...
    :operation-status :rewritten
    :operation-body "(self.informationSource->forAll(p | p->oclIsKindOf(Actor) or p->oclIsKindOf(Node) or
    ...
    :original-body "(self.informationSource->forAll(p | p->oclIsKindOf(Actor) or oclIsKindOf(Node) or
...
(def-mm-constraint "sources_and_targets" |InformationItem| 
  ...
  Signal, Component."
    ...
    :operation-status :ignored
    :operation-body "true"
    :original-body "(self.represented->select(p | p->oclIsKindOf(InformationItem))->forAll(p |
...
"  Join nodes have a Boolean value specification using the names of the incoming
  ...
  into one by the join.")
   ;; pod 2011-04-20 changed multiplicity of joinSpec from (1 1) to (0 1)
...
(def-mm-class |LinkAction| (:UML23) (|Action|)
 "LinkAction is an abstract class for all link actions that identify their
  ...
  ((|endData| :range |LinkEndData| :multiplicity (2 -1 ) :is-composite-p t 
	      :subsetted-properties ((|Element| |ownedElement|)) ; pod added for 2011-04-20 updates
    :documentation
...
(def-mm-constraint "qualifiers" |LinkEndData| 
    ...
    :operation-status :ignored
    :original-body "self.qualifier->collect(qualifier) = self.end.qualifier"
    :operation-body "true")
...
"  Object nodes have support for token selection, limitation on the number
  ...
  ;; 2011-10-13 back to a LiteralSpecification
  (mofi::mofi-make-instance (intern "LiteralUnlimitedNatural" :uml23)) ; POD 2010-11-01 MIWG telecon
    :documentation
...
;;; 2010-08-03 Removing them again! These are handled by def-mm-primitive at top of file.
;;;            See page 101 of UML 2.3 Infrastructure for a discussion of primitive types. 
;;;            There are four; the four listed here.
;;; 2012-02-24 I removed the commented out code: emacs couldn't handle highlighting!
...
"  Property specializes ParameterableElement to specify that a property can
  ...
  :subsetted-properties ((|Element| |owner|)) 
   ...
   (|class| :range |Class| :multiplicity (0 1 )
  :subsetted-properties (#| pod not investigated (|A_attribute_classifier| |classifier|)|# (|Feature| |featuringClassifier|) (|NamedElement| |namespace|)) :opposite (|Class| |ownedAttribute|) 
    :documentation
   "  References the Class that owns the Property.")
   (|datatype| :range |DataType| :multiplicity (0 1 )
  :subsetted-properties (#| pod not investigated (|A_attribute_classifier| |classifier|)|# (|Feature| |featuringClassifier|) (|NamedElement| |namespace|)) :opposite (|DataType| |ownedAttribute|) 
    :documentation
  ...
  Property when an object of the owning Classifier is instantiated.")
   (|interface| :range |Interface| :multiplicity (0 1 )
  :subsetted-properties (#| pod not investigated (|A_attribute_classifier| |classifier|)|# (|Feature| |featuringClassifier|) (|NamedElement| |namespace|)) :opposite (|Interface| |ownedAttribute|) )
...
(def-mm-constraint "multiplicity_of_composite" |Property| 
  ...
  :operation-status :rewritten
  :original-body "isComposite implies (upperBound()->isEmpty() or upperBound() <= 1)"
  :operation-body "self.isComposite and self.association->notEmpty() implies
...
(def-mm-operation "isConsistentWith" |Property| 
  ...
  (self.isComposite implies prop.isComposite))"
    :original-body "result = redefinee.oclIsKindOf(Property) and 
  let prop : Property = redefinee.oclAsType(Property) in 
  (prop.type.conformsTo(self.type) and 
  ((prop.lowerBound()->notEmpty() and self.lowerBound()->notEmpty()) implies prop.lowerBound() >= self.lowerBound()) and 
...
(def-mm-constraint "contained" |ReadSelfAction| 
    ...
    :operation-status :ignored
    :original-body "self.context->size() = 1"
    :operation-body "true")
...
"  A stereotype defines how an existing metaclass may be extended, and enables
  ...
  the extended model elements.")
   (|profile| :range |Profile| :multiplicity (0 1 ) ; pod 2011-04-20 was (1 1)
;   :is-derived-p t  ; POD 2011-04-20 Package.containingProfile() is messed up
   :documentation
...
"  Because of the concurrent nature of the execution of actions within and
  ...
  node."
  ((|activity| :range |Activity| :multiplicity (0 1 )
  ;; POD 2011-11-25 Note that this redefines TWO properties!	       
  :redefined-property (|ActivityNode| |activity| |ActivityGroup| |inActivity|)
  ...
  :subsetted-properties ((|ActivityGroup| |containedNode|)
			 (|Element| |ownedElement|)) ; pod added for 2011-04-20 updates. 
...
(def-mm-operation "isConsistentWith" |Transition| 
  ...
  let trans: Transition = redefinee.oclAsType(Transition) in
    ...
    :original-body "result = (redefinee.oclIsKindOf(Transition) and
  let trans: Transition = redefinee.oclAsType(Transition) in
