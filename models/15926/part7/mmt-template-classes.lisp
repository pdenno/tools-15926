;;; Created 2013-04-17 11:37:39 from file /local/tmp/upload/mmt-templates-owl-2013-04-17.xml.
...
(mofi:def-mm-class |ActivityCausesBeginningOfIndividual| :MMTC NIL
   ...
   (|valStartTimeOfIndividual| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |ActivityCausesEndingOfIndividual| :MMTC NIL
   ...
   (|valEndTimeOfIndividual| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |AggregateOfMonotypeIndividual| :MMTC NIL
   ""
   ((|hasParticulateType| :range DM:CLASS_OF_PARTICULATE_MATERIAL :multiplicity (1 1))
...
(mofi:def-mm-class |ApprovalWithStatusByIndividual| :MMTC NIL
   ...
   (|hasEnd1OfApproved| :range DM:THING :multiplicity (1 1))
   (|hasEnd2OfApproved| :range DM:THING :multiplicity (1 1))
   ))

(mofi:def-mm-class |ApprovalWithStatusByTemporalPart| :MMTC NIL
   ""
   ((|hasTemporalWholeOfApprover| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
   (|POD-UNDEFINED-1| :range DM:THING :multiplicity (1 1))
   (|hasStatus| :range DM:CLASS_OF_APPROVAL_BY_STATUS :multiplicity (1 1))
   (|hasRelationshipType| :range DM:CLASS_OF_RELATIONSHIP_WITH_SIGNATURE :multiplicity (1 1))
   (|hasEnd1OfApproved| :range DM:THING :multiplicity (1 1))
   (|hasEnd2OfApproved| :range DM:THING :multiplicity (1 1))
   (|valStartTime| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |ClassOfCauseOfBeginningOfClassOfIndividualDefinition| :MMTC NIL
   ...
   (|hasUrClassofIndividual| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
...
(mofi:def-mm-class |ClassOfIndividualHasIndirectPropertyWithBoundingValues| :MMTC NIL
   ""
   ...
   (|valLowerBound| :range |Real| :multiplicity (1 1))
   (|valUpperBound| :range |Real| :multiplicity (1 1))
   (|hasScale| :range DM:SCALE :multiplicity (1 1))
   (|hasCardinalityOfPossessorType| :range DM:CARDINALITY :multiplicity (1 1))
   ))

(mofi:def-mm-class |ClassOfIndividualHasIndirectPropertyWithMaximumValue| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPossessorType| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasIndirectPropertyType| :range DM:CLASS_OF_INDIRECT_PROPERTY :multiplicity (1 1))
   (|hasBasePropertyType| :range DM:PROPERTY_SPACE :multiplicity (1 1))
   (|valMaximumValue| :range |Real| :multiplicity (1 1))
   (|hasScale| :range DM:SCALE :multiplicity (1 1))
   (|hasCardinalityOfPossessorType| :range DM:CARDINALITY :multiplicity (1 1))
   ))

(mofi:def-mm-class |ClassOfIndividualHasIndirectPropertyWithMinimumValue| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPossessorType| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasIndirectPropertyType| :range DM:CLASS_OF_INDIRECT_PROPERTY :multiplicity (1 1))
   (|hasBasePropertyType| :range DM:PROPERTY_SPACE :multiplicity (1 1))
   (|valMinimumValue| :range |Real| :multiplicity (1 1))
   (|hasScale| :range DM:SCALE :multiplicity (1 1))
   (|hasCardinalityOfPossessorType| :range DM:CARDINALITY :multiplicity (1 1))
   ))

(mofi:def-mm-class |ClassOfIndividualHasIndirectPropertyWithPointValue| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPossessorType| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasIndirectPropertyType| :range DM:CLASS_OF_INDIRECT_PROPERTY :multiplicity (1 1))
   (|hasBasePropertyType| :range DM:PROPERTY_SPACE :multiplicity (1 1))
   (|valPointValue| :range |Real| :multiplicity (1 1))
   (|hasScale| :range DM:SCALE :multiplicity (1 1))
   (|hasCardinalityOfPossessorType| :range DM:CARDINALITY :multiplicity (1 1))
   ))

(mofi:def-mm-class |ClassOfIndividualHasIndirectPropertyWithRefPropertySpace| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPossessorType| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasIndirectPropertyType| :range DM:CLASS_OF_INDIRECT_PROPERTY :multiplicity (1 1))
...
(mofi:def-mm-class |ClassOfIndividualUsedInDirectConnectionDefinition| :MMTC NIL
   ...
   (|hasEnd1Connected| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasEnd2Connected| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
...
(mofi:def-mm-class |ClassOfIndividualWithEnumeratedIndirectProperties| :MMTC NIL
   ""
...
(mofi:def-mm-class |ClassOfParticipationDefinition| :MMTC NIL
   ...
   ((|hasUrClassOfActivity| :range DM:CLASS_OF_ACTIVITY :multiplicity (1 1))
   (|hasActivityType| :range DM:CLASS_OF_ACTIVITY :multiplicity (1 1))
   (|hasUrClassOfParticipant| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
...
(mofi:def-mm-class |ClassOfRecognitionOfClassOfRelationshipWithSignature| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS_OF_ACTIVITY :multiplicity (1 1))
   (|hasActivityType| :range DM:CLASS_OF_ACTIVITY :multiplicity (1 1))
   (|hasEnd1RecognizedClass| :range DM:CLASS :multiplicity (1 1))
   (|hasEnd1RecognizedRole| :range DM:ROLE :multiplicity (1 1))
   (|POD-UNDEFINED-2| :range DM:THING :multiplicity (1 1))
   (|POD-UNDEFINED-3| :range DM:THING :multiplicity (1 1))
   (|POD-UNDEFINED-4| :range DM:THING :multiplicity (1 1))
   (|hasEnd2RecognizedClass| :range DM:CLASS :multiplicity (1 1))
   (|hasEnd2RecognizedRole| :range DM:ROLE :multiplicity (1 1))
   (|hasCardinalityOfActivity| :range DM:CARDINALITY :multiplicity (1 1))
...
(mofi:def-mm-class |ClassificationOfClassWithEnumeratedSetOfClass| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS :multiplicity (1 1))
   (|hasClassified| :range DM:CLASS :multiplicity (1 1))
   (|hasClassifier| :range DM:ENUMERATED_SET_OF_CLASS :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |ConditionalPropertyOfClassOfIndividualWithValue| :MMTC NIL
   ...
   (|valPropertyValue| :range |Real| :multiplicity (1 1))
...
(mofi:def-mm-class |DefinitionOfAClassOIM| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS :multiplicity (1 1))
   (|hasHandleOfOIM| :range DM:CLASS :multiplicity (1 1))
   (|hasOIM| :range DM:ENUMERATED_SET_OF_CLASS :multiplicity (1 1))
   ))

(mofi:def-mm-class |DefinitionOfAClassOption| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS :multiplicity (1 1))
   (|hasUrClassOfOption| :range DM:CLASS :multiplicity (1 1))
   (|hasOption| :range DM:CLASS :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |DocumentApproval| :MMTC NIL
   ...
   (|valApprovalDate| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |DocumentPublishing| :MMTC NIL
   ...
   (|valPublishingDate| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |DocumentRevision| :MMTC NIL
   ...
   (|valRevisionDate| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |EndingOfIndividual| :MMTC NIL
   ""
   ((|hasIndividual| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
   (|valEndTime| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |EruptingBehaviourOfIndividual| :MMTC NIL
   ...
   (|hasBehaviourType| :range DM:CLASS_OF_ACTIVITY :multiplicity (1 1))
   (|hasCausingActivity| :range DM:ACTIVITY :multiplicity (1 1))
   (|valStartTimeOfEvent| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |FunctionalPhysicalObjectFulfilsUnitOperation| :MMTC NIL
   ""
   ((|hasUrUnitOperationn| :range DM:ACTIVITY :multiplicity (1 1))
   (|hasUnitOperationClass| :range DM:CLASS_OF_ACTIVITY :multiplicity (1 1))
   (|hasUfFunctionPlace| :range DM:FUNCTIONAL_PHYSICAL_OBJECT :multiplicity (1 1))
...
(mofi:def-mm-class |InstallationOfMaterializedPhysicalObjectInFunctionPlace| :MMTC NIL
   ""
...
(mofi:def-mm-class |InvolvementByReferenceOfTemporalPartInWholeLifeActivity| :MMTC NIL
   ""
   ((|hasActivity| :range (AND DM:ACTIVITY DM:WHOLE_LIFE_INDIVIDUAL) :multiplicity (1 1))
   (|hasTemporalWholeOfInvolved| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
   (|hasInvolved| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
   (|valStartTime| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |MeasuringAPropertyOfATemporalPartOverAPeriodInTime| :MMTC NIL
   ...
   (|hasTemporalWholeOfPossessor| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
   (|hasPossessor| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
   (|hasPropertyType| :range DM:CLASS_OF_RECOGNITION :multiplicity (1 1))
   (|valPropertyValue| :range |Real| :multiplicity (1 1))
   (|hasPropertyScale| :range DM:SCALE :multiplicity (1 1))
   (|valStartTime| :range XML-XSD:|DateTime| :multiplicity (1 1))
   (|valEndTime| :range XML-XSD:|DateTime| :multiplicity (1 1))
...
(mofi:def-mm-class |MonetaryValueOfIndividual| :MMTC NIL
   ...
   (|valMonetaryValue| :range |Real| :multiplicity (1 1))
...
(mofi:def-mm-class |ParticipationOfTemporalPartInWholeLifeActivity| :MMTC NIL
   ""
   ((|hasActivity| :range DM:ACTIVITY :multiplicity (1 1))
   (|hasTemporalWholeOfParticipant| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
   (|hasParticipant| :range DM:POSSIBLE_INDIVIDUAL :multiplicity (1 1))
...
(mofi:def-mm-class |PositionOfATemporalPartInACoordinateSystem| :MMTC NIL
   ...
   (|hasCoordinateSystem| :range DM:COORDINATE_SYSTEM :multiplicity (1 1))
   (|valX| :range |Real| :multiplicity (1 1))
   (|valY| :range |Real| :multiplicity (1 1))
   (|valZ| :range |Real| :multiplicity (1 1))
   (|valStartTime| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |PropertyWithPercentageVarianceOfClassOfIndividual| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPossessorType| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPropertyType| :range DM:SINGLE_PROPERTY_DIMENSION :multiplicity (1 1))
   (|valPropertyValue| :range |Real| :multiplicity (1 1))
   (|hasPropertyScale| :range DM:SCALE :multiplicity (1 1))
   (|valPositiveVariance| :range |Real| :multiplicity (1 1))
   (|valNegativeVariance| :range |Real| :multiplicity (1 1))
   (|hasVarianceScale| :range DM:SCALE :multiplicity (1 1))
   (|hasCardinalityOfPossessorType| :range DM:CARDINALITY :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |PropertyWithVarianceOfClassOfIndividual| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPossessorType| :range DM:CLASS_OF_INDIVIDUAL :multiplicity (1 1))
   (|hasPropertyType| :range DM:SINGLE_PROPERTY_DIMENSION :multiplicity (1 1))
...
(mofi:def-mm-class |SpecializationByFunctionalObjectType| :MMTC NIL
   ""
   ((|hasClass| :range DM:CLASS_OF_ARRANGED_INDIVIDUAL :multiplicity (1 1))
...
(mofi:def-mm-class |SpecializationOfClass| :MMTC NIL
   ""
   ((|hasUrClass| :range DM:CLASS :multiplicity (1 1))
   (|hasSubClass| :range DM:CLASS :multiplicity (1 1))
...
(mofi:def-mm-class |TemporalPartActivityCausesBeginningOfIndividual| :MMTC NIL
   ...
   (|valStartTimeOfIndividual| :range XML-XSD:|DateTime| :multiplicity (1 1))
   (|valStartTimeOfActivity| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |ThreeDimensionalRealNumber| :MMTC NIL
   ...
   (|valFirstNumber| :range |Real| :multiplicity (1 1))
   (|valSecondNumber| :range |Real| :multiplicity (1 1))
   (|valThirdNumber| :range |Real| :multiplicity (1 1))
   ))
...
(mofi:def-mm-class |TwoDimensionalPropertyWithValuesOfTemporalPart| :MMTC NIL
   ...
   (|valPropertyValue2| :range |Real| :multiplicity (1 1))
   (|hasPropertyScale2| :range DM:SCALE :multiplicity (1 1))
   (|hasStartTime| :range XML-XSD:|DateTime| :multiplicity (1 1))
   ))
