...
(ensure-model 
 ...
 :classes-path (pod:lpath :lisplib "pod-utils/uml-utils/models/odm.lisp"))
...
;	      "BPMN2 Constraints.mdzip#_16_8beta_8740266_1261484630687_217688_1428"
 ...
 :classes-path (pod:lpath :lisplib "pod-utils/uml-utils/models/bpmn-profile.lisp"))

(push-last "http://www.nomagic.com/magicdraw/UML/2.4.1" (nicknames (find-model :uml241)))


(ensure-model 
 :uml-profile-l2 :force t  :verbose t
 :features '(:cre)
 :nicknames '("StandardProfileL2"
 ...
 :model-class 'mofi::profile
 :classes-path (pod:lpath :lisplib "pod-utils/uml-utils/models/uml-std-profile-l2.lisp"))
...
;;; :ns-uri "http://www.omg.org/spec/SysML/20100301/SysML-profile"
 ...
 :model-class 'mofi::profile
 :depends-on-models '(:ocl :uml-profile-l2 :uml23 #|:qudv|#)
 :classes-path (pod:lpath :lisplib "pod-utils/uml-utils/models/sei/sysml-profile-12.lisp"))
...
(ensure-model 
  ...
  :operator-strings '("ABS" "ACOS" "ASIN" "ATAN" "BLENGTH" "COS" "EXISTS" "EXP" "FORMAT" 
		      ...
		      "VALUE" "VALUE_IN" "VALUE_UNIQUE" "IN" "LIKE" "OR" "XOR" "DIV" "MOD" 
		      "AND" "INSERT" "REMOVE")
  :classes-path (pod:lpath :lisplib "pod-utils/uml-utils/models/mexico.lisp"))
...
;;; ============================================
;;; Load metamodel for 15926-2 
;;; ============================================
;;;(defpackage :ISO15926-2
...
(defun tryme ()
  ...
  (with-debugging (:parser 5)
    (expo:read-schema
     (make-instance 'expo:express-file :version 2 :target-type :nothing
		    :path #P"/local/lisp/pod-utils/uml-utils/models/cre/small.exp"))))



;(expo:load-schema
; (make-instance 'expo::lisp-compiled-express-file 
;		:path (lpath :lisplib "pod-utils/uml-utils/models/15926-2.lisp")))
