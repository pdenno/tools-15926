...
;;; by UML Testbed tools on 2009-04-07 09:48:36
...
(def-mm-class |Activity| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|risk_impact_item| |project_item| |documented_element_select| |defined_methods| |activity_item| |security_classification_item| |product_based_location_representation| |position_group_item| |justification_support_item| |condition_parameter_item| |state_definition_of_item| |contract_item| |issue_reference_item| |approval_item| |time_interval_item| |observed_context| |groupable_item| |string_select| |risk_perception_source_item| |affected_item_select| |position_type_item| |required_resource_item| |type_of_person_item_select| |organization_or_person_in_organization_item| |analysed_item| |event_item| |justification_item| |location_assignment_select| |state_of_item| |condition_item| |activity_method_item| |identification_item| |condition_evaluation_parameter_item| |position_item| |effectivity_item| |characterized_activity_definition| |classified_attribute_select| |property_assignment_select| |date_or_date_time_item| |certification_item| |work_item| |classification_item|)
   ""
...
(def-mm-class |Activity_method| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|in_zone_item| |risk_impact_item| |project_item| |documented_element_select| |defined_methods| |activity_item| |security_classification_item| |product_based_location_representation| |justification_support_item| |position_group_item| |requirement_assignment_item| |condition_parameter_item| |state_definition_of_item| |contract_item| |issue_reference_item| |approval_item| |resource_assignment_item| |activity_realization_select| |condition_evaluation_item| |observed_context| |groupable_item| |work_output_item| |string_select| |risk_perception_source_item| |position_type_item| |affected_item_select| |behaviour_model| |required_resource_item| |type_of_person_item_select| |organization_or_person_in_organization_item| |event_item| |analysed_item| |justification_item| |verification_evidence_item| |state_of_item| |condition_item| |activity_method_item| |information_usage_right_item| |requirement_source_item| |identification_item| |position_item| |description_item| |effectivity_item| |characterized_activity_definition| |classified_attribute_select| |property_assignment_select| |date_or_date_time_item| |certification_item| |resource_as_realized_item| |work_item| |classification_item|)
   ""
...
(def-mm-class |Activity_method_assignment| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |effectivity_item| |organization_or_person_in_organization_item| |date_or_date_time_item| |approval_item| |string_select| |resource_as_realized_item| |time_interval_item| |location_assignment_select| |classified_attribute_select| |issue_reference_item| |type_of_person_item_select| |verification_evidence_item| |classification_item| |justification_support_item| |security_classification_item|)
   ""
...
(def-mm-class |Affected_items_assignment| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |organization_or_person_in_organization_item| |date_or_date_time_item| |approval_item| |resource_as_realized_item| |time_interval_item| |classified_attribute_select| |issue_reference_item| |identification_item| |verification_evidence_item| |classification_item| |security_classification_item|)
   ""
...
(def-mm-class |Alternate_product_relationship| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|event_item| |risk_impact_item| |organization_or_person_in_organization_item| |effectivity_item| |property_assignment_select| |certification_item| |date_or_date_time_item| |approval_item| |analysed_item| |project_item| |product_based_location_representation| |state_of_item| |state_definition_of_item| |requirement_source_item| |requirement_assignment_item| |documented_element_select| |classified_attribute_select| |information_usage_right_item| |issue_reference_item| |observed_context| |verification_evidence_item| |classification_item| |risk_perception_source_item| |security_classification_item|)
   ""
...
(def-mm-class |Applied_activity_method_assignment| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|event_item| |justification_item| |effectivity_item| |organization_or_person_in_organization_item| |property_assignment_select| |certification_item| |date_or_date_time_item| |approval_item| |string_select| |condition_parameter_item| |condition_item| |description_item| |resource_as_realized_item| |project_item| |contract_item| |work_item| |location_assignment_select| |in_zone_item| |state_definition_of_item| |requirement_source_item| |requirement_assignment_item| |documented_element_select| |issue_reference_item| |identification_item| |observed_context| |verification_evidence_item| |classification_item| |security_classification_item| |justification_support_item|)
   ""
...
(def-mm-class |Approval| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |event_item| |risk_impact_item| |organization_or_person_in_organization_item| |date_or_date_time_item| |activity_item| |condition_parameter_item| |string_select| |groupable_item| |condition_item| |state_of_item| |condition_evaluation_parameter_item| |condition_evaluation_item| |identification_item| |issue_reference_item| |documented_element_select| |classified_attribute_select| |observed_context| |classification_item| |justification_support_item| |risk_perception_source_item|)
   ""
...
(def-mm-class |Approval_assignment| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |activity_method_item| |effectivity_item| |condition_parameter_item| |condition_item| |affected_item_select| |condition_evaluation_parameter_item| |requirement_source_item| |condition_evaluation_item| |issue_reference_item| |classified_attribute_select| |documented_element_select| |observed_context| |verification_evidence_item| |classification_item|)
   ""
...
(def-mm-class |Assembly_relationship_substitution| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |event_item| |risk_impact_item| |organization_or_person_in_organization_item| |effectivity_item| |certification_item| |approval_item| |date_or_date_time_item| |string_select| |analysed_item| |project_item| |product_based_location_representation| |state_of_item| |state_definition_of_item| |requirement_assignment_item| |documented_element_select| |identification_item| |issue_reference_item| |information_usage_right_item| |observed_context| |verification_evidence_item| |classification_item| |risk_perception_source_item| |security_classification_item|)
   ""
...
(def-mm-class |Boolean_literal| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (#| |Simple_boolean_expression| |# |Boolean_expression| |Generic_literal| )
   ""
...
(def-mm-class |Condition_parameter| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|property_assignment_select| |string_select| |description_item| |issue_reference_item| |documented_element_select| |classified_attribute_select| |classification_item|)
   ""
  ((|condition| :range |Condition| :multiplicity (1 1 ))
   (|description| :range |String| :multiplicity (0 1 ))
   (|name| :range |String| :multiplicity (1 1 ))
...
;;; POD |condition_parameter_item| picked up from Generic_expression
(def-mm-class |Expression| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") 
  (|description_item| #| |condition_parameter_item| |# |Generic_expression| |classification_item|)
   ""
  ())
...
(def-mm-class |External_class| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") 
  (#|POD |contract_item| |# |Class|)
   ""
...
;;; POD using Simple_generic_expression makes problems with Generic_expression, which is also included from Expression.
...
(def-mm-class |Interface_connector_occurrence| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |risk_impact_item| |activity_method_item| |organization_or_person_in_organization_item| |effectivity_item| |property_assignment_select| |product_item| |date_or_date_time_item| |activity_item| |approval_item| |condition_parameter_item| |string_select| |description_item| |analysed_item| |affected_item_select| |required_resource_item| |product_based_location_representation| |state_of_item| |condition_evaluation_parameter_item| |location_assignment_select| |interface_definition_item| |in_zone_item| |connection_items| |state_definition_of_item| |requirement_source_item| |requirement_assignment_item| |issue_reference_item| |documented_element_select| |identification_item| |information_usage_right_item| |observed_context| |classification_item| |resource_assignment_item| |justification_support_item| |risk_perception_source_item| |security_classification_item| |selected_item_select|)
   ""
...
(def-mm-class |Interface_definition_connection| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|in_zone_item| |risk_impact_item| |project_item| |documented_element_select| |activity_item| |security_classification_item| |product_based_location_representation| |justification_support_item| |position_group_item| |condition_parameter_item| |state_definition_of_item| |issue_reference_item| |approval_item| |condition_evaluation_item| |observed_context| |string_select| |risk_perception_source_item| |position_type_item| |affected_item_select| |required_resource_item| |type_of_person_item_select| |organization_or_person_in_organization_item| |analysed_item| |justification_item| |verification_evidence_item| |location_assignment_select| |state_of_item| |condition_item| |information_usage_right_item| |activity_method_item| |identification_item| |description_item| |condition_evaluation_parameter_item| |position_item| |selected_item_select| |classified_attribute_select| |property_assignment_select| |date_or_date_time_item| |certification_item| |resource_as_realized_item| |classification_item|)
   ""
...
(def-mm-class |Location| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|activity_method_item| |activity_item| |string_select| |groupable_item| |position_group_item| |position_item| |state_of_item| |work_output_item| |state_definition_of_item| |identification_item| |documented_element_select| |issue_reference_item| |classified_attribute_select| |position_type_item| |resource_assignment_item| |resource_item_select| |classification_item| |justification_support_item|)
   ""
...
(def-mm-class |Location_assignment| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |organization_or_person_in_organization_item| |effectivity_item| |property_assignment_select| |date_or_date_time_item| |string_select| |condition_item| |documented_element_select| |issue_reference_item| |verification_evidence_item| |classification_item| |justification_support_item|)
   ""
  ((|description| :range |String| :multiplicity (0 1 ))
...
(def-mm-class |Product| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|risk_impact_item| |project_item| |documented_element_select| |defined_methods| |activity_item| |security_classification_item| |product_based_location_representation| |justification_support_item| |position_group_item| |requirement_assignment_item| |condition_parameter_item| |product_select| |external_identification_item| |state_definition_of_item| |issue_reference_item| |approval_item| |resource_assignment_item| |observed_context| |groupable_item| |work_output_item| |string_select| |defined_activities| |risk_perception_source_item| |position_type_item| |affected_item_select| |required_resource_item| |organization_or_person_in_organization_item| |type_of_person_item_select| |analysed_item| |event_item| |justification_item| |location_assignment_select| |verification_evidence_item| |state_of_item| |information_usage_right_item| |activity_method_item| |requirement_source_item| |identification_item| |condition_evaluation_parameter_item| |position_item| |description_item| |assigned_name_select| |effectivity_item| |selected_item_select| |classified_attribute_select| |property_assignment_select| |resource_item_select| |certification_item| |resource_as_realized_item| |classification_item|)
   ""
  ((|description| :range |String| :multiplicity (0 1 ))
   (|id| :range |String| :multiplicity (1 1 ))
   (|name| :range |String| :multiplicity (0 1 ))))
...
(def-mm-class |Product_version| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|risk_impact_item| |project_item| |documented_element_select| |activity_item| |version_or_definition| |security_classification_item| |product_based_location_representation| |justification_support_item| |position_group_item| |requirement_assignment_item| |condition_parameter_item| |product_select| |state_definition_of_item| |contract_item| |issue_reference_item| |approval_item| |resource_assignment_item| |observed_context| |work_output_item| |string_select| |risk_perception_source_item| |affected_item_select| |position_type_item| |required_resource_item| |organization_or_person_in_organization_item| |type_of_person_item_select| |analysed_item| |event_item| |justification_item| |verification_evidence_item| |location_assignment_select| |state_of_item| |information_usage_right_item| |activity_method_item| |requirement_source_item| |identification_item| |condition_evaluation_parameter_item| |position_item| |description_item| |effectivity_item| |selected_item_select| |classified_attribute_select| |property_assignment_select| |date_or_date_time_item| |resource_item_select| |certification_item| |resource_as_realized_item| |classification_item|)
   ""
  ((|description| :range |String| :multiplicity (0 1 ))
   (|id| :range |String| :multiplicity (1 1 ))
...
(def-mm-class |Product_view_definition| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|in_zone_item| |risk_impact_item| |project_item| |documented_element_select| |activity_item| |version_or_definition| |security_classification_item| |shapeable_item| |position_group_item| |justification_support_item| |requirement_assignment_item| |condition_parameter_item| |state_definition_of_item| |issue_reference_item| |approval_item| |resource_assignment_item| |parameter_value_select| |interface_definition_item| |observed_context| |work_output_item| |string_select| |risk_perception_source_item| |position_type_item| |affected_item_select| |required_resource_item| |organization_or_person_in_organization_item| |analysed_item| |event_item| |justification_item| |location_assignment_select| |verification_evidence_item| |information_usage_right_item| |activity_method_item| |connection_definition_items| |requirement_source_item| |identification_item| |position_item| |condition_evaluation_parameter_item| |description_item| |assigned_name_select| |effectivity_item| |classified_attribute_select| |property_assignment_select| |date_or_date_time_item| |resource_item_select| |connector_on_item| |product_item| |resource_as_realized_item| |classification_item|)
   ""
...
(def-mm-class |Representation_item| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|event_item| |risk_impact_item| |property_assignment_select| |parameter_value_select| |string_select| |description_item| |resource_as_realized_item| |identification_item| |documented_element_select| |issue_reference_item| |classified_attribute_select| |information_usage_right_item| |observed_context| |verification_evidence_item| |classification_item| |risk_perception_source_item|)
   ""
  ((|name| :range |String| :multiplicity (0 1 ))))
...
(def-mm-class |Simple_boolean_expression| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (#| POD ... and added Generic_expression |Simple_generic_expression| |# |Generic_expression| |Boolean_expression| )
   ""
  ())
...
(def-mm-class |Simple_numeric_expression| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (#| POD ... and added Generic_expression |Simple_generic_expression| |# |Generic_expression| |Numeric_expression|)
   ""
  ())


;;; POD 
(def-mm-class |Simple_string_expression| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (#| POD ... and added Generic_expression |Simple_generic_expression| |# |Generic_expression| |String_expression|)
   ""
  ())
...
(def-mm-class |State| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|event_item| |risk_impact_item| |activity_item| |condition_parameter_item| |analysed_item| |resource_as_realized_item| |affected_item_select| |position_group_item| |product_based_location_representation| |position_item| |state_or_state_definition_select| |state_of_item| |condition_evaluation_parameter_item| |state_definition_of_item| |requirement_source_item| |requirement_assignment_item| |issue_reference_item| |documented_element_select| |position_type_item| |verification_evidence_item| |observed_context| |classification_item| |risk_perception_source_item| |justification_support_item|)
   ""
  ((|description| :range |String| :multiplicity (0 1 ))
   (|name| :range |String| :multiplicity (1 1 ))))


(def-mm-class |State_assertion| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |risk_impact_item| |property_assignment_select| |documented_element_select| |issue_reference_item| |observed_context| |verification_evidence_item| |classification_item| |risk_perception_source_item|)
   ""
...
(def-mm-class |State_assessment| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |risk_impact_item| |property_assignment_select| |approval_item| |condition_parameter_item| |analysed_item| |resource_as_realized_item| |state_of_item| |issue_reference_item| |documented_element_select| |observed_context| |verification_evidence_item| |classification_item| |risk_perception_source_item|)
   ""
...
(def-mm-class |State_relationship| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|event_item| |activity_method_item| |risk_impact_item| |approval_item| |activity_item| |parameter_value_select| |resource_as_realized_item| |product_based_location_representation| |state_of_item| |issue_reference_item| |observed_context| |verification_evidence_item| |classification_item| |justification_support_item| |risk_perception_source_item|)
   ""
  ((|description| :range |String| :multiplicity (0 1 ))
   (|name| :range |String| :multiplicity (1 1 ))
...
;;; POD modified Simple_string_expression instead of here. 
(def-mm-class |String_literal| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") 
...
(def-mm-class |Work_output| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|activity_method_item| |organization_or_person_in_organization_item| |certification_item| |activity_item| |approval_item| |date_or_date_time_item| |condition_parameter_item| |string_select| |groupable_item| |contract_item| |product_based_location_representation| |characterized_activity_definition| |time_interval_item| |condition_evaluation_parameter_item| |defined_activities| |requirement_assignment_item| |classified_attribute_select| |information_usage_right_item| |identification_item| |issue_reference_item| |documented_element_select| |observed_context| |classification_item| |justification_support_item| |external_identification_item| |risk_perception_source_item| |security_classification_item|)
   ""
  ((|description| :range |String| :multiplicity (0 1 ))
   (|name| :range |String| :multiplicity (1 1 ))
...
(def-mm-class |Work_output_assignment| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|justification_item| |activity_method_item| |effectivity_item| |approval_item| |analysed_item| |resource_as_realized_item| |position_group_item| |position_item| |defined_methods| |issue_reference_item| |verification_evidence_item| |type_of_person_item_select| |position_type_item| |classification_item| |defined_attributes| |security_classification_item| |risk_perception_source_item|)
   ""
  ((|assigned_output| :range |Work_output| :multiplicity (1 1 ))
   (|item| :range |work_item| :multiplicity (1 1 ))))


(def-mm-class |Work_output_relationship| (:AP233 "Data specification view" "Ap233_systems_engineering_arm_LF") (|effectivity_item| |string_select| |analysed_item| |classified_attribute_select| |issue_reference_item| |classification_item| |security_classification_item|)
   ""
  ((|description| :range |String| :multiplicity (0 1 ))
   (|name| :range |String| :multiplicity (1 1 ))
...
(with-slots (mofi::abstract-classes) *model*
    (setf mofi::abstract-classes '(|Simple_boolean_expression| |Analysis_representation_item| |activity_realization_select| |information_usage_right_item| |second_in_minute| |Probability_distribution| |risk_impact_item| |product_select| |organization_or_person_in_organization_select| |product_based_location_representation| |Boolean_expression| |characterized_activity_definition| |description_item| |affected_item_select| |work_output_item| |set_of_text_based_item| |behaviour_item| |contract_item| |Detailed_geometric_model_element| |Resource_event| |qualifications_select| |Unary_function_call| |external_identification_item| |Binary_function_call| |Measure_item| |type_of_person_item_select| |risk_estimation_select| |File| |scheme_version_select| |Boolean_defined_function| |Multiple_arity_numeric_expression| |Multiple_arity_generic_expression| |Binary_generic_expression| |condition_parameter_item| |location_assignment_select| |work_item| |project_item| |groupable_item| |list_of_text_based_item| |date_or_date_time_item| |analysed_item| |interface_definition_item| |resource_as_realized_relationship_select| |Representation_item| |risk_communication_select| |defined_attributes| |descriptive_or_numerical| |scheme_subject_select| |Binary_numeric_expression| |state_or_state_definition_select| |string_select| |product_item| |Multiple_arity_function_call| |Generic_variable| |shapeable_item| |activity_item| |condition_item| |plane_angle_measure| |approval_item| |Type_qualifier| |String_expression| |connector_on_item| |position_type_item| |Geometric_placement_operation| |risk_activity| |date_or_event| |Required_resource| |resource_as_realized_item| |scheme_entry_item_select| |certification_item| |Product_as_individual_version| |breakdown_item| |Binary_boolean_expression| |Unary_numeric_expression| |measure_value| |text_based_item_select| |shape_select| |Generic_literal| |activity_method_item| |Product_occurrence_definition_relationship| |method_or_method_version| |length_measure| |Multiple_arity_boolean_expression| |String_defined_function| |connection_items| |Location_representation| |Expression| |position_person_or_organization_or_person_in_organization_select| |resource_item_select| |event_item| |verification_evidence_item| |Probability| |date_or_date_time_select| |person_or_organization_or_person_in_organization_select| |classification_item| |shape_model| |task_item| |Generic_expression| |list_or_set_of_text_based_item| |Unary_boolean_expression| |any_string_value| |represented_definition| |Comparison_expression| |constraint_context| |Variable_semantics| |connection_definition_items| |Sql_mappable_defined_function| |month_in_year_number| |Task_element| |Real_defined_function| |documented_element_select| |Risk_activity_structure| |resource_assignment_item| |Integer_defined_function| |document_property_item| |shape_dependent_select| |observed_context| |justification_support_item| |property_assignment_select| |any_number_value| |condition_evaluation_parameter_item| |characterized_resource_select| |Variable| |position_item| |Structured_task_element| |state_definition_of_item| |minute_in_hour| |defined_methods| |assigned_document_select| |Probability_generator| |selected_item_select| |risk_criteria_select| |geometric_item_specific_usage_select| |observation_recorder| |value_qualifier| |justification_item| |parameter_value_select| |position_group_item| |hour_in_day| |Defined_function| |required_resource_item| |Numeric_defined_function| |defined_activities| |condition_evaluation_item| |Simple_string_expression| |requirement_source_item| |risk_treatment_select| |selected_item_context_items| |lessons_learned_select| |issue_reference_item| |cartesian_transformation| |security_classification_item| |assigned_name_select| |described_element_select| |Unary_generic_expression| |day_in_month_number| |position_context_item| |in_zone_item| |expression_assignment_item| |Assembly_component_relationship| |Property_definition_representation| |Simple_numeric_expression| |classified_attribute_select| |requirement_assignment_item| |risk_perception_source_item| |Qualified_representation_item| |year_number| |Literal_number| |effectivity_item| |identification_item| |state_of_item| |state_based_behaviour_element| |organization_or_person_in_organization_item| |Numeric_expression| |Simple_generic_expression| |template_definition_select| |alias_identification_item| |version_or_definition| |time_interval_item| |behaviour_model| |Geometric_model_relationship_with_transformation|))) 
