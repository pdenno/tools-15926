;;; Automatically created by pop-gen at 2012-03-03 18:01:47.
;;; Source file is bpmn2-profile-clean.xmi
...
(def-mm-enum |GatewayNotation| :BPMN-P NIL 
...
(def-mm-enum |isCollection_dataInput| :BPMN-P NIL 
   (|true| |false|)
   "")



(def-mm-enum |isCollection_dataOutput| :BPMN-P NIL 
   (|true| |false|)
   "")
...
;;; ====================== AdHocSubProcess
;;; =========================================================
(def-mm-stereotype |AdHocSubProcess| (:BPMN-P) (|SubProcess|) (UML241:|StructuredActivityNode|) 
 "An Ad-Hoc Sub-Process is a specialized type of Sub-Process that is a group
  ...
  ((|cancelRemainingInstances| :range PTYPES:|Boolean| :multiplicity (1 1) :default :true
    :documentation
   ...
   (|completionCondition| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
...
(def-mm-constraint "AdHocSubProcess.cancelRemainingInstances" |AdHocSubProcess| 
   ...
   :editor-note "Specification is opaque. (See original-body.)"
   :original-body
...
;;; ====================== Assignment
;;; =========================================================
(def-mm-stereotype |Assignment| (:BPMN-P) NIL (UML241:|Class|) 
 "The Assignment class is used to specify a simple mapping of data elements
  ...
  ((|from| :range UML241:|Element| :multiplicity (1 1))
   (|to| :range UML241:|Element| :multiplicity (1 1))))


;;; =========================================================
;;; ====================== Association
;;; =========================================================
(def-mm-stereotype |Association| (:BPMN-P) (|BPMNArtifact|) (UML241:|Dependency|) 
...
;;; ====================== AttributeProperty
;;; =========================================================
(def-mm-stereotype |AttributeProperty| (:BPMN-P) (|BPMNProperty|) (UML241:|Property|) 
 ""
  ())
...
;;; ====================== Auditing
;;; =========================================================
(def-mm-stereotype |Auditing| (:BPMN-P) (|BaseElement|) (UML241:|Dependency|) 
...
;;; ====================== BPMNActivity
;;; =========================================================
(def-mm-stereotype |BPMNActivity| (:BPMN-P) (|FlowNode|) (UML241:|Action|) 
 "An Activity is work that is performed within a Business Process. An Activity
  ...
  ((|boundaryEventRefs| :range |BoundaryEvent| :multiplicity (0 -1) :is-derived-p T
    :opposite (|BoundaryEvent| |attachedToRef|))
   (|completionQuantity| :range PTYPES:|Integer| :multiplicity (1 1) :default 1
    :documentation
   ...
   (|dataInputs| :range |DataInput| :multiplicity (:* -1) :soft-opposite (|DataInput| POD-UNNAMED-1))
   (|dataOutputs| :range |DataOutput| :multiplicity (0 -1) :soft-opposite (|DataOutput| POD-UNNAMED-2))
   (|default| :range |SequenceFlow| :multiplicity (0 1) :soft-opposite (|SequenceFlow| POD-UNNAMED-3)
    :documentation
     "The Sequence Flow that will receive a token when none of the conditionExpressions
      ...
      ignored.")
   (|inputSets| :range |InputSet| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|InputSet| POD-UNNAMED-4))
   (|isForCompensation| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
   ...
   (|outputSets| :range |OutputSet| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|OutputSet| POD-UNNAMED-5))
   (|resources| :range |ResourceRole| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|ResourceRole| POD-UNNAMED-6)
    :documentation
   ...
   (|startQuantity| :range PTYPES:|Integer| :multiplicity (1 1) :default 1
    :documentation
     "The default value is 1. The value MUST NOT be less than 1. This attribute
...
;;; ====================== BPMNArtifact
;;; =========================================================
(def-mm-stereotype |BPMNArtifact| (:BPMN-P) (|BaseElement|) (UML241:|Comment| UML241:|Dependency|) 
...
;;; ====================== BPMNExpression
;;; =========================================================
(def-mm-stereotype |BPMNExpression| (:BPMN-P) (|BaseElement|) (UML241:|OpaqueExpression|) 
...
;;; ====================== BPMNImport
;;; =========================================================
(def-mm-stereotype |BPMNImport| (:BPMN-P) NIL (UML241:|Class|) 
 "The Import class is used when referencing external element, either BPMN
  ...
  ((|definition| :range |Definitions| :multiplicity (1 1)
   ...
   (|importType| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
   ...
   (|location| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
     "Identifies the location of the imported element.")
   (|namespace| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
...
;;; ====================== BPMNInterface
;;; =========================================================
(def-mm-stereotype |BPMNInterface| (:BPMN-P) (|RootElement|) (UML241:|Interface|) 
...
;;; ====================== BPMNProcess
;;; =========================================================
(def-mm-stereotype |BPMNProcess| (:BPMN-P) (|CallableElement|) (UML241:|Activity|) 
 "A Process describes a sequence or flow of Activities in an enterprise with
  ...
  ((|correlationSubscriptions| :range |CorrelationSubscription| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|CorrelationSubscription| POD-UNNAMED-7)
    :documentation
   ...
   (|defintitionalCollaborationRef| :range |Collaboration| :multiplicity (0 1) :soft-opposite (|Collaboration| POD-UNNAMED-8)
    :documentation
   ...
   (|isClosed| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
   ...
   (|resources| :range |ResourceRole| :multiplicity (0 -1) :soft-opposite (|ResourceRole| POD-UNNAMED-9)
    :documentation
   ...
   (|supports| :range |BPMNProcess| :multiplicity (0 -1) :soft-opposite (|BPMNProcess| POD-UNNAMED-10)
    :documentation
...
;;; ====================== BPMNProperty
;;; =========================================================
(def-mm-stereotype |BPMNProperty| (:BPMN-P) (|ItemAwareElement|) NIL 
 "Properties, like Data Objects, are item-aware elements. But, unlike Data
  ...
  ((|itemSubjectRef| :range |ItemDefinition| :multiplicity (0 1) :soft-opposite (|ItemDefinition| POD-UNNAMED-11))))
...
;;; ====================== BaseElement
;;; =========================================================
(def-mm-stereotype |BaseElement| (:BPMN-P) NIL (UML241:|ActivityEdge| UML241:|ActivityNode| UML241:|ActivityPartition| UML241:|Classifier| UML241:|Comment| UML241:|Dependency| UML241:|Package|) 
 "BaseElement is the abstract super class for most BPMN elements. It provides
  ...
  ((|id| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
...
;;; ====================== BoundaryEvent
;;; =========================================================
(def-mm-stereotype |BoundaryEvent| (:BPMN-P) (|CatchEvent|) (UML241:|AcceptEventAction|) 
 ""
...
;;; ====================== BusinessRuleTask
;;; =========================================================
(def-mm-stereotype |BusinessRuleTask| (:BPMN-P) (|Task|) (UML241:|OpaqueAction|) 
 "A Business Rule Task provides a mechanism for the Process to provide input
  ...
  Rules Engine."
  ((|implementation| :range PTYPES:|String| :multiplicity (1 1) :default :##unspecified
    :documentation
...
;;; ====================== CallActivity
;;; =========================================================
(def-mm-stereotype |CallActivity| (:BPMN-P) (|BPMNActivity|) (UML241:|CallBehaviorAction|) 
 "A Call Activity identifies a point in the Process where a global Process
  ...
  to the Embedded Sub-Process of BPMN 1.2."
  ())
...
;;; ====================== CallChoreography
;;; =========================================================
(def-mm-stereotype |CallChoreography| (:BPMN-P) (|ChoreographyActivity|) (UML241:|CallBehaviorAction|) 
 "A Call Choreography identifies a point in the Process where a global Choreography
  ...
  ((|participantAssociations| :range |ParticipantAssociation| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|ParticipantAssociation| POD-UNNAMED-12)
    :documentation
...
;;; ====================== CallConversation
;;; =========================================================
(def-mm-stereotype |CallConversation| (:BPMN-P) (|ConversationNode|) (UML241:|CallBehaviorAction|) 
 "A Call Conversation identifies a place in the Conversation where a global
  Conversation or a GlobalCommunication is used."
  ((|participantAssociations| :range |ParticipantAssociation| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|ParticipantAssociation| POD-UNNAMED-13)
    :documentation
...
;;; ====================== CallableElement
;;; =========================================================
(def-mm-stereotype |CallableElement| (:BPMN-P) (|RootElement|) (UML241:|ActivityNode| UML241:|Classifier|) 
 "CallableElement is the abstract super class of all Activities that have
  ...
  ((|supportedInterfacesRefs| :range UML241:|Interface| :multiplicity (0 -1) :soft-opposite (UML241:|Interface| |callableElements|)
    :documentation
...
;;; ====================== CancelBoundaryEvent
;;; =========================================================
(def-mm-stereotype |CancelBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |CancelEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; ====================== CancelEndEvent
;;; =========================================================
(def-mm-stereotype |CancelEndEvent| (:BPMN-P) (|EndEvent| |CancelEventDefinition|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |CancelEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
...
;;; ====================== CatchEvent
;;; =========================================================
(def-mm-stereotype |CatchEvent| (:BPMN-P) (|Event|) (UML241:|AcceptEventAction|) 
...
;;; ====================== Choreography
;;; =========================================================
(def-mm-stereotype |Choreography| (:BPMN-P) (|Collaboration|) (UML241:|Activity|) 
...
;;; =========================================================
(def-mm-stereotype |ChoreographyActivity| (:BPMN-P) (|FlowNode|) (UML241:|ActivityNode| UML241:|Classifier|) 
 "A Choreography Activity represents a point in a Choreography flow where
  ...
  ((|boundaryEventRefs| :range |BoundaryEvent| :multiplicity (0 -1) :is-derived-p T)
   (|initiatingParticipantRef| :range |Participant| :multiplicity (1 1) :soft-opposite (|Participant| POD-UNNAMED-14)
    :documentation
     "One (1) of the Participants will be the one that initiates the Choreography
      Activity")
   (|participantRefs| :range |Participant| :multiplicity (2 -1) :is-ordered-p T :soft-opposite (|Participant| POD-UNNAMED-15)
    :documentation
...
;;; =========================================================
#|
(def-mm-stereotype |ChoreographyDiagram| (:BPMN-P) NIL (UML241::|Diagram|) 
...
;;; ====================== ChoreographyTask
;;; =========================================================
(def-mm-stereotype |ChoreographyTask| (:BPMN-P) (|ChoreographyActivity|) (UML241:|OpaqueAction|) 
 "A Choreography Task is an atomic Activity in a Choreography Process. It
  ...
  ((|messageFlow| :range |MessageFlow| :multiplicity (1 -1) :is-composite-p T :soft-opposite (|MessageFlow| POD-UNNAMED-16))))


;;; =========================================================
;;; ====================== Collaboration
;;; =========================================================
(def-mm-stereotype |Collaboration| (:BPMN-P) (|RootElement|) (UML241:|Activity|) 
 "Collaborations is a collection of Participants shown as Pools, their interactions
  ...
  ((|artifacts| :range |BPMNArtifact| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|BPMNArtifact| POD-UNNAMED-17))
   (|choreographyRef| :range |Choreography| :multiplicity (0 -1) :soft-opposite (|Choreography| POD-UNNAMED-18)
    :documentation
   ...
   (|conversationAssociations| :range |ConversationAssociation| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|ConversationAssociation| POD-UNNAMED-19)
    :documentation
   ...
   (|conversations| :range |ConversationNode| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|ConversationNode| POD-UNNAMED-20)
    :documentation
     "The conversations model aggregation relationship allows a Collaboration
      ...
      a Choreography.")
   (|correlationKeys| :range |CorrelationKey| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|CorrelationKey| POD-UNNAMED-21)
    :documentation
   ...
   (|messageFlow| :range |MessageFlow| :multiplicity (0 -1)
    :documentation
   ...
   (|messageFlowAssociations| :range |MessageFlowAssociation| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|MessageFlowAssociation| POD-UNNAMED-22)
    :documentation
   ...
   (|participantAssociations| :range |ParticipantAssociation| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|ParticipantAssociation| POD-UNNAMED-23)
    :documentation
     "This attribute provides a list of mappings from the Participants of a referenced.
...
;;; =========================================================
#|
(def-mm-stereotype |CollaborationDiagram| (:BPMN-P) NIL (UML241::|Diagram|) 
...
;;; ====================== Communication
;;; =========================================================
(def-mm-stereotype |Communication| (:BPMN-P) (|ConversationNode|) (UML241:|StructuredActivityNode|) 
 "A Communication is an atomic element for a Conversation diagram. It represents
  ...
  ((|messageFlowRefs| :range |MessageFlow| :multiplicity (0 -1) :soft-opposite (|MessageFlow| POD-UNNAMED-24))))


;;; =========================================================
;;; ====================== CompensationBoundaryEvent
;;; =========================================================
(def-mm-stereotype |CompensationBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |CompenstationEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |CompensationEndEvent| (:BPMN-P) (|EndEvent| |CompenstationEventDefinition|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |CompensationStartEvent| (:BPMN-P) (|StartEvent| |CompenstationEventDefinition|) (UML241:|InitialNode|) 
...
;;; =========================================================
(def-mm-stereotype |CompensationThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |CompenstationEventDefinition|) (UML241:|SendObjectAction|) 
...
;;; =========================================================
(def-mm-stereotype |CompenstationEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 "Compensation Events are used in the context of triggering or handling compensation."
  ((|activityRef| :range |BPMNActivity| :multiplicity (0 1) :soft-opposite (|BPMNActivity| POD-UNNAMED-25)
    :documentation
     "For a Start Event: This Event  catches  the compensation for an Event Sub-Process.
      ...
      broadcast.")
   (|waitForCompletion| :range PTYPES:|Boolean| :multiplicity (1 1) :default :true
    :documentation
...
;;; =========================================================
(def-mm-stereotype |ComplexBehaviorDefinition| (:BPMN-P) NIL (UML241:|Class|) 
 ""
  ((|condition| :range PTYPES:|String| :multiplicity (1 1))
...
;;; ====================== ComplexGateway
;;; =========================================================
(def-mm-stereotype |ComplexGateway| (:BPMN-P) (|Gateway|) (UML241:|ForkNode| UML241:|JoinNode|) 
 "The Complex Gateway can be used to model complex synchronization behavior.
  ...
  Gateway."
  ((|activationCondition| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
     "Determines which combination of incoming tokens will be synchronized for
      activation of the Gateway.")
   (|activationCount| :range PTYPES:|Integer| :multiplicity (1 1)
    :documentation
   ...
   (|default| :range |SequenceFlow| :multiplicity (0 1)
    :documentation
     "The Sequence Flow that will receive a Token when none of the conditionExpressions
      ...
      Flow should not have a conditionExpression. Any such Expression SHALL be
      ignored.")
   (|waitingForStart| :range PTYPES:|Boolean| :multiplicity (1 1) :default :true
    :documentation
...
;;; =========================================================
(def-mm-stereotype |ConditionalBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |ConditionalEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |ConditionalCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |ConditionalEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |ConditionalEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 ""
  ((|condition| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
...
;;; =========================================================
(def-mm-stereotype |ConditionalStartEvent| (:BPMN-P) (|StartEvent| |ConditionalEventDefinition|) (UML241:|InitialNode|) 
 ""
...
;;; =========================================================
(def-mm-stereotype |ConversationAssociation| (:BPMN-P) (|BaseElement|) (UML241:|Class|) 
 "A ConversationAssociation is used within Collaborations and Choreographies
  ...
  ((|messageFlowRefs| :range |MessageFlow| :multiplicity (0 -1)
    :opposite (|MessageFlow| POD-UNNAMED-26)
    :documentation
...
;;; =========================================================
#|
(def-mm-stereotype |ConversationDiagram| (:BPMN-P) NIL (UML241::|Diagram|) 
...
;;; ====================== ConversationLink
;;; =========================================================
(def-mm-stereotype |ConversationLink| (:BPMN-P) NIL (UML241:|Dependency|) 
 ""
  ())
...
;;; ====================== ConversationNode
;;; =========================================================
(def-mm-stereotype |ConversationNode| (:BPMN-P) (|InteractionNode| |BaseElement|) (UML241:|ActivityEdge| UML241:|ActivityPartition| UML241:|CallBehaviorAction| UML241:|Classifier| UML241:|Comment| UML241:|Dependency| UML241:|Package| UML241:|StructuredActivityNode|) 
 "ConversationNode is the abstract super class for all elements that can
  ...
  ((|correlationKeys| :range |CorrelationKey| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|CorrelationKey| POD-UNNAMED-27)
    :documentation
...
;;; ====================== Correlation
;;; =========================================================
(def-mm-stereotype |Correlation| (:BPMN-P) NIL (UML241:|Class|) 
...
;;; ====================== CorrelationKey
;;; =========================================================
(def-mm-stereotype |CorrelationKey| (:BPMN-P) (|BaseElement|) (UML241:|Class|) 
 "A CorrelationKey represents a composite key out of one (1) or many CorrelationProperties
  ...
  ((|correlationPropertyRef| :range |CorrelationProperty| :multiplicity (0 -1) :soft-opposite (|CorrelationProperty| POD-UNNAMED-28)
    :documentation
...
;;; ====================== CorrelationProperty
;;; =========================================================
(def-mm-stereotype |CorrelationProperty| (:BPMN-P) (|RootElement|) (UML241:|Class|) 
 "Key-based correlation is a simple and efficient form of correlation, where
  ...
  for this Conversation. The idea is to use a joint Conversation  token 
  which is used (passed to and received from) and outgoing and incoming Message.
  ...
  this Conversation."
  ((|correlationPropertyRetievalExpression| :range |CorrelationPropertyRetrievalExpression| :multiplicity (1 -1) :is-composite-p T :soft-opposite (|CorrelationPropertyRetrievalExpression| POD-UNNAMED-29)
    :documentation
   ...
   (|type| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
...
;;; =========================================================
(def-mm-stereotype |CorrelationPropertyBinding| (:BPMN-P) NIL (UML241:|Class|) 
 "CorrelationPropertyBindings represent the partial keys of a CorrelationSubscription
  ...
  CorrelationKey."
  ((|correlationPropertyRef| :range |CorrelationProperty| :multiplicity (1 1) :soft-opposite (|CorrelationProperty| POD-UNNAMED-30)
    :documentation
     "The specific CorrelationProperty, this CorrelationPropertyBinding refers
      to.")
   (|dataPathBody| :range UML241:|Element| :multiplicity (1 1)
    :documentation
     "The Data path defines the extraction rule from the Process context. The
      ...
      as element content.")
   (|dataPathLanguage| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
     "The Data path defines the extraction rule from the Process context. The
...
;;; =========================================================
(def-mm-stereotype |CorrelationPropertyRetrievalExpression| (:BPMN-P) NIL (UML241:|Class|) 
 ""
  ((|mesagePathLanguage| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
   ...
   (|messagePathBody| :range UML241:|Element| :multiplicity (1 1)
    :documentation
     "The Message path defines how to extract a CorrelationProperty from the
   ...
   (|messageRef| :range |Message| :multiplicity (1 1) :soft-opposite (|Message| POD-UNNAMED-31)
    :documentation
...
;;; =========================================================
(def-mm-stereotype |CorrelationSubscription| (:BPMN-P) NIL (UML241:|Class|) 
 "a Process MAY provide a CorrelationSubscription which acts as the Process-specific
  ...
  ((|correlationKeyRef| :range |CorrelationKey| :multiplicity (1 1) :soft-opposite (|CorrelationKey| POD-UNNAMED-32)
    :documentation
     "The CorrelationKey this CorrelationSubscription refers to.")
   (|correlationPropertyBinding| :range |CorrelationPropertyBinding| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|CorrelationPropertyBinding| POD-UNNAMED-33)
    :documentation
...
;;; ====================== DataAssociation
;;; =========================================================
(def-mm-stereotype |DataAssociation| (:BPMN-P) (|BaseElement|) (UML241:|ObjectFlow|) 
 "The DataAssociation class is a BaseElement contained by an Activity or
  ...
  ((|assignment| :range |Assignment| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|Assignment| POD-UNNAMED-34)
    :documentation
   ...
   (|transformation| :range PTYPES:|String| :multiplicity (0 1) :is-composite-p T
    :documentation
...
;;; ====================== DataInput
;;; =========================================================
(def-mm-stereotype |DataInput| (:BPMN-P) (|ItemAwareElement|) (UML241:|CentralBufferNode|) 
 "A DataInput is a declaration that a particular kind of data will be used
  ...
  ((|inputSetRefs| :range |InputSet| :multiplicity (1 -1) :is-derived-p T
   ...
   (|isCollection| :range |isCollection_dataInput| :multiplicity (1 1) :default :false
    :documentation
...
;;; =========================================================
(def-mm-stereotype |DataInputAssociation| (:BPMN-P) (|DataAssociation|) (UML241:|ObjectFlow|) 
...
;;; ====================== DataObject
;;; =========================================================
(def-mm-stereotype |DataObject| (:BPMN-P) (|FlowElement| |ItemAwareElement|) (UML241:|CentralBufferNode|) 
...
;;; ====================== DataOutput
;;; =========================================================
(def-mm-stereotype |DataOutput| (:BPMN-P) (|ItemAwareElement|) (UML241:|CentralBufferNode|) 
 "A DataInput is a declaration that a particular kind of data will be used
  as input of the InputOutputSpecification. There may be multiple data inputs
  associated with an InputOutputSpecification. The DataInput is an item-aware
  element. DataInput elements may appear in a Process diagram to show the
  inputs to the Process as whole, which are passed along as the inputs of
  Activities by DataAssociations."
  ((|isCollection| :range |isCollection_dataOutput| :multiplicity (1 1) :default :false
    :documentation
...
;;; =========================================================
(def-mm-stereotype |DataOutputAssociation| (:BPMN-P) (|DataAssociation|) (UML241:|ObjectFlow|) 
...
;;; ====================== DataStore
;;; =========================================================
(def-mm-stereotype |DataStore| (:BPMN-P) (|ItemAwareElement| |RootElement|) (UML241:|CentralBufferNode|) 
 "A DataStore provides a mechanism for Activities to retrieve or update stored
  ...
  ((|capacity| :range PTYPES:|Integer| :multiplicity (0 1)
    :documentation
     "Defines the capacity of the Data Store. This is not needed if the isUnlimited
      attribute is set to true.")
   (|isUnlimited| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
...
;;; ====================== Definitions
;;; =========================================================
(def-mm-stereotype |Definitions| (:BPMN-P) (|BaseElement|) (UML241:|Package|) 
 ""
  ((|exporter| :range PTYPES:|String| :multiplicity (1 1))
   (|exporterVersion| :range PTYPES:|String| :multiplicity (1 1))
   (|expressionLanguage| :range PTYPES:|String| :multiplicity (1 1))
   (|imports| :range |BPMNImport| :multiplicity (:* -1) :is-composite-p T
    :opposite (|BPMNImport| |definition|))
   (|relationships| :range |Relationship| :multiplicity (:* -1) :is-composite-p T
    :opposite (|Relationship| |definition|))
   (|targetNamespace| :range PTYPES:|String| :multiplicity (1 1))
   (|typeLanguage| :range PTYPES:|String| :multiplicity (1 1))))


;;; =========================================================
;;; ====================== EndEvent
;;; =========================================================
(def-mm-stereotype |EndEvent| (:BPMN-P) (|ThrowEvent|) (UML241:|ActivityFinalNode|) 
...
;;; ====================== EndPoint
;;; =========================================================
(def-mm-stereotype |EndPoint| (:BPMN-P) (|RootElement|) (UML241:|Class|) 
...
;;; ====================== Error
;;; =========================================================
(def-mm-stereotype |Error| (:BPMN-P) (|RootElement|) (UML241:|Class|) 
 "An Error represents the content of an Error Event or the Fault of a failed
  ...
  ((|errorCode| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
   ...
   (|structureRef| :range |ItemDefinition| :multiplicity (0 1) :soft-opposite (|ItemDefinition| POD-UNNAMED-35))))


;;; =========================================================
;;; ====================== ErrorBoundaryEvent
;;; =========================================================
(def-mm-stereotype |ErrorBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |ErrorEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; ====================== ErrorEndEvent
;;; =========================================================
(def-mm-stereotype |ErrorEndEvent| (:BPMN-P) (|EndEvent| |ErrorEventDefinition|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |ErrorEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 ""
  ((|errorRef| :range |Error| :multiplicity (0 1) :soft-opposite (|Error| POD-UNNAMED-36)
    :documentation
...
;;; ====================== ErrorStartEvent
;;; =========================================================
(def-mm-stereotype |ErrorStartEvent| (:BPMN-P) (|StartEvent| |ErrorEventDefinition|) (UML241:|InitialNode|) 
...
;;; ====================== Escalation
;;; =========================================================
(def-mm-stereotype |Escalation| (:BPMN-P) (|RootElement|) (UML241:|Class|) 
 "An Escalation identifies a business situation that a Process might need
  to react to."
  ((|escalationCode| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
     "For an End Event: If the Result is an Escalation, then the escalationCode
      ...
      Event.")
   (|structureRef| :range |ItemDefinition| :multiplicity (0 1) :soft-opposite (|ItemDefinition| POD-UNNAMED-37))))


;;; =========================================================
;;; ====================== EscalationBoundaryEvent
;;; =========================================================
(def-mm-stereotype |EscalationBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |EscalationEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; ====================== EscalationEndEvent
;;; =========================================================
(def-mm-stereotype |EscalationEndEvent| (:BPMN-P) (|EndEvent| |EscalationEventDefinition|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |EscalationEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 ""
  ((|escalationCode| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
     "For an End Event: If the Result is an Escalation, then the escalationCode
      ...
      then only an escalation that matches the escalationCode SHALL trigger the
      Event.t.")
   (|escalationRef| :range |Escalation| :multiplicity (0 1) :soft-opposite (|Escalation| POD-UNNAMED-38))
...
;;; =========================================================
(def-mm-stereotype |EscalationStartEvent| (:BPMN-P) (|StartEvent| |EscalationEventDefinition|) (UML241:|InitialNode|) 
...
;;; =========================================================
(def-mm-stereotype |EscalationThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |EscalationEventDefinition|) (UML241:|SendObjectAction|) 
...
;;; ====================== Event
;;; =========================================================
(def-mm-stereotype |Event| (:BPMN-P) (|FlowNode| |MessageFlowNode| |InteractionNode|) (UML241:|Action| UML241:|ControlNode| UML241:|Event|) 
...
;;; ====================== EventBasedGateway
;;; =========================================================
(def-mm-stereotype |EventBasedGateway| (:BPMN-P) (|Gateway|) (UML241:|AcceptEventAction| UML241:|ForkNode|) 
 "The Event-Based Gateway represents a branching point in the Process where
  ...
  different Messages   i.e., they are not the same Message with different
  values within a property of the Message. The receipt of the Message can
  be modeled with an Intermediate Event with a Message Trigger or a Receive
  Task. In addition to Messages, other Triggers for Intermediate Events can
  be used, such as Timers."
  ((|eventGatewayType| :range |EventGatewayType| :multiplicity (1 1) :default :exclusive
   ...
   (|instantiate| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
...
;;; ====================== EventDefinition
;;; =========================================================
(def-mm-stereotype |EventDefinition| (:BPMN-P) (|RootElement|) (UML241:|ActivityEdge| UML241:|ActivityNode| UML241:|ActivityPartition| UML241:|Class| UML241:|Comment| UML241:|Dependency| UML241:|Property|) 
...
;;; ====================== ExclusiveGateway
;;; =========================================================
(def-mm-stereotype |ExclusiveGateway| (:BPMN-P) (|Gateway|) (UML241:|DecisionNode|) 
  ...
  ((|default| :range |SequenceFlow| :multiplicity (0 1)
    :documentation
     "The Sequence Flow that will receive a Token when none of the conditionExpressions
      ...
      Flow should not have a conditionExpression. Any such Expression SHALL be
      ignored.")
   (|gatewayNotation| :range |GatewayNotation| :multiplicity (1 1) :default :|without marker|)))


;;; =========================================================
;;; ====================== FlowElement
;;; =========================================================
(def-mm-stereotype |FlowElement| (:BPMN-P) (|BaseElement|) (UML241:|ActivityEdge| UML241:|ActivityNode| UML241:|Classifier|) 
...
;;; ====================== FlowNode
;;; =========================================================
(def-mm-stereotype |FlowNode| (:BPMN-P) (|FlowElement|) (UML241:|ActivityEdge| UML241:|ActivityNode| UML241:|Classifier|) 
...
;;; ====================== FormalExpression
;;; =========================================================
(def-mm-stereotype |FormalExpression| (:BPMN-P) (|BPMNExpression|) (UML241:|OpaqueExpression|) 
 "The FormalExpression class is used to specify an executable expression
  ...
  ((|body| :range UML241:|Element| :multiplicity (1 1)
    :documentation
     "The body of the expression.")
   (|evaluatesToTypeRef| :range |ItemDefinition| :multiplicity (1 1) :soft-opposite (|ItemDefinition| POD-UNNAMED-39)
    :documentation
     "The type of object that this Expression returns when evaluated. For example,
      conditional Expressions evaluate to a boolean.")
   (|language| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
...
;;; ====================== Gateway
;;; =========================================================
(def-mm-stereotype |Gateway| (:BPMN-P) (|FlowNode|) (UML241:|ActivityEdge| UML241:|ActivityNode|) 
 "Gateways are used to control how the Process flows (how Tokens flow) through
  ...
  Gateways do not represent  work  being done and they are considered to
  have zero effect on the operational measures of the Process being executed
  (cost, time, etc.). The Gateway controls the flow of both diverging and
  converging Sequence Flow. That is, a single Gateway could have multiple
  input and multiple output flows. Modelers and modeling tools may want to
  enforce a best practice of a Gateway only performing one of these functions.
  Thus, it would take two sequential Gateways to first converge and then
  to diverge the Sequence Flow."
...
;;; =========================================================
(def-mm-stereotype |GlobalBusinessRuleTask| (:BPMN-P) (|GlobalTask|) (UML241:|Activity|) 
 "A Business Rule Task provides a mechanism for the Process to provide input
  to a Business Rules Engine and to get the output of calculations that the
  Business Rules Engine might provide. The InputOutputSpecification of the
  Task will allow the Process to send data to and receive data from the Business
...
;;; =========================================================
(def-mm-stereotype |GlobalChoreographyTask| (:BPMN-P) (|Choreography|) (UML241:|Activity|) 
...
;;; ====================== GlobalManualTask
;;; =========================================================
(def-mm-stereotype |GlobalManualTask| (:BPMN-P) (|GlobalTask|) (UML241:|Activity|) 
...
;;; ====================== GlobalScriptTask
;;; =========================================================
(def-mm-stereotype |GlobalScriptTask| (:BPMN-P) (|GlobalTask|) (UML241:|Activity|) 
 "A Script Task is executed by a business process engine. The modeler or
  ...
  ((|script| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
     "The modeler MAY include a script that can be run when the Task is performed.
      ...
      of None.")
   (|scriptFormat| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
...
;;; ====================== GlobalTask
;;; =========================================================
(def-mm-stereotype |GlobalTask| (:BPMN-P) (|CallableElement|) (UML241:|Activity|) 
 "A Global Task is a reusable, atomic Task definition that can be called
  ...
  ((|performers| :range |Performer| :multiplicity (0 1) :is-composite-p T :soft-opposite (|Performer| POD-UNNAMED-40)
    :documentation
   ...
   (|resources| :range |ResourceRole| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|ResourceRole| POD-UNNAMED-41))))


;;; =========================================================
;;; ====================== GlobalUserTask
;;; =========================================================
(def-mm-stereotype |GlobalUserTask| (:BPMN-P) (|GlobalTask|) (UML241:|Activity|) 
 "A User Task is a typical  workflow  Task where a human performer performs
  ...
  ((|implementation| :range |UserTaskImplementation| :multiplicity (1 1)
    :documentation
     "This attribute specifies the technology that will be used to implement
      the User Task.")
   (|renderings| :range |Rendering| :multiplicity (0 -1) :soft-opposite (|Rendering| POD-UNNAMED-42))))


;;; =========================================================
;;; ====================== HumanPerformer
;;; =========================================================
(def-mm-stereotype |HumanPerformer| (:BPMN-P) (|Performer|) (UML241:|Actor| UML241:|Class|) 
...
;;; ====================== ImplicitThrowEvent
;;; =========================================================
(def-mm-stereotype |ImplicitThrowEvent| (:BPMN-P) (|ThrowEvent|) (UML241:|SendObjectAction|) 
 ""
  ())
...
;;; ====================== InclusiveGateway
;;; =========================================================
(def-mm-stereotype |InclusiveGateway| (:BPMN-P) (|Gateway|) (UML241:|ForkNode| UML241:|JoinNode|) 
...
;;; =========================================================
(def-mm-stereotype |InputOutputSpecification| (:BPMN-P) NIL (UML241:|Class|) 
 ""
  ((|dataInputs| :range |DataInput| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|DataInput| POD-UNNAMED-43))
   (|dataOutputs| :range |DataOutput| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|DataOutput| POD-UNNAMED-44))
   (|inputSets| :range |InputSet| :multiplicity (1 -1) :is-composite-p T :soft-opposite (|InputSet| POD-UNNAMED-45))
   (|outputSets| :range |OutputSet| :multiplicity (1 -1) :is-composite-p T :soft-opposite (|OutputSet| POD-UNNAMED-46))))


;;; =========================================================
;;; ====================== InputSet
;;; =========================================================
(def-mm-stereotype |InputSet| (:BPMN-P) NIL (UML241:|Class|) 
...
;;; ====================== InteractionNode
;;; =========================================================
(def-mm-stereotype |InteractionNode| (:BPMN-P) NIL (UML241:|Action| UML241:|ControlNode| UML241:|Event|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |IntermediateCatchEvent| (:BPMN-P) (|CatchEvent|) (UML241:|AcceptEventAction|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |IntermediateThrowEvent| (:BPMN-P) (|ThrowEvent|) (UML241:|SendObjectAction|) 
 ""
  ())
...
;;; ====================== ItemAwareElement
;;; =========================================================
(def-mm-stereotype |ItemAwareElement| (:BPMN-P) (|BaseElement|) (UML241:|CentralBufferNode|) 
 ""
  ())
...
;;; ====================== ItemDefinition
;;; =========================================================
(def-mm-stereotype |ItemDefinition| (:BPMN-P) (|RootElement|) (UML241:|Class|) 
 "BPMN elements, such as DataObjects and Messages, represent items that are
  ...
  ((|import| :range |BPMNImport| :multiplicity (0 1) :soft-opposite (|BPMNImport| POD-UNNAMED-47)
    :documentation
   ...
   (|structureRef| :range UML241:|Element| :multiplicity (0 1)
    :documentation
...
;;; ====================== Lane
;;; =========================================================
(def-mm-stereotype |Lane| (:BPMN-P) (|BaseElement|) (UML241:|ActivityPartition|) 
...
;;; =========================================================
(def-mm-stereotype |LinkCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |LinkEventDefinition|) (UML241:|AcceptEventAction|) 
 "The Link Intermediate Events are only valid in Normal Flow, i.e. they may
  ...
  printing a Process across multiple pages. They can also be used as generic
   Go To  objects within the Process level. There can be multiple Source
...
;;; ====================== LinkEventDefinition
;;; =========================================================
(def-mm-stereotype |LinkEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
...
;;; =========================================================
(def-mm-stereotype |LinkThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |LinkEventDefinition|) (UML241:|SendObjectAction|) 
 "The Link Intermediate Events are only valid in Normal Flow, i.e. they may
  not be used on the boundary of an Activity. A Link is a mechanism for connecting
  two sections of a Process. Link Events can be used to create looping situations
  or to avoid long Sequence Flow lines. Link Event uses are limited to a
...
;;; ====================== ManualTask
;;; =========================================================
(def-mm-stereotype |ManualTask| (:BPMN-P) (|Task|) (UML241:|OpaqueAction|) 
 "A Manual Task is a Task that is expected to be performed without the aid
  of any business process execution engine or any application. A Manual Task
  is not managed by any business process engine. It can be considered as
  an unmanaged Task, unmanaged in the sense of that the business process
...
;;; ====================== Message
;;; =========================================================
(def-mm-stereotype |Message| (:BPMN-P) (|RootElement|) (UML241:|CentralBufferNode|) 
 "A Message is used to depict the content of a communication between two
  ...
  ((|itemRef| :range |ItemDefinition| :multiplicity (0 1) :soft-opposite (|ItemDefinition| POD-UNNAMED-48)
    :documentation
...
;;; =========================================================
(def-mm-stereotype |MessageBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |MessageEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |MessageCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |MessageEventDefinition|) (UML241:|AcceptEventAction|) 
 ""
  ())
...
;;; ====================== MessageEndEvent
;;; =========================================================
(def-mm-stereotype |MessageEndEvent| (:BPMN-P) (|EndEvent| |MessageEventDefinition|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |MessageEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 ""
  ((|messageRef| :range |Message| :multiplicity (0 1) :soft-opposite (|Message| POD-UNNAMED-49)
    :documentation
     "The Message MUST be supplied (if the processType attribute of the Process
      is set to executable).")
   (|operationRef| :range UML241:|Operation| :multiplicity (0 1)
    :documentation
...
;;; ====================== MessageFlow
;;; =========================================================
(def-mm-stereotype |MessageFlow| (:BPMN-P) (|BaseElement|) (UML241:|Dependency|) 
 "A Message Flow is used to show the flow of Messages between two Participants
  ...
  ((POD-UNNAMED-50 :range |ConversationAssociation| :multiplicity (0 -1)
    :opposite (|ConversationAssociation| |messageFlowRefs|))
   (|messageRef| :range |Message| :multiplicity (0 1) :soft-opposite (|Message| POD-UNNAMED-51))))
...
;;; =========================================================
(def-mm-stereotype |MessageFlowAssociation| (:BPMN-P) (|BaseElement|) (UML241:|Dependency|) 
...
;;; ====================== MessageFlowNode
;;; =========================================================
(def-mm-stereotype |MessageFlowNode| (:BPMN-P) NIL (UML241:|ActivityNode| UML241:|Classifier|) 
...
;;; ====================== MessageStartEvent
;;; =========================================================
(def-mm-stereotype |MessageStartEvent| (:BPMN-P) (|StartEvent| |MessageEventDefinition|) (UML241:|InitialNode|) 
...
;;; =========================================================
(def-mm-stereotype |MessageThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |MessageEventDefinition|) (UML241:|SendObjectAction|) 
...
;;; ====================== Monitoring
;;; =========================================================
(def-mm-stereotype |Monitoring| (:BPMN-P) (|BaseElement|) (UML241:|Dependency|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |MultiInstanceLoopCharacteristics| (:BPMN-P) NIL (UML241:|CallBehaviorAction| UML241:|OpaqueAction| UML241:|StructuredActivityNode|) 
 "The MultiInstanceLoopCharacteristics class allows for creation of a desired
  ...
  ((|behavior| :range |MultiInstanceBehavior| :multiplicity (1 1) :default :all
   ...
   (|completionCondition| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
   ...
   (|inputDataItem| :range |BPMNProperty| :multiplicity (0 1)
    :documentation
     "A Data Input, representing for every Activity instance the single item
      ...
      loopDataInput.")
   (|isSequential| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
     "This attribute is a flag that controls whether the Activity instances will
      execute sequentially or in parallel.")
   (|loopCardinality| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
     "A numeric Expression that controls the number of Activity instances that
      ...
      MUST be specified.")
   (|loopCounter| :range PTYPES:|Integer| :multiplicity (1 1)
    :documentation
   ...
   (|numberOfActiveInstances| :range PTYPES:|Integer| :multiplicity (1 1)
    :documentation
   ...
   (|numberOfCompletedInstances| :range PTYPES:|Integer| :multiplicity (1 1)
    :documentation
     "This attribute is provided for the outer instance of the Multi-Instance
      Activity only. This attribute contains the number of already completed
      inner instances for the Multi-Instance Activity.")
   (|numberOfInstances| :range PTYPES:|Integer| :multiplicity (1 1))
   (|numberOfTerminatedInstances| :range PTYPES:|Integer| :multiplicity (1 1)
    :documentation
     "This attribute is provided for the outer instance of the Multi-Instance
...
;;; =========================================================
(def-mm-stereotype |MultipleBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |TimerEventDefinition| |MessageEventDefinition| |LinkEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TerminateEventDefinition| |CancelEventDefinition| |CompenstationEventDefinition| |ConditionalEventDefinition| |ErrorEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; ====================== MultipleEndEvent
;;; =========================================================
(def-mm-stereotype |MultipleEndEvent| (:BPMN-P) (|EndEvent| |MessageEventDefinition| |LinkEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TimerEventDefinition| |TerminateEventDefinition| |ErrorEventDefinition| |ConditionalEventDefinition| |CompenstationEventDefinition| |CancelEventDefinition|) (UML241:|ActivityFinalNode|) 
...
;;; ====================== MultipleStartEvent
;;; =========================================================
(def-mm-stereotype |MultipleStartEvent| (:BPMN-P) (|StartEvent| |CancelEventDefinition| |MessageEventDefinition| |LinkEventDefinition| |TimerEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TerminateEventDefinition| |CompenstationEventDefinition| |ConditionalEventDefinition| |ErrorEventDefinition|) (UML241:|InitialNode|) 
...
;;; ====================== NoneEndEvent
;;; =========================================================
(def-mm-stereotype |NoneEndEvent| (:BPMN-P) (|EndEvent|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |NoneIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent|) (UML241:|AcceptEventAction|) 
...
;;; ====================== NoneStartEvent
;;; =========================================================
(def-mm-stereotype |NoneStartEvent| (:BPMN-P) (|StartEvent|) (UML241:|InitialNode|) 
...
;;; ====================== Operation
;;; =========================================================
(def-mm-stereotype |Operation| (:BPMN-P) (|BaseElement|) (UML241:|Operation|) 
 ""
  ((|errorRef| :range |Error| :multiplicity (0 -1) :soft-opposite (|Error| POD-UNNAMED-52)
    :documentation
   ...
   (|inMessageRef| :range |Message| :multiplicity (1 1) :soft-opposite (|Message| POD-UNNAMED-53)
    :documentation
     "This attribute specifies the input Message of the Operation. An Operation
      has exactly one input Message.")
   (|outMessageRef| :range |Message| :multiplicity (0 1) :soft-opposite (|Message| POD-UNNAMED-54)
    :documentation
...
;;; ====================== OutputSet
;;; =========================================================
(def-mm-stereotype |OutputSet| (:BPMN-P) NIL (UML241:|Class|) 
 ""
...
;;; ====================== ParallelGateway
;;; =========================================================
(def-mm-stereotype |ParallelGateway| (:BPMN-P) (|Gateway|) (UML241:|ForkNode| UML241:|JoinNode|) 
...
(def-mm-stereotype |ParallelMultipleBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |MessageEventDefinition| |LinkEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TimerEventDefinition| |TerminateEventDefinition| |ErrorEventDefinition| |ConditionalEventDefinition| |CompenstationEventDefinition| |CancelEventDefinition|) (UML241:|AcceptEventAction|) 
 "This means that there are multiple triggers assigned to the Event. When
  ...
  trigger. Unlike the normal Multiple Intermediate Event, all of the assigned
...
;;; =========================================================
(def-mm-stereotype |ParallelMultipleCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |MessageEventDefinition| |LinkEventDefinition| |SignalEventDefinition| |EscalationEventDefinition| |TimerEventDefinition| |CancelEventDefinition| |CompenstationEventDefinition| |ConditionalEventDefinition| |ErrorEventDefinition| |TerminateEventDefinition|) (UML241:|AcceptEventAction|) 
 "This means that there are multiple triggers assigned to the Event. If used
...
;;; =========================================================
(def-mm-stereotype |ParallelMultipleStartEvent| (:BPMN-P) (|StartEvent| |SignalEventDefinition| |CompenstationEventDefinition| |ErrorEventDefinition| |TerminateEventDefinition| |TimerEventDefinition| |LinkEventDefinition| |MessageEventDefinition| |ConditionalEventDefinition| |CancelEventDefinition| |EscalationEventDefinition|) (UML241:|InitialNode|) 
 ""
...
;;; ====================== Participant
;;; =========================================================
(def-mm-stereotype |Participant| (:BPMN-P) (|MessageFlowNode| |RootElement| |BaseElement|) (UML241:|Actor| UML241:|Class|) 
 "A Participant represents a specific PartnerEntity (e.g., a company) and/or
  ...
  ((|endpointRefs| :range |EndPoint| :multiplicity (0 -1) :soft-opposite (|EndPoint| POD-UNNAMED-55)
    :documentation
     "This attribute is used to specify the address (or endpoint reference) of
      concrete services realizing the Participant.")
   (|globalChoreographyTask| :range |GlobalChoreographyTask| :multiplicity (0 -1)
    :opposite (|GlobalChoreographyTask| |initiatingParticipantRef|))
   (|interfaceRef| :range UML241:|Interface| :multiplicity (:* -1) :soft-opposite (UML241:|Interface| POD-UNNAMED-56)
    :documentation
     "This association defines Interfaces that a Participant supports.")
   (|maximum| :range PTYPES:|Integer| :multiplicity (1 1) :default 1
    :documentation
   ...
   (|minimum| :range PTYPES:|Integer| :multiplicity (1 1) :default 0
    :documentation
   ...
   (|numParticipants| :range PTYPES:|Integer| :multiplicity (0 1)
    :documentation
   ...
   (|partnerRoleRef| :range |PartnerRole| :multiplicity (0 1) :is-readonly-p T
    ...
    :documentation
     "The partnerRoleRef attribute identifies a PartnerRole that the Participant
      plays in the Collaboration. Both a PartnerRole and a PartnerEntity MAY
      be defined for the Participant.")
   (|processRef| :range |BPMNProcess| :multiplicity (0 1) :soft-opposite (|BPMNProcess| POD-UNNAMED-57)
    :documentation
...
;;; =========================================================
(def-mm-stereotype |ParticipantAssociation| (:BPMN-P) (|BaseElement|) (UML241:|Dependency|) 
 "These elements are used to do mapping between two elements that both contain
  ...
  contains its own set of ParticipantAssociations.   A Call Choreography
  references a Choreography or GlobalChoreographyTask. Thus, the Participants
  of the Choreography or GlobalChoreographyTask (the inner diagram) need
  to be mapped to the Participants referenced by the Call Choreography (the
  outer element). Each Call Choreography contains its own set of ParticipantAssociations.
...
;;; ====================== PartnerEntity
;;; =========================================================
(def-mm-stereotype |PartnerEntity| (:BPMN-P) (|RootElement|) (UML241:|Actor| UML241:|Class|) 
...
;;; ====================== PartnerRole
;;; =========================================================
(def-mm-stereotype |PartnerRole| (:BPMN-P) (|RootElement|) (UML241:|Actor| UML241:|Class|) 
...
;;; ====================== Performer
;;; =========================================================
(def-mm-stereotype |Performer| (:BPMN-P) (|ResourceRole|) (UML241:|Actor| UML241:|Class|) 
...
;;; ====================== PinProperty
;;; =========================================================
(def-mm-stereotype |PinProperty| (:BPMN-P) (|BPMNProperty|) (UML241:|ValuePin|) 
 ""
  ())
...
;;; ====================== Pool
;;; =========================================================
(def-mm-stereotype |Pool| (:BPMN-P) (|MessageFlowNode|) (UML241:|ActivityPartition|) 
...
;;; ====================== PotentialOwner
;;; =========================================================
(def-mm-stereotype |PotentialOwner| (:BPMN-P) (|HumanPerformer|) (UML241:|Actor| UML241:|Class|) 
 ""
  ())
...
;;; =========================================================
#|
(def-mm-stereotype |ProcessDiagram| (:BPMN-P) NIL (UML241::|Diagram|) 
...
;;; ====================== ReceiveTask
;;; =========================================================
(def-mm-stereotype |ReceiveTask| (:BPMN-P) (|Task|) (UML241:|OpaqueAction|) 
 "A Receive Task is a simple Task that is designed to wait for a Message
  ...
  ((|implementation| :range |Implementation| :multiplicity (1 1) :default :|web service|
   ...
   (|messageRef| :range |Message| :multiplicity (0 1) :soft-opposite (|Message| POD-UNNAMED-58)
    :documentation
   ...
   (|operationRef| :range UML241:|Operation| :multiplicity (1 1) :soft-opposite (UML241:|Operation| POD-UNNAMED-59)
    :documentation
...
;;; ====================== Relationship
;;; =========================================================
(def-mm-stereotype |Relationship| (:BPMN-P) (|BaseElement|) (UML241:|ActivityEdge| UML241:|ActivityNode| UML241:|Classifier| UML241:|Dependency|) 
 "It is the intention of this specification to cover the basic elements required
  ...
  of  derivation  or  definition  relationships between UML artifacts and
  BPMN Artifacts in novel ways. So, a UML use case could be related to a
  Process element in the BPMN specification without affecting the nature
  of the Artifacts themselves, but enabling different integration models
  that traverse specialized relationships. Simply, the model enables the
  external specification of augmentation relationships between BPMN Artifacts
  and arbitrary relationship classification models, these external models,
  via traversing relationships declared in the external definition allow
  for linkages between BPMN elements and other structured or non-structured
...
;;; ====================== Rendering
;;; =========================================================
(def-mm-stereotype |Rendering| (:BPMN-P) NIL (UML241:|Pin|) 
...
;;; ====================== Resource
;;; =========================================================
(def-mm-stereotype |Resource| (:BPMN-P) (|RootElement|) (UML241:|Actor| UML241:|Class|) 
...
;;; =========================================================
(def-mm-stereotype |ResourceAssignmentExpression| (:BPMN-P) NIL (UML241:|Class|) 
 ""
  ((|expression| :range PTYPES:|String| :multiplicity (1 1) :is-composite-p T
    :documentation
...
;;; ====================== ResourceParameter
;;; =========================================================
(def-mm-stereotype |ResourceParameter| (:BPMN-P) (|RootElement| |BaseElement|) (UML241:|Property|) 
 "Resource can define a set of parameters to define a query to resolve the
  ...
  ((|isRequired| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
...
;;; =========================================================
(def-mm-stereotype |ResourceParameterBinding| (:BPMN-P) NIL (UML241:|Class|) 
 ""
  ((|expression| :range PTYPES:|String| :multiplicity (1 1) :is-composite-p T
    :documentation
     "The Expression that evaluates the value used to bind the ResourceParameter.")
   (|parameterRef| :range |ResourceParameter| :multiplicity (1 1) :soft-opposite (|ResourceParameter| POD-UNNAMED-60)
    :documentation
...
;;; ====================== ResourceRole
;;; =========================================================
(def-mm-stereotype |ResourceRole| (:BPMN-P) (|BaseElement|) (UML241:|Actor| UML241:|Class|) 
 "The ResourceRole element inherits the attributes and model associations
  ...
  ((|ResourceAssignmentExpression| :range |ResourceAssignmentExpression| :multiplicity (0 1) :is-composite-p T :soft-opposite (|ResourceAssignmentExpression| POD-UNNAMED-61)
    :documentation
   ...
   (|resourceParameterBindings| :range |ResourceParameterBinding| :multiplicity (:* -1) :is-composite-p T :soft-opposite (|ResourceParameterBinding| POD-UNNAMED-62)
    :documentation
     "This defines the Parameter bindings used for the Resource assignment. Is
      only applicable if a resourceRef is specified.")
   (|resourceRef| :range |Resource| :multiplicity (0 1) :soft-opposite (|Resource| POD-UNNAMED-63)
    :documentation
...
;;; ====================== RootElement
;;; =========================================================
(def-mm-stereotype |RootElement| (:BPMN-P) (|BaseElement|) (UML241:|ActivityEdge| UML241:|ActivityNode| UML241:|ActivityPartition| UML241:|Classifier| UML241:|Comment| UML241:|Dependency| UML241:|Property|) 
...
;;; ====================== ScriptTask
;;; =========================================================
(def-mm-stereotype |ScriptTask| (:BPMN-P) (|Task|) (UML241:|OpaqueAction|) 
 "A Script Task is executed by a business process engine. The modeler or
  implementer defines a script in a language that the engine can interpret.
  When the Task is ready to start, the engine will execute the script. When
  the script is completed, the Task will also be completed."
  ((|script| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
     "The modeler MAY include a script that can be run when the Task is performed.
      If a script is not included, then the Task will act as the equivalent of
      an Abstract Task.")
   (|scriptFormat| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
...
;;; ====================== SendTask
;;; =========================================================
(def-mm-stereotype |SendTask| (:BPMN-P) (|Task|) (UML241:|OpaqueAction|) 
 "A Send Task is a simple Task that is designed to send a Message to an external
  ...
  ((|implementation| :range |Implementation| :multiplicity (1 1) :default :|web service|)
   (|messageRef| :range |Message| :multiplicity (0 1) :soft-opposite (|Message| POD-UNNAMED-64)
    :documentation
     "A Message for the messageRef attribute MAY be entered. This indicates that
   ...
   (|operationRef| :range UML241:|Operation| :multiplicity (1 1) :soft-opposite (UML241:|Operation| POD-UNNAMED-65)
    :documentation
...
;;; ====================== SequenceFlow
;;; =========================================================
(def-mm-stereotype |SequenceFlow| (:BPMN-P) (|FlowElement|) (UML241:|ControlFlow|) 
 "A Sequence Flow is used to show the order of Flow Elements in a Process.
  ...
  are false)."
  ((|isImmediate| :range PTYPES:|Boolean| :multiplicity (1 1)
    :documentation
...
;;; ====================== ServiceTask
;;; =========================================================
(def-mm-stereotype |ServiceTask| (:BPMN-P) (|Task|) (UML241:|OpaqueAction|) 
...
;;; ====================== SignalBoundaryEvent
;;; =========================================================
(def-mm-stereotype |SignalBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |SignalEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |SignalCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |SignalEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; ====================== SignalEndEvent
;;; =========================================================
(def-mm-stereotype |SignalEndEvent| (:BPMN-P) (|EndEvent| |SignalEventDefinition|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |SignalEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 ""
  ((|signalRef| :range UML241:|Signal| :multiplicity (0 1)
    :documentation
...
;;; ====================== SignalStartEvent
;;; =========================================================
(def-mm-stereotype |SignalStartEvent| (:BPMN-P) (|StartEvent| |SignalEventDefinition|) (UML241:|InitialNode|) 
 ""
...
;;; =========================================================
(def-mm-stereotype |SignalThrowIntermediateEvent| (:BPMN-P) (|IntermediateThrowEvent| |SignalEventDefinition|) (UML241:|Class| UML241:|SendObjectAction|) 
 "This type of event is used for sending or receiving Signals. A Signal is
  for general communication within and across Process Levels, across Pools,
  and between Business Process Diagrams. A BPMN Signal is similar to a signal
  flare that shot into the sky for anyone who might be interested to notice
...
;;; =========================================================
(def-mm-stereotype |StandardLoopCharacteristics| (:BPMN-P) NIL (UML241:|CallBehaviorAction| UML241:|OpaqueAction| UML241:|StructuredActivityNode|) 
 "The StandardLoopCharacteristics class defines looping behavior based on
  ...
  not exceed this cap."
  ((|loopCondition| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
   ...
   (|loopCounter| :range PTYPES:|Integer| :multiplicity (1 1)
    :documentation
     "The LoopCounter attribute is used at runtime to count the number of loops
      and is automatically updated by the process engine.")
   (|loopMaximum| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
     "Serves as a cap on the number of iterations.")
   (|testBefore| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
...
;;; ====================== StartEvent
;;; =========================================================
(def-mm-stereotype |StartEvent| (:BPMN-P) (|CatchEvent|) (UML241:|InitialNode|) 
...
;;; ====================== SubChoreography
;;; =========================================================
(def-mm-stereotype |SubChoreography| (:BPMN-P) (|ChoreographyActivity|) (UML241:|StructuredActivityNode|) 
 "A Choreography Sub-Process is a compound Activity in that it has detail
  ...
  a Choreography Task."
  ((|referencedDiagram| :range UML241:|Element| :multiplicity (1 1)))) ; pod range was "UML\ 2.4.1" -- not investigated


;;; =========================================================
;;; ====================== SubConversation
;;; =========================================================
(def-mm-stereotype |SubConversation| (:BPMN-P) (|ConversationNode|) (UML241:|StructuredActivityNode|) 
...
;;; ====================== SubProcess
;;; =========================================================
(def-mm-stereotype |SubProcess| (:BPMN-P) (|BPMNActivity|) (UML241:|StructuredActivityNode|) 
 "A Sub-Process is an Activity whose internal details have been modeled using
  ...
  ((|referencedDiagram| :range UML241:|Element| :multiplicity (0 1)) ; pod range was UML\ 2.4.1 -- not investigated
   (|triggeredByEvent| :range PTYPES:|Boolean| :multiplicity (1 1) :default :false
    :documentation
...
;;; ====================== Task
;;; =========================================================
(def-mm-stereotype |Task| (:BPMN-P) (|BPMNActivity| |MessageFlowNode| |InteractionNode|) (UML241:|OpaqueAction|) 
...
;;; ====================== TerminateEndEvent
;;; =========================================================
(def-mm-stereotype |TerminateEndEvent| (:BPMN-P) (|EndEvent| |TerminateEventDefinition|) (UML241:|ActivityFinalNode|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |TerminateEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 ""
  ())
...
;;; ====================== TextAnnotation
;;; =========================================================
(def-mm-stereotype |TextAnnotation| (:BPMN-P) (|BPMNArtifact|) (UML241:|Comment|) 
...
;;; ====================== ThrowEvent
;;; =========================================================
(def-mm-stereotype |ThrowEvent| (:BPMN-P) (|Event|) NIL 
 "Events that throw a Result. All End Events and some Intermediate Events
  ...
  ((|dataInput| :range |DataInput| :multiplicity (0 1) :is-composite-p T :soft-opposite (|DataInput| POD-UNNAMED-66))
...
;;; ====================== TimerBoundaryEvent
;;; =========================================================
(def-mm-stereotype |TimerBoundaryEvent| (:BPMN-P) (|BoundaryEvent| |TimerEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |TimerCatchIntermediateEvent| (:BPMN-P) (|IntermediateCatchEvent| |TimerEventDefinition|) (UML241:|AcceptEventAction|) 
...
;;; =========================================================
(def-mm-stereotype |TimerEventDefinition| (:BPMN-P) (|EventDefinition|) NIL 
 ""
  ((|timeCycle| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
   ...
   (|timeDate| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
   ...
   (|timeDuration| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
...
;;; ====================== TimerStartEvent
;;; =========================================================
(def-mm-stereotype |TimerStartEvent| (:BPMN-P) (|StartEvent| |TimerEventDefinition|) (UML241:|InitialNode|) 
 "A specific time-date or a specific cycle (e.g. every Monday at 9 am) can
...
;;; ====================== Transaction
;;; =========================================================
(def-mm-stereotype |Transaction| (:BPMN-P) (|SubProcess|) (UML241:|StructuredActivityNode|) 
 "A Transaction is a specialized type of Sub-Process which will have a special
  ...
  ((|method| :range |TransactionMethod| :multiplicity (1 1) :default :compensate
   ...
   (|protocol| :range PTYPES:|String| :multiplicity (0 1)
    :documentation
...
;;; ====================== UserTask
;;; =========================================================
(def-mm-stereotype |UserTask| (:BPMN-P) (|Task|) (UML241:|OpaqueAction|) 
 "A User Task is a typical  workflow  Task where a human performer performs
  the Task with the assistance of a software application and is scheduled
  through a task list manager of some sort."
  ((|actualOwner| :range PTYPES:|String| :multiplicity (1 1)
    :documentation
   ...
   (|renderings| :range |Rendering| :multiplicity (0 -1) :is-composite-p T :soft-opposite (|Rendering| POD-UNNAMED-67))
   (|taskPriority| :range PTYPES:|Integer| :multiplicity (1 1)
    :documentation
...
;;; ====================== VariableProperty
;;; =========================================================
(def-mm-stereotype |VariableProperty| (:BPMN-P) (|BPMNProperty|) (UML241:|Class| UML241:|Variable|) 
 ""
  ())
...
;;; ====================== conditional_false
;;; =========================================================
(def-mm-stereotype |conditional_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== conditional_true
;;; =========================================================
(def-mm-stereotype |conditional_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== escalation_false
;;; =========================================================
(def-mm-stereotype |escalation_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== escalation_true
;;; =========================================================
(def-mm-stereotype |escalation_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |gatewayNotation_withMarker| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |gatewayNotation_withoutMarker| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |is_collection_dataInput_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |is_collection_dataInput_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |is_collection_dataOutput_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |is_collection_dataOutput_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== is_collection_false
;;; =========================================================
(def-mm-stereotype |is_collection_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== is_collection_true
;;; =========================================================
(def-mm-stereotype |is_collection_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== message_false
;;; =========================================================
(def-mm-stereotype |message_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== message_true
;;; =========================================================
(def-mm-stereotype |message_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== multiple_false
;;; =========================================================
(def-mm-stereotype |multiple_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== multiple_true
;;; =========================================================
(def-mm-stereotype |multiple_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |parrallelMultiple_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |parrallelMultiple_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== signal_false
;;; =========================================================
(def-mm-stereotype |signal_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== signal_true
;;; =========================================================
(def-mm-stereotype |signal_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_conditional_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_conditional_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_escalation_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_escalation_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_message_false
;;; =========================================================
(def-mm-stereotype |start_message_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_message_true
;;; =========================================================
(def-mm-stereotype |start_message_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_multiple_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_multiple_true
;;; =========================================================
(def-mm-stereotype |start_multiple_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_parallelMultiple_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; =========================================================
(def-mm-stereotype |start_parallelMultiple_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_signal_false
;;; =========================================================
(def-mm-stereotype |start_signal_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_signal_true
;;; =========================================================
(def-mm-stereotype |start_signal_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_timer_false
;;; =========================================================
(def-mm-stereotype |start_timer_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== start_timer_true
;;; =========================================================
(def-mm-stereotype |start_timer_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== timer_false
;;; =========================================================
(def-mm-stereotype |timer_false| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())
...
;;; ====================== timer_true
;;; =========================================================
(def-mm-stereotype |timer_true| (:BPMN-P) NIL (UML241:|EnumerationLiteral|) 
 ""
  ())


(def-mm-package |Activities| |Process| :BPMN-P 
   (|ResourceParameterBinding|
    |Transaction|
    |AdHocOrdering|
    |BPMNActivity|
...
(def-mm-package |Artifacts| |Common| :BPMN-P 
   (|BPMNArtifact|
    |TextAnnotation|
    |Association|
    |AssociationDirection|))

(def-mm-package |BPMN2 Profile| NIL :BPMN-P 
   (|Supplementary|
    |Collaboration|
    |Diagrams|
    |Choreography|
...
(def-mm-package |Choreography| |BPMN2 Profile| :BPMN-P 
   (|Choreography|
    |GlobalChoreographyTask|
    |ChoreographyActivities|))

(def-mm-package |ChoreographyActivities| |Choreography| :BPMN-P 
   (|SubChoreography|
    |ChoreographyActivity|
    |CallChoreography|
    |ChoreographyTask|))

(def-mm-package |Collaboration| |BPMN2 Profile| :BPMN-P 
   (|Collaboration|))

(def-mm-package |Common| |Core| :BPMN-P 
   (|BPMNExpression|
    |SequenceFlow|
    |Participant|
    |ResourceParameter|
...
(def-mm-package |Conversation| |BPMN2 Profile| :BPMN-P 
   (|ConversationNode|
    |ConversationLink|
    |CallConversation|
    |SubConversation|
...
(def-mm-package |Core| |BPMN2 Profile| :BPMN-P 
   (|Foundation|
    |Definitions|
    |Service|
    |Common|
...
(def-mm-package |Data| |Process| :BPMN-P 
   (|InputSet|
    |DataInputAssociation|
    |BPMNProperty|
    |OutputSet|
...
(def-mm-package |Diagrams| |BPMN2 Profile| :BPMN-P 
   (|ConversationDiagram|
    |CollaborationDiagram|
    |ProcessDiagram|
    |ChoreographyDiagram|))

(def-mm-package |Events| |Common| :BPMN-P 
   (|ConditionalEventDefinition|
    |ParallelMultipleStartEvent|
    |MessageCatchIntermediateEvent|
    |TerminateEventDefinition|
...
(def-mm-package |Foundation| |Core| :BPMN-P 
   (|Relationship|
    |RootElement|
    |BaseElement|))

(def-mm-package |Gateways| |Common| :BPMN-P 
   (|ParallelGateway|
    |ComplexGateway|
    |InclusiveGateway|
    |ExclusiveGateway|
...
(def-mm-package |HumanInteraction| |Process| :BPMN-P 
   (|HumanPerformer|
    |GlobalUserTask|
    |UserTask|
...
(def-mm-package |Infrastructure| |BPMN2 Profile| :BPMN-P 
   (|BPMNImport|))

(def-mm-package |Process| |BPMN2 Profile| :BPMN-P 
   (|Lane|
    |Pool|
    |Performer|
    |Auditing|
...
(def-mm-package |Service| |Core| :BPMN-P 
   (|Operation|
    |BPMNInterface|
    |EndPoint|))

(def-mm-package |Supplementary| |BPMN2 Profile| :BPMN-P 
   (|isInterrupting_message|
    |cancelActivity_escalation|
    |escalation_true|
    |start_conditional_true|
    |start_conditional_false|
    |isInterrupting_escalation|
    |parrallelMultiple_true|
    |start_message_true|
    |cancelActivity_signal|
    |timer_false|
    |isInterrupting_timer|
    |isCollection|
    |conditional_false|
    |cancelActivity_timer|
    |isInterrupting_conditional|
    |conditional_true|
    |start_escalation_false|
    |isInterrupting_parallelMultiple|
    |escalation_false|
    |start_multiple_true|
    |timer_true|
    |multiple_true|
    ...
    |start_parallelMultiple_false|
    |multiple_false|
    |cancelActivity_multiple|
    |cancelActivity_conditional|
    |message_false|
    |signal_true|
    |start_timer_true|
    |is_collection_true|
    ...
    |start_message_false|
    |start_signal_true|
    |isInterrupting_signal|
    |signal_false|
    |start_multiple_false|
    |cancelActivity_parallelMultiple|
    |is_collection_false|
    |start_parallelMultiple_true|
    |cancelActivity_message|
    |message_true|
    |start_timer_false|
    |isInterrupting_multiple|
    |is_collection_dataOutput_true|
    |isCollection_dataOutput|
    |is_collection_dataInput_true|
    |is_collection_dataInput_false|
    |is_collection_dataOutput_false|
    |isCollection_dataInput|
    |GatewayNotation|
    |gatewayNotation_withMarker|
    |gatewayNotation_withoutMarker|))

(def-mm-package UML2.4.1 NIL :BPMN-P 
   ())
