...
(defparameter *about-ht* (make-hash-table)) ; 2022 was :test eq
	  ...
	  (when-bind (comment (xml-find-child 'rdfs:|comment| oelem))
	    (setf |ODM-RDFBase|::|RDFScomment|
		  (with-instance (|ODM-RDFBase|::|PlainLiteral|)
		    (setf |ODM-RDFConcepts|::|lexicalForm| (car (xml-utils:xml-children comment)))))) ; 2022 "Concepts" was "Base"
