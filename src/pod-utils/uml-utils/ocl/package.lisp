...
(defpackage ocl
  ...
  (:export
    ...
    #:bag-typ-p
    #:base-type
    #:|body| ; 2022 this seems neccessary.
    #:boolean-typ
    #:collection-typ
    #:|Collection|
    #:compile-constraints
    ...
    #:|Variable|
    #:self
    ;; sbcl: OCL also exports the following symbols:
    #:|true| #:|pre| #:|then| #:|else| #:|xor| #:|package|
    #:|attr| #:|and| #:|def| #:|invalid| #:|or| #:|endpackage|
    #:|false| #:|oper| #:|endif| #:|context| #:|self| #:|if|
    #:|not| #:|init| #:|inv| #:|implies| #:|let| #:|in| #:|post|
    #:|null| #:|static| #:|derive|))
